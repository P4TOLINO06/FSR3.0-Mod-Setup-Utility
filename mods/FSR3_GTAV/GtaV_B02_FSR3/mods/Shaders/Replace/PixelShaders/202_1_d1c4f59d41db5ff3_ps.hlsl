  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.yz = r2.yz * r2.yz;
  r4.w = r2.w * specularFalloffMult + -500;
  r4.w = max(0, r4.w);
  r2.w = r2.w * specularFalloffMult + -r4.w;
  r4.w = 558 * r4.w;
  r2.w = r2.w * 3 + r4.w;
  ...
  if (r5.w == 0) {
    ...
    if (r5.w == 0) {
      ...
      r4.x = r4.x * r4.x;
      r3.w = r4.x * r3.w;
      r3.w = specularFresnel * r3.w + r6.w;
