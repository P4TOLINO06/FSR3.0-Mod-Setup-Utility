...
SamplerState ComboHeightSamplerFur01_s : register(s4);
...
Texture2D<float4> ComboHeightSamplerFur01 : register(t4);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r5.xyzw = ComboHeightSamplerFur01.Sample(ComboHeightSamplerFur01_s, r1.zw).xyzw;
  r1.z = v1.w * r5.y;
