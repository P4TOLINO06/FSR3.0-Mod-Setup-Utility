  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  x0[3].xyz = r5.xyz;
  r9.yw = float2(-0.346096516,0.32848981) * gCSMResolution.zw;
  ...
  r9.xy = float2(-0.0311755072,0.179337755) * gCSMResolution.zw;
  r10.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(0.514749467,0.253502458) * gCSMResolution.zw;
  ...
  r9.xy = float2(0.545546651,0.0241285414) * gCSMResolution.zw;
  r14.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(-0.0289061088,-0.136784583) * gCSMResolution.zw;
  r15.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(-0.47951147,-0.244832873) * gCSMResolution.zw;
  r16.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(0.758788407,-0.112109199) * gCSMResolution.zw;
  r17.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(0.339352578,-0.249327824) * gCSMResolution.zw;
  r18.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(1.07059765,0.208122596) * gCSMResolution.zw;
  r19.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(1.29403818,-0.0180776753) * gCSMResolution.zw;
  r20.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(-0.747563064,-0.113974348) * gCSMResolution.zw;
  r21.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(0.94772172,-0.248763546) * gCSMResolution.zw;
  r22.xyz = r9.xyz + r7.xyz;
  r9.xy = float2(-1.34315288,-0.088584058) * gCSMResolution.zw;
