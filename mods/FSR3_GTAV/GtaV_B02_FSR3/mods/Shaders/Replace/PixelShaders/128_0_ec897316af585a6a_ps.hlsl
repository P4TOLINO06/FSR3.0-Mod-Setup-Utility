...
cbuffer vehiclecommonlocals : register(b12)
{
  ...
  float4 Track2AnimUV : packoffset(c3);
  float4 dirtLevelMod : packoffset(c4);
  float3 dirtColor : packoffset(c5);
  float specularFresnel : packoffset(c5.w);
  float specularFalloffMult : packoffset(c6);
  float specularIntensityMult : packoffset(c6.y);
  float3 specMapIntMask : packoffset(c7);
  float bumpiness : packoffset(c7.w);
  float reflectivePower : packoffset(c8);
  float envEffThickness : packoffset(c8.y);
  float2 envEffScale : packoffset(c8.z);
  float envEffTexTileUV : packoffset(c9);
}
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.xyz = dirtColor.xyz * dirtLevelMod.yyy + -r1.xyw;
  r1.xyw = r0.xxx * r2.xyz + r1.xyw;
  r2.xyz = r1.zzz + -r1.xyw;
  r0.xyw = r0.yyy * r2.xyz + r1.xyw;
  ...
  r1.xzw = r1.xxx * v5.xyz + r2.xyz;
  r1.xyz = r1.yyy * v2.xyz + r1.xzw;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r2.x = r1.z * r1.w + -0.349999994;
  r1.xyz = r1.xyz * r1.www;
  o1.xyz = r1.xyz * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  r1.x = saturate(1.53846157 * r2.x);
  ...
  r2.xy = r2.xy * r2.xy;
  r1.y = specularFalloffMult * r2.w;
  r3.y = 0.001953125 * r1.y;
  r1.y = dot(r2.xyz, specMapIntMask.xyz);
  r1.y = specularIntensityMult * r1.y;
  r1.y = v3.x * r1.y;
  r3.x = r1.y * r0.z;
  r0.z = saturate(r1.y * r0.z + 0.400000006);
  r2.xy = r0.zz * float2(0.5,0.48828125) + -r3.xy;
  r0.z = -r3.x * 0.5 + 1;
  r0.z = r1.x * r0.z;
  r0.z = r0.z * -0.5 + 1;
