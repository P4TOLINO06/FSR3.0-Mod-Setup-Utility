...
{
  float3 ambientDecalMask : packoffset(c0);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r1.x != 0) discard;
  r0.w = v1.w * r0.w;
  r1.x = globalScalars.z * v1.x;
  r0.x = dot(r0.xyz, ambientDecalMask.xyz);
  r0.x = saturate(1 + -r0.x);
  r0.x = r0.x * r0.w;
  r0.x = globalScalars.x * r0.x;
  o3.w = gAmbientOcclusionEffect.x * r0.x;
