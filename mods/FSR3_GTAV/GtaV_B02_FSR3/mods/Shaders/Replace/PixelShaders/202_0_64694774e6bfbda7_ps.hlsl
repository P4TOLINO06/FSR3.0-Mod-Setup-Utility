  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r3.x = r3.x * r3.x;
  r3.x = min(1, r3.x);
  r3.y = saturate(v6.z * gCSMShaderVars_shared[3].x + gCSMShaderVars_shared[3].y);
  r3.y = sqrt(r3.y);
  ...
  r7.zw = r7.zw * r7.zw;
  r7.xy = r7.zw * r7.xy;
  r3.z = 1 + -specularFresnel;
  r7.xy = specularFresnel * r7.xy + r3.zz;
  ...
  r2.w = r2.w * r3.y;
  r3.y = r4.w * r3.y;
  r5.xyz = r0.xyz * r3.yyy + r2.www;
  r5.xyz = gDirectionalColour.xyz * r5.xyz;
  r1.z = r1.z * r1.w + gLightNaturalAmbient0.w;
  r1.z = gLightNaturalAmbient1.w * r1.z;
  r1.z = max(0, r1.z);
  r7.xyz = gLightArtificialExtAmbient0.xyz * r1.zzz + gLightArtificialExtAmbient1.xyz;
  r1.w = 1 + -globalScalars2.z;
  r8.xyz = gLightArtificialIntAmbient0.xyz * r1.zzz + gLightArtificialIntAmbient1.xyz;
  r8.xyz = globalScalars2.zzz * r8.xyz;
  r7.xyz = r7.xyz * r1.www + r8.xyz;
  r7.xyz = r7.xyz * r1.yyy;
  r8.xyz = gLightNaturalAmbient0.xyz * r1.zzz + gLightNaturalAmbient1.xyz;
  ...
  r8.xyz = gDirectionalAmbientColour.xyz * r1.zzz + r8.xyz;
  r7.xyz = r8.xyz * r1.xxx + r7.xyz;
  ...
  r3.xy = saturate(float2(0.00066666666,0.00177619897) * r3.ww);
  r1.w = 1 + -r3.x;
