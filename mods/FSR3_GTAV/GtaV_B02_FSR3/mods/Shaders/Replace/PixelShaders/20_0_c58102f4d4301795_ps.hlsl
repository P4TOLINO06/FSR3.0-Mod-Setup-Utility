  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r0.x != 0) {
    ...
    while (true) {
      ...
      if (r0.w != 0) break;
      r1.xy = EvaluateAttributeAtSample(v2.xy, r0.z);
  ...
  r0.x = r1.w * r0.w;
  r0.y = AlphaScale * globalScalars.x;
  r0.x = dot(r0.yy, r0.xx);
  r0.y = cmp(0 >= gTransparencyAASamples);
  r0.z = cmp(AlphaTest >= r0.x);
  r0.y = r0.z ? r0.y : 0;
  if (r0.y != 0) discard;
  r0.y = cmp(0 != globalFogParams[0].w);
  r0.y = r0.y ? -1 : 1;
  r0.yzw = v3.xyz * r0.yyy;
  r2.xy = BumpSampler.Sample(BumpSampler_s, v2.xy).xy;
  ...
  r1.w = rsqrt(r1.w);
  r0.yzw = r0.yzw * r1.www + float3(-0,-0,-1);
  r0.yzw = UseTreeNormals * r0.yzw + float3(0,0,1);
