  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  x0[3].xyz = r6.xyz;
  r10.yw = float2(-0.346096486,0.32848981) * gCSMResolution.zw;
  ...
  r10.xy = float2(-0.0311755091,0.1793378) * gCSMResolution.zw;
  r11.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(0.514749527,0.253502488) * gCSMResolution.zw;
  ...
  r10.xy = float2(0.54554671,0.0241285395) * gCSMResolution.zw;
  r15.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(-0.0289061107,-0.136784598) * gCSMResolution.zw;
  r16.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(-0.479511499,-0.244832903) * gCSMResolution.zw;
  r17.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(0.758788407,-0.112109199) * gCSMResolution.zw;
  r18.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(0.339352608,-0.249327794) * gCSMResolution.zw;
  r19.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(1.07059801,0.208122596) * gCSMResolution.zw;
  r20.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(1.29403806,-0.0180776808) * gCSMResolution.zw;
  r21.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(-0.747563124,-0.113974303) * gCSMResolution.zw;
  r22.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(0.94772172,-0.248763502) * gCSMResolution.zw;
  r23.xyz = r10.xyz + r8.xyz;
  r10.xy = float2(-1.343153,-0.088584058) * gCSMResolution.zw;
  ...
  r6.zw = r6.zw * r6.zw;
  r6.xy = r6.zw * r6.xy;
  r6.xy = r6.xy * float2(0.899999976,0.899999976) + float2(0.100000001,0.100000001);
