  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r0.w == 0) {
    ...
    r2.xyz = float3(0.111111112,0.111111112,0.111111112) * r2.xyz;
    r1.xyz = r1.xyz * float3(0.111111112,0.111111112,0.111111112) + r2.xyz;
  ...
  r0.xyz = Gamma * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r0.w = ScanlineFilterParams.w + v1.y;
  r0.w = ScanlineFilterParams.y * r0.w;
  r0.w = sin(r0.w);
  r0.w = r0.w * 0.5 + 0.5;
  r1.x = ScanlineFilterParams.w * 0.5 + v1.y;
  r1.x = ScanlineFilterParams.z * r1.x;
  r1.x = sin(r1.x);
  r1.x = r1.x * 0.5 + 0.5;
  r1.x = ScanlineFilterParams.x * r1.x;
  r0.w = r0.w * ScanlineFilterParams.x + r1.x;
  r0.w = 1 + -r0.w;
