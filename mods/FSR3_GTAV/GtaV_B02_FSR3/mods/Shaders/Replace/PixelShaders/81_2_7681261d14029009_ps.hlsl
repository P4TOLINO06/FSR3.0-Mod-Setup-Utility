  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r1.w == 0) {
    ...
    if (r0.w != 0) {
      ...
      r2.y = r2.x * r2.z;
      r2.x = v2.z * r2.x;
      r2.zw = heightScale1 * r0.ww;
      r2.zw = heightScale0 * r1.ww + r2.zw;
      r2.zw = heightScale2 * r2.yy + r2.zw;
      r2.zw = heightScale3 * r2.xx + r2.zw;
      r2.z = r2.z * r0.x;
      ...
      if (r3.x != 0) {
        ...
        r0.z = 1 + -r0.z;
        r0.z = r3.w ? r0.z : 0;
        r3.xy = r5.xy * r0.zz + r3.xy;
        r0.z = cmp(0 < parallaxSelfShadowAmount);
        r0.z = r0.z ? r4.w : 0;
        if (r0.z != 0) {
          r1.xy = r4.xy / r4.zz;
          r1.xy = r1.xy * r2.zz;
