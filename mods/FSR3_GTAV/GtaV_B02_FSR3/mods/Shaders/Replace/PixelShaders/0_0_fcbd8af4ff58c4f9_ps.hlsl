...
{
  float4 posCurr = (IsWheel)? mul(pos.xyzw, matWheelWorldViewProjUnjittered) : mul(pos.xyzw, gWorldViewProjUnjittered);
  float4 posPrev = (IsWheel)? mul(pos.xyzw, matWheelWorldViewProjUnjitteredPrev) : mul(pos.xyzw, gWorldViewProjUnjitteredPrev);
