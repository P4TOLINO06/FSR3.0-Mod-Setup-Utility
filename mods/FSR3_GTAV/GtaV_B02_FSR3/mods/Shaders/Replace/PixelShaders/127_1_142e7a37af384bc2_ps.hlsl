...
cbuffer vehiclecommonlocals : register(b11)
{
  ...
  float diffuse2SpecMod : packoffset(c5.y);
  float envEffThickness : packoffset(c5.z);
  float2 envEffScale : packoffset(c6);
  float envEffTexTileUV : packoffset(c6.z);
}
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = r0.x * r0.z;
  r2.xyzw = DiffuseSampler2.Sample(DiffuseSampler2_s, v1.xy).xyzw;
  r0.z = matDiffuseColor2.w * r2.w;
  r3.xyzw = DiffuseSampler.Sample(DiffuseSampler_s, v1.xy).xyzw;
  r1.xyw = matDiffuseColor.xyz * r3.xyz;
  r2.xyz = r2.xyz * matDiffuseColor2.xyz + -r1.xyw;
  r3.xyz = r0.zzz * r2.xyz + r1.xyw;
  r2.xyzw = v3.xxxw * r3.xyzw;
