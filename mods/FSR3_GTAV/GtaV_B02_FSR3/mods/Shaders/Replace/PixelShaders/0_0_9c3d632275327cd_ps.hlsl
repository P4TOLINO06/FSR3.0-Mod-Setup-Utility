  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.yz = r0.yy * float2(0.5,0.48828131) + -r2.xy;
  r0.yz = max(float2(0,0), r0.yz);
  r0.w = -r2.x * 0.5 + 1;
  r1.x = dot(v2.xyz, v2.xyz);
  r1.x = rsqrt(r1.x);
  r1.y = v2.z * r1.x + -0.349999994;
  r1.xzw = v2.xyz * r1.xxx;
  o1.xyz = r1.xzw * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  r1.x = saturate(1.53846204 * r1.y);
