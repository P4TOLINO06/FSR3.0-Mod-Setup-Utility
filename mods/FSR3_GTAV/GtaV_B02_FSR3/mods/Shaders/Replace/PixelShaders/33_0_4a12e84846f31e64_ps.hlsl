...
SamplerState ComboHeightSamplerFur23_s : register(s5);
...
Texture2D<float4> ComboHeightSamplerFur23 : register(t5);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r5.xyzw = ComboHeightSamplerFur23.Sample(ComboHeightSamplerFur23_s, r1.zw).xyzw;
  r1.z = v1.w * r5.w;
