  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.w = saturate(v1.z + v1.z);
  r3.y = -0.5 + v1.z;
  r3.y = saturate(r3.y + r3.y);
  r1.w = r1.w * r6.w;
  ...
  r0.y = saturate(r0.y * r1.w + 0.400000006);
  r4.z = specularFresnel;
  r1.xy = r0.yy * float2(0.5,0.48828125) + -r4.xy;
  r1.z = 0;
