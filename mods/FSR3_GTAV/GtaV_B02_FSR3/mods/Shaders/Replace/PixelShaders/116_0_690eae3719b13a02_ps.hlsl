  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.w = globalScalars.z * v3.x;
  r4.xy = envEffTexTileUV * v1.xy;
  r5.xyzw = SnowSampler0.Sample(SnowSampler0_s, r4.xy).xyzw;
  r6.xyzw = SnowSampler1.Sample(SnowSampler1_s, r4.xy).xyzw;
  r3.w = saturate(v4.w + v4.w);
  r4.x = -0.5 + v4.w;
  r4.x = saturate(r4.x + r4.x);
  r3.w = r3.w * r5.w;
  r2.xyz = -r2.xyz * v3.xxx + r5.xyz;
  ...
  r1.xyz = r2.yyy * r5.xyw + r1.xyz;
  r2.y = dirtLevelMod.x * r2.z;
  r5.xyz = r5.zzz + -r1.xyz;
  r1.xyz = r2.yyy * r5.xyz + r1.xyz;
  r2.x = -r4.y * r2.x + 1;
  r0.z = r2.x * r0.z;
  r2.x = cmp(0 < specular2ColorIntensity);
  if (r2.x != 0) {
    r2.x = specular2ColorIntensity * dirtLevelMod.w;
    r2.x = v3.x * r2.x;
    r0.y = r2.x * r0.y;
    r2.xyz = float3(0,0,-1) + -gDirectionalLight.xyz;
    r2.xyz = specular2Color_DirLerp.www * r2.xyz + gDirectionalLight.xyz;
