  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r4.x = -r3.z * 16 + 14;
  r4.x = cmp(1 >= abs(r4.x));
  r4.yz = float2(specularIntensityMult, specularFalloffMult) * r1.zw;
  r0.w = v3.w * r0.w;
  ...
  if (r5.y != 0) {
    ...
    if (r1.z != 0) {
      ...
      r6.xyz = r1.zzz * r2.xyz + r6.xyz;
      r1.z = dot(r6.xyz, r6.xyz);
      r1.z = rsqrt(r1.z);
      r2.xyz = r6.xyz * r1.zzz;
    }
  } else {
    r8.x = 1;
  }
  ...
  if (r1.z != 0) {
    ...
    if (r1.w != 0) {
      ...
      r6.xyzw = VolumeSampler.Sample(VolumeSampler_s, r3.xyz).yzxw;
      r6.xy = r6.xy * float2(2,2) + float2(-1,-1);
    } else {
      r3.xy = detailSettings.zz * v1.xy;
      r7.xyzw = VolumeSampler.Sample(VolumeSampler_s, r3.xyz).xyzw;
      r1.w = r2.w ? 2 : 3;
      r3.xy = v1.xy * r1.ww;
      r3.xyzw = VolumeSampler.Sample(VolumeSampler_s, r3.xyz).xyzw;
      r3.xyz = r3.yzx * float3(2,2,1) + float3(-1,-1,0);
      r7.xyz = r7.yzx * float3(2,2,1) + float3(-1,-1,0);
      r7.xyz = r7.xyz + -r3.xyz;
      r6.xyz = _matMaterialColorScale[1].xxx * r7.xyz + r3.xyz;
    }
    r3.xyzw = r2.wwww ? float4(2,-2,2,-2) : float4(1,-1,1.5,-1.5);
    r5.yw = detailSettings.xy + r3.yw;
    r3.zw = _matMaterialColorScale[1].xx * r5.yw + r3.xz;
    r1.w = StubbleGrowth.y + r3.y;
    r1.w = _matMaterialColorScale[1].x * r1.w + r3.x;
    r3.x = r6.z * 2 + -1;
    r3.x = r3.x * r3.z;
    r3.x = r3.x * r1.z;
    r3.x = r3.x * r1.w + 1;
    r0.xyz = r3.xxx * r0.xyz;
    r3.xyz = v6.xyz * r6.yyy;
  ...
  r3.x = cmp((int)r2.w == 0);
  r3.yzw = wetnessAdjust.xxx * r0.xyz;
  r3.yzw = r3.yzw * r1.zzz;
  r3.xyz = r3.xxx ? r3.yzw : 0;
  r0.xyz = -r3.xyz + r0.xyz;
  r1.zw = wetnessAdjust.yz * r1.ww + r4.zy;
  r0.xyz = _matMaterialColorScale[0].xxx * r0.xyz;
  r3.x = r2.w ? 0.010000 : 0;
  r2.w = r2.w ? -0.00999999978 : -0;
  r1.w = r2.w + r1.w;
  r1.w = _matMaterialColorScale[0].z * r1.w + r3.x;
  ...
  r3.x = saturate(dot(r3.xyz, r6.xyz));
  r3.x = 0.5 + -r3.x;
  ...
  r3.x = r3.y * r3.x;
  r3.y = 1 + r2.z;
  r3.y = saturate(r3.y * 0.5 + -0.300000012);
  r3.y = 1.42857146 * r3.y;
  r6.xyz = saturate(v8.xyz);
  r3.x = r6.x * r3.x;
  r3.x = r3.x * r3.y;
  r3.xyz = r3.xxx * r0.xyz;
  o0.xyz = r3.xyz * _matMaterialColorScale[0].yyy + r0.xyz;
  r0.xyz = v4.xyz * r2.www + -r2.xyz;
  r0.xyz = r6.yyy * r0.xyz + r2.xyz;
  r2.x = 1 + -r8.x;
  r2.y = PedDamageColors[2].y + -r6.z;
  r2.x = r2.x * r2.y + r6.z;
  ...
  r3.x = r5.z * r5.x + gLightArtificialIntAmbient0.w;
