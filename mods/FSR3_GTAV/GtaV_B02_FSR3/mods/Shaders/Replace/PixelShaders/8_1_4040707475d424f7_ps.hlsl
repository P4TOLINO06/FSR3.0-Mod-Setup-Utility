  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.yz = r0.xy * detailSettings.yy + r1.xy;
  r0.x = -r0.x * detailSettings.x + 1;
  ...
  r0.y = r1.y * r0.y;
  r0.z = specularIntensityMult * r0.x;
  r0.w = -r0.z * 0.5 + 1;
  r0.w = r0.y * r0.w;
  ...
  r0.x = saturate(specularIntensityMult * r0.x + 0.400000006);
  r3.xy = float2(0.5,0.48828125) * r0.xx;
  o0.xyz = r2.xyz * r0.www;
  r0.x = v1.w * r2.w;
  o0.w = globalScalars.x * r0.x;
  r0.x = -0.200000003 + wetnessMultiplier;
  r0.x = saturate(10 * r0.x);
  r0.w = saturate(v3.z * 128 + -127);
  o1.w = r0.w * r0.x;
  r2.z = -specularFresnel;
  r3.z = 0.970000029;
  r0.x = 0.001953125 * specularFalloffMult;
  r2.xy = -r0.zx;
  r2.xyz = r3.xyz + r2.xyz;
  r2.xyz = max(float3(0,0,0), r2.xyz);
  r3.x = r2.x * r0.y + r0.z;
  r3.y = r2.y * r0.y + r0.x;
  o2.z = r2.z * r0.y + specularFresnel;
  o2.xy = sqrt(r3.xy);
  o2.w = 1;
