...
cbuffer megashader_locals : register(b12)
{
  ...
  float reflectivePower : packoffset(c2);
...
SamplerState EnvironmentSampler_s : register(s4);
Texture2D<float4> DiffuseSampler : register(t0);
Texture2D<float4> BumpSampler : register(t2);
Texture2D<float4> SpecSampler : register(t3);
TextureCube<float4> EnvironmentSampler : register(t4);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.y = rsqrt(r0.y);
  r0.yzw = v4.xzy * r0.yyy;
  r1.w = dot(-r0.ywz, r1.xyz);
  r1.w = r1.w + r1.w;
  r0.yzw = r1.xzy * -r1.www + -r0.yzw;
  o1.xyz = r1.xyz * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  r1.x = dot(r0.yzw, r0.yzw);
  r1.x = rsqrt(r1.x);
  r0.yzw = r1.xxx * r0.yzw;
  r1.xyzw = EnvironmentSampler.Sample(EnvironmentSampler_s, r0.yzw).xyzw;
  ...
  r3.x = specularIntensityMult * r1.y;
  r1.y = saturate(r1.y * specularIntensityMult + 0.400000006);
  r2.xy = float2(0.5,0.48828125) * r1.yy;
  r1.y = -r3.x * 0.5 + 1;
  r1.y = r1.y * r0.x;
  r1.y = r1.y * -0.5 + 1;
