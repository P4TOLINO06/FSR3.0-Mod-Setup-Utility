  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = cmp(r0.x < 1);
  if (r0.x != 0) discard;
  r0.xyzw = WetSampler.Sample(WetSampler_s, v5.zw).xyzw;
  r1.y = dot(r0.xx, WaveMovement);
  r1.x = 0;
  r0.yz = v5.xy + -r1.xy;
  r0.yz = WaveOffset + r0.yz;
  r0.w = -WaterHeight + v1.z;
  r0.w = max(0, r0.w);
  r0.w = HeightOpacity * r0.w;
  r1.xyzw = FoamSampler.Sample(FoamSampler_s, r0.yz).xyzw;
  r0.yz = v5.xy + r0.yz;
  r2.xyzw = WaterBumpSampler.Sample(WaterBumpSampler_s, r0.yz).xyzw;
  r0.y = r2.x * r1.y;
  r0.y = r0.y * r0.w;
  r0.y = v1.w * r0.y;
  ...
  r0.zw = float2(0.5,0.48828125) * r0.yy;
