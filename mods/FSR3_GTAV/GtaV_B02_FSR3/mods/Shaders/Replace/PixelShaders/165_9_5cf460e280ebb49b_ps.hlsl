  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  while (true) {
    ...
    if (r1.x != 0) break;
    r1.x = (int)r0.w;
    r1.y = -r1.x * 0.010416667 + 1;
    r1.y = r1.y * r1.y;
    r1.xz = LightStreaksBlurDir.xy * r1.xx;
    r1.xz = TexelSize.xy * r1.xz + v1.xy;
    r2.xyzw = HDRSampler.Sample(HDRSampler_s, r1.xz).xyzw;
    r0.xyz = r2.xyz * r1.yyy + r0.xyz;
    r0.w = (int)r0.w + 1;
  }
  r0.xyz = LightStreaksColorShift0.xyz * r0.xyz;
  r0.xyz = float3(0.0416666679,0.0416666679,0.0416666679) * r0.xyz;
  r0.w = cmp(0 < LensArtefactsParams1.y);
  r1.xy = float2(-0.5,-0.5) + v1.yx;
  r0.w = r0.w ? abs(r1.x) : abs(r1.y);
  r0.w = r0.w + r0.w;
  r1.x = LensArtefactsParams1.w + -LensArtefactsParams1.z;
  r0.w = r1.x * r0.w + LensArtefactsParams1.z;
  r0.w = r0.w * r0.w;
