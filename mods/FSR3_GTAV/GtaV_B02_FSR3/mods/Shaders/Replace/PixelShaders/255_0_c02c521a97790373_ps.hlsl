  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r4.w != 0) {
    r6.xy = frac(v7.xy);
    r6.z = r6.y * abs(v7.z) + abs(v7.w);
    r4.w = frac(PedDamageData.z);
    r4.w = cmp(0.100000001 < r4.w);
    r6.w = 1 + -r6.x;
    r6.xyzw = r4.wwww ? r6.zwzw : r6.xzxz;
    r7.xyzw = pedBloodTargetSampler.SampleLevel(pedBloodTargetSampler_s, r6.zw, 0).zxyw;
    r5.y = 1 + -r7.x;
    r5.z = r5.y * r5.y;
    r5.z = r5.z * r7.y;
    ...
    r4.x = r5.z * r3.x + r4.x;
    r8.xyz = r0.xyz * PedDamageColors[1].xyz + -r0.xyz;
    r8.xyz = r7.zzz * r8.xyz + r0.xyz;
    r9.xyz = PedDamageColors[0].xyz * r7.yyy;
    r0.xyz = r8.xyz * r7.xxx + r9.xyz;
    r3.x = cmp(PedDamageData.y != 0.000000);
    if (r3.x != 0) {
      r3.x = cmp(0.150000006 < v7.z);
      r8.yw = frac(PedDamageData.ww);
      r8.xz = float2(0.400000006,0.400000006) * r8.ww;
      r8.xyzw = r4.wwww ? r8.xyzw : r8.wzwz;
      r3.x = cmp((int)r4.w == (int)r3.x);
      r9.xyzw = r3.xxxx ? float4(1,0,0,1) : float4(0,-1,-1,0);
      r6.xyzw = r9.xyzw * r8.xyzw + r6.xyzw;
      r8.xyzw = pedBloodTargetSampler.SampleLevel(pedBloodTargetSampler_s, r6.xy, 0).xyzw;
      r6.xyzw = pedBloodTargetSampler.SampleLevel(pedBloodTargetSampler_s, r6.zw, 0).yzxw;
      r6.x = r7.y;
      r6.y = r8.x;
      r3.x = r6.x * r5.y;
      r3.xy = r6.zy * r5.yy + -r3.xx;
  ...
  if (r3.x != 0) {
    ...
    if (r3.x != 0) {
      ...
      r2.xy = detailSettings.zz * v1.xy;
      r8.xyzw = VolumeSampler.Sample(VolumeSampler_s, r2.xyz).xyzw;
      r3.x = r1.w ? 2 : 3;
      r2.xy = v1.xy * r3.xx;
      r9.xyzw = VolumeSampler.Sample(VolumeSampler_s, r2.xyz).xyzw;
      r2.xyz = r9.yzx * float3(2,2,1) + float3(-1,-1,0);
      r5.yzw = r8.yzx * float3(2,2,1) + float3(-1,-1,0);
      r5.yzw = r5.yzw + -r2.xyz;
      r6.xyz = _matMaterialColorScale[1].xxx * r5.yzw + r2.xyz;
    }
    r8.xyzw = r1.wwww ? float4(2,-2,2,-2) : float4(1,-1,1.5,-1.5);
    r2.xy = detailSettings.xy + r8.yw;
    r2.xy = _matMaterialColorScale[1].xx * r2.xy + r8.xz;
    r2.z = StubbleGrowth.y + r8.y;
    r2.z = _matMaterialColorScale[1].x * r2.z + r8.x;
    r3.x = r6.z * 2 + -1;
    r2.x = r3.x * r2.x;
    r2.x = r2.x * r2.w;
    r2.x = r2.x * r2.z + 1;
