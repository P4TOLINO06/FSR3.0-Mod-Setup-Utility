...
cbuffer vehiclecommonlocals : register(b11)
{
  ...
  float diffuse2SpecMod : packoffset(c7.y);
  float envEffThickness : packoffset(c7.z);
  float2 envEffScale : packoffset(c8);
  float envEffTexTileUV : packoffset(c8.z);
}
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = cmp(r0.x < 1);
  if (r0.x != 0) discard;
  r0.xyzw = DiffuseSampler2.Sample(DiffuseSampler2_s, v1.zw).xyzw;
  ...
  r3.y = specularIntensityMult * r3.x;
  ...
  r0.w = matDiffuseColor2.w * r0.w;
  r0.xyz = r0.xyz * matDiffuseColor2.xyz + -r4.xyz;
  r1.xyz = r0.www * r0.xyz + r4.xyz;
  r0.xyzw = v3.xxxw * r1.xyzw;
  r1.x = globalScalars.z * v3.x;
  r1.y = v3.x * r3.y;
  r1.y = v2.w * r1.y;
  ...
  r4.xzw = r4.zzz + -r0.xyz;
  r0.xyz = r1.www * r4.xzw + r0.xyz;
  r1.z = -r4.y * r1.z + 1;
  r1.y = r1.y * r1.z;
  r1.z = dirtLevelMod.w * v3.x;
  r1.z = r1.z * r3.x;
  r1.z = 0.75 * r1.z;
  ...
  if (r1.w != 0) {
    r3.x = saturate(dot(r2.yzw, -r4.xyz));
    r3.y = 0;
    r5.xyzw = SpecularRampTextureSampler.Sample(SpecularRampTextureSampler_s, r3.xy).xyzw;
  } else {
    r5.xyz = specular2Color_DirLerp.xyz;
  }
  r5.xyz = r5.xyz * r1.zzz;
  r3.xyz = v4.xyz * r3.zzz + -r4.xyz;
  r1.z = dot(r3.xyz, r3.xyz);
  r1.z = rsqrt(r1.z);
  r3.xyz = r3.xyz * r1.zzz;
  r1.z = dot(r2.yzw, r3.xyz);
  r1.z = saturate(9.99999994e-09 + r1.z);
  r1.w = r3.w * 15 + 9.99999994e-09;
  r1.z = log2(r1.z);
  r1.z = r1.w * r1.z;
  r1.z = exp2(r1.z);
