...
SamplerState UITexture1_s : register(s3);
Texture2D<float4> UITexture0 : register(t2);
Texture2D<float4> UITexture1 : register(t3);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xyzw = UITexture0.Sample(UITexture0_s, v3.xy).xyzw;
  r1.xyzw = UITexture1.Sample(UITexture1_s, v3.zw).xyzw;
  r0.xyzw = -r1.xyzw + r0.xyzw;
  r0.xyzw = v2.zzzz * r0.xyzw + r1.xyzw;
  r0.xyzw = r0.xyzw * UIColorXformScale.xyzw + UIColorXformOffset.xyzw;
  r0.w = v2.w * r0.w;
  r1.xyz = r0.xyz * r0.www;
  r2.xy = globalScalars.wx * r0.ww;
  r0.w = cmp(UIPremultiplyAlpha == 0.000000);
  r0.xyz = r0.www ? r0.xyz : r1.xyz;
  r0.w = cmp(globalScalars.w != 1.000000);
  r1.x = r2.x * r2.x;
  o0.w = saturate(r2.y);
  o0.z = r0.w ? r1.x : r0.z;
  o0.xy = r0.xy;
