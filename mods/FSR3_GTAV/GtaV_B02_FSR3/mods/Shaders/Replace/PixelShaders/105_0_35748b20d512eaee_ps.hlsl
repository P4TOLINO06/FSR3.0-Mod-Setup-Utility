  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.x = specularIntensityMult * r1.x;
  r1.z = specularFalloffMult * r1.w;
  r1.y = v1.w * r1.y;
  r1.w = globalScalars.z * v1.x;
  o1.xyz = r0.yzw * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  r2.y = 0.001953125 * r1.z;
  o2.w = globalScalars.x * r1.y;
  r0.x = v3.z * r0.x + -0.349999994;
  r0.x = saturate(1.53846157 * r0.x);
  r0.x = gDynamicBakesAndWetness.z * r0.x;
  r0.y = 1 + -globalScalars2.z;
  r0.x = r0.x * r0.y;
  r0.x = r0.x * r1.w;
  r0.y = saturate(r1.x * specularIntensityMult + 0.699999988);
