...
Texture2D<float4> RenderTarget128 : register(t0);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.x = 2;
  r1.y = ScreenSize.z;
  r0.zw = float2(0.03125,0.0625) * r1.xy;
  r1.x = r0.x * 0.5 + -0.5;
  r1.yzw = float3(0,0,0);
  ...
  while (true) {
    ...
    while (true) {
      ...
      r5.xyz = RenderTarget128.Sample(Sampler1_s, r5.xy).xyz;
      r6.xy = r3.xy + r3.xy;
