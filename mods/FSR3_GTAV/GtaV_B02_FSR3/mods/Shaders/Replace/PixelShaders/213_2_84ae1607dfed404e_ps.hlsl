  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xyzw = CurLumSampler.Sample(CurLumSampler_s, v1.xy).xyzw;
  r1.x = 0;
  r0.y = r0.x;
  r0.z = 0;
  while (true) {
    ...
    if (r0.w != 0) break;
    r1.y = (int)r0.z;
    r1.yz = TexelSize.xy * r1.xy + v1.xy;
    r2.xyzw = CurLumSampler.Sample(CurLumSampler_s, r1.yz).xyzw;
    r0.y = r2.x + r0.y;
    r0.z = (int)r0.z + 1;
  }
  o0.xyzw = float4(0.200000003,0.200000003,0.200000003,0.200000003) * r0.yyyy;
  return;
}