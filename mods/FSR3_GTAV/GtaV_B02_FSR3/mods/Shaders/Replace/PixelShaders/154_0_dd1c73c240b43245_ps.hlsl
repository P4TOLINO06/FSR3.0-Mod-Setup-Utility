    ...
    if (r3.w == 0) {
      ...
      if (r11.x != 0) {
        ...
        if (r11.w != 0) {
          ...
          r11.w = gLocalLightShadowCM3.SampleCmpLevelZero(gShadowZSamplerCache_s, r13.xyz, r11.w).x;
        } else {
          r12.xy = r12.xy / -r12.zz;
          r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r11.x = dot(r11.xyz, r11.xyz);
          ...
          r11.w = gLocalLightShadowSpot3.SampleCmpLevelZero(gShadowZSamplerCache_s, r12.xy, r11.x).x;
        }
      } else {
        r11.w = 1;
      }
      ...
      r7.w = r9.x * r7.w;
      r7.w = r7.w * r5.w;
      r8.xyz = r7.www * gLightColourAndCapsuleExtent[3].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r7.w = cmp(4 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r7.w;
    if (r3.w == 0) {
      r7.w = cmp(gLightColourAndCapsuleExtent[4].w == 0.000000);
      r9.xyz = gLightPositionAndInvDistSqr[4].xyz + -v2.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[4].xyz + v2.xyz;
      r9.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[4].xyz);
      r10.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[4].w;
      r9.w = saturate(r9.w / r10.w);
      r9.w = gLightColourAndCapsuleExtent[4].w * r9.w;
      r11.xyz = gLightDirectionAndFalloffExponent[4].xyz * r9.www + gLightPositionAndInvDistSqr[4].xyz;
      r11.xyz = -v2.xyz + r11.xyz;
      r9.xyz = r7.www ? r9.xyz : r11.xyz;
      r7.w = dot(r9.xyz, r9.xyz);
      r9.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r9.xyz;
      ...
      r9.w = rsqrt(r9.w);
      r9.xyz = r9.xyz * r9.www;
      r7.w = saturate(-r7.w * gLightPositionAndInvDistSqr[4].w + 1);
      r9.w = 1 + -gLightDirectionAndFalloffExponent[4].w;
      r9.w = r9.w * r7.w + gLightDirectionAndFalloffExponent[4].w;
      r7.w = r7.w / r9.w;
      r9.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[4].xyz);
      r9.w = saturate(r9.w * gLightConeScale[4] + gLightConeOffset[4]);
      r10.w = saturate(dot(r9.xyz, r2.xyz));
      r11.x = cmp(gLocalLightShadowData[4]._m03 != 0.000000);
      if (r11.x != 0) {
        r11.xyz = gLocalLightShadowData[4]._m30_m31_m32 + r7.xyz;
        r12.x = dot(r11.xyz, gLocalLightShadowData[4]._m00_m01_m02);
        r12.y = dot(r11.xyz, gLocalLightShadowData[4]._m10_m11_m12);
        r12.z = dot(r11.xyz, gLocalLightShadowData[4]._m20_m21_m22);
        ...
        if (r11.w != 0) {
          ...
          r11.w = gLocalLightShadowCM4.SampleCmpLevelZero(gShadowZSamplerCache_s, r13.xyz, r11.w).x;
        } else {
          r12.xy = r12.xy / -r12.zz;
          r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r11.x = dot(r11.xyz, r11.xyz);
          r11.x = sqrt(r11.x);
          r11.x = gLocalLightShadowData[4]._m23 * r11.x;
          r11.w = gLocalLightShadowSpot4.SampleCmpLevelZero(gShadowZSamplerCache_s, r12.xy, r11.x).x;
        }
      } else {
        r11.w = 1;
      }
      ...
      r11.x = r11.x * r9.w;
      r11.x = r11.x * r7.w;
      r11.xyz = gLightColourAndCapsuleExtent[4].xyz * r11.xxx;
      r10.xyz = r11.xyz * r0.xyz + r10.xyz;
      r9.xyz = r4.xyz * r2.www + r9.xyz;
      r11.x = dot(r9.xyz, r9.xyz);
      r11.x = rsqrt(r11.x);
      ...
      r7.w = r9.x * r7.w;
      r7.w = r7.w * r5.w;
      r8.xyz = r7.www * gLightColourAndCapsuleExtent[4].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r7.w = cmp(5 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r7.w;
    if (r3.w == 0) {
      r7.w = cmp(gLightColourAndCapsuleExtent[5].w == 0.000000);
      r9.xyz = gLightPositionAndInvDistSqr[5].xyz + -v2.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[5].xyz + v2.xyz;
      r9.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[5].xyz);
      r10.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[5].w;
      r9.w = saturate(r9.w / r10.w);
      r9.w = gLightColourAndCapsuleExtent[5].w * r9.w;
      r11.xyz = gLightDirectionAndFalloffExponent[5].xyz * r9.www + gLightPositionAndInvDistSqr[5].xyz;
      r11.xyz = -v2.xyz + r11.xyz;
      r9.xyz = r7.www ? r9.xyz : r11.xyz;
      r7.w = dot(r9.xyz, r9.xyz);
      r9.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r9.xyz;
      ...
      r9.w = rsqrt(r9.w);
      r9.xyz = r9.xyz * r9.www;
      r7.w = saturate(-r7.w * gLightPositionAndInvDistSqr[5].w + 1);
      r9.w = 1 + -gLightDirectionAndFalloffExponent[5].w;
      r9.w = r9.w * r7.w + gLightDirectionAndFalloffExponent[5].w;
      r7.w = r7.w / r9.w;
      r9.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[5].xyz);
      r9.w = saturate(r9.w * gLightConeScale[5] + gLightConeOffset[5]);
      r10.w = saturate(dot(r9.xyz, r2.xyz));
      r11.x = cmp(gLocalLightShadowData[5]._m03 != 0.000000);
      if (r11.x != 0) {
        r11.xyz = gLocalLightShadowData[5]._m30_m31_m32 + r7.xyz;
        r12.x = dot(r11.xyz, gLocalLightShadowData[5]._m00_m01_m02);
        r12.y = dot(r11.xyz, gLocalLightShadowData[5]._m10_m11_m12);
        r12.z = dot(r11.xyz, gLocalLightShadowData[5]._m20_m21_m22);
        ...
        if (r11.w != 0) {
          ...
          r11.w = gLocalLightShadowCM5.SampleCmpLevelZero(gShadowZSamplerCache_s, r13.xyz, r11.w).x;
        } else {
          r12.xy = r12.xy / -r12.zz;
          r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r11.x = dot(r11.xyz, r11.xyz);
          r11.x = sqrt(r11.x);
          r11.x = gLocalLightShadowData[5]._m23 * r11.x;
          r11.w = gLocalLightShadowSpot5.SampleCmpLevelZero(gShadowZSamplerCache_s, r12.xy, r11.x).x;
        }
      } else {
        r11.w = 1;
      }
      ...
      r11.x = r11.x * r9.w;
      r11.x = r11.x * r7.w;
      r11.xyz = gLightColourAndCapsuleExtent[5].xyz * r11.xxx;
      r10.xyz = r11.xyz * r0.xyz + r10.xyz;
      r9.xyz = r4.xyz * r2.www + r9.xyz;
      r11.x = dot(r9.xyz, r9.xyz);
      r11.x = rsqrt(r11.x);
      ...
      r7.w = r9.x * r7.w;
      r7.w = r7.w * r5.w;
      r8.xyz = r7.www * gLightColourAndCapsuleExtent[5].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r7.w = cmp(6 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r7.w;
    if (r3.w == 0) {
      r7.w = cmp(gLightColourAndCapsuleExtent[6].w == 0.000000);
      r9.xyz = gLightPositionAndInvDistSqr[6].xyz + -v2.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[6].xyz + v2.xyz;
      r9.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[6].xyz);
      r10.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[6].w;
      r9.w = saturate(r9.w / r10.w);
      r9.w = gLightColourAndCapsuleExtent[6].w * r9.w;
      r11.xyz = gLightDirectionAndFalloffExponent[6].xyz * r9.www + gLightPositionAndInvDistSqr[6].xyz;
      r11.xyz = -v2.xyz + r11.xyz;
      r9.xyz = r7.www ? r9.xyz : r11.xyz;
      r7.w = dot(r9.xyz, r9.xyz);
      r9.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r9.xyz;
      ...
      r9.w = rsqrt(r9.w);
      r9.xyz = r9.xyz * r9.www;
      r7.w = saturate(-r7.w * gLightPositionAndInvDistSqr[6].w + 1);
      r9.w = 1 + -gLightDirectionAndFalloffExponent[6].w;
      r9.w = r9.w * r7.w + gLightDirectionAndFalloffExponent[6].w;
      r7.w = r7.w / r9.w;
      r9.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[6].xyz);
      r9.w = saturate(r9.w * gLightConeScale[6] + gLightConeOffset[6]);
      r10.w = saturate(dot(r9.xyz, r2.xyz));
      r11.x = cmp(gLocalLightShadowData[6]._m03 != 0.000000);
      if (r11.x != 0) {
        r11.xyz = gLocalLightShadowData[6]._m30_m31_m32 + r7.xyz;
        r12.x = dot(r11.xyz, gLocalLightShadowData[6]._m00_m01_m02);
        r12.y = dot(r11.xyz, gLocalLightShadowData[6]._m10_m11_m12);
        r12.z = dot(r11.xyz, gLocalLightShadowData[6]._m20_m21_m22);
        ...
        if (r11.w != 0) {
          ...
          r11.w = gLocalLightShadowCM6.SampleCmpLevelZero(gShadowZSamplerCache_s, r13.xyz, r11.w).x;
        } else {
          r12.xy = r12.xy / -r12.zz;
          r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r11.x = dot(r11.xyz, r11.xyz);
          r11.x = sqrt(r11.x);
          r11.x = gLocalLightShadowData[6]._m23 * r11.x;
          r11.w = gLocalLightShadowSpot6.SampleCmpLevelZero(gShadowZSamplerCache_s, r12.xy, r11.x).x;
        }
      } else {
        r11.w = 1;
      }
      ...
      r11.x = r11.x * r9.w;
      r11.x = r11.x * r7.w;
      r11.xyz = gLightColourAndCapsuleExtent[6].xyz * r11.xxx;
      r10.xyz = r11.xyz * r0.xyz + r10.xyz;
      r9.xyz = r4.xyz * r2.www + r9.xyz;
      r11.x = dot(r9.xyz, r9.xyz);
      r11.x = rsqrt(r11.x);
      ...
      r7.w = r9.x * r7.w;
      r7.w = r7.w * r5.w;
      r8.xyz = r7.www * gLightColourAndCapsuleExtent[6].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r7.w = cmp(7 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r7.w;
    if (r3.w == 0) {
      ...
      r7.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[7].xyz);
      r9.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[7].w;
      r7.w = saturate(r7.w / r9.w);
      r7.w = gLightColourAndCapsuleExtent[7].w * r7.w;
      r11.xyz = gLightDirectionAndFalloffExponent[7].xyz * r7.www + gLightPositionAndInvDistSqr[7].xyz;
      r11.xyz = -v2.xyz + r11.xyz;
      ...
      r7.w = 1 + -gLightDirectionAndFalloffExponent[7].w;
      r7.w = r7.w * r3.w + gLightDirectionAndFalloffExponent[7].w;
      r3.w = r3.w / r7.w;
      r7.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[7].xyz);
      r7.w = saturate(r7.w * gLightConeScale[7] + gLightConeOffset[7]);
      r9.w = saturate(dot(r9.xyz, r2.xyz));
      r10.w = cmp(gLocalLightShadowData[7]._m03 != 0.000000);
      if (r10.w != 0) {
        r11.xyz = gLocalLightShadowData[7]._m30_m31_m32 + r7.xyz;
        r12.x = dot(r11.xyz, gLocalLightShadowData[7]._m00_m01_m02);
        r12.y = dot(r11.xyz, gLocalLightShadowData[7]._m10_m11_m12);
        r12.z = dot(r11.xyz, gLocalLightShadowData[7]._m20_m21_m22);
        ...
        if (r10.w != 0) {
          ...
          r10.w = gLocalLightShadowCM7.SampleCmpLevelZero(gShadowZSamplerCache_s, r13.xyz, r10.w).x;
        } else {
          r12.xy = r12.xy / -r12.zz;
          r12.xy = r12.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r11.x = dot(r11.xyz, r11.xyz);
          r11.x = sqrt(r11.x);
          r11.x = gLocalLightShadowData[7]._m23 * r11.x;
          r10.w = gLocalLightShadowSpot7.SampleCmpLevelZero(gShadowZSamplerCache_s, r12.xy, r11.x).x;
        }
      } else {
        r10.w = 1;
      }
      ...
      r11.x = r11.x * r7.w;
      r11.x = r11.x * r3.w;
      r11.xyz = gLightColourAndCapsuleExtent[7].xyz * r11.xxx;
      r10.xyz = r11.xyz * r0.xyz + r10.xyz;
      ...
      r2.w = r2.w * r3.w;
      r2.w = r2.w * r5.w;
      r8.xyz = r2.www * gLightColourAndCapsuleExtent[7].xyz + r8.xyz;
    }
  }
  r2.w = r6.w * r6.w;
  r1.x = r1.x * r1.x;
