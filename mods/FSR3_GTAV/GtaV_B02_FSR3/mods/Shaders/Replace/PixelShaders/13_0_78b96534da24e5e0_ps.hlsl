  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xz = r3.yy * r0.xz;
  r3.yzw = v6.xyz * r0.zzz;
  r3.yzw = r0.xxx * v5.xyz + r3.yzw;
  r3.xyz = r3.xxx * v3.xyz + r3.yzw;
  r0.x = dot(r3.xyz, r3.xyz);
  r0.x = rsqrt(r0.x);
  r3.xyw = r3.xyz * r0.xxx;
  r0.z = materialWetnessMultiplier.y * r2.y;
  r0.z = materialWetnessMultiplier.x * r2.w + r0.z;
  r0.z = materialWetnessMultiplier.z * r2.z + r0.z;
  r0.z = materialWetnessMultiplier.w * r2.x + r0.z;
  r2.x = specularIntensityMult * specularIntensityMult;
  r2.y = cmp(r0.y == 1.000000);
  ...
  r0.x = r0.x * r0.z;
  r0.z = r0.w * -0.5 + 1;
  o0.xyz = r1.xyw * r0.zzz;
  r1.x = -r2.x;
  r1.y = -r0.y;
  r0.zw = float2(0.5,0.48828125) + r1.xy;
