...
SamplerState Sampler19_s : register(s15);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.x = ScreenSize.y;
  r0.y = 1 / r0.y;
  r3.xyzw = r2.xyxy * float4(-2,-2,2,-2) + r0.xzxz;
  r4.xyzw = Texture0.SampleLevel(Sampler19_s, r3.xy, 0).xyzw;
  r5.xyzw = Texture3.SampleLevel(Sampler19_s, r3.xy, 0).xyzw;
  ...
  r0.w = 0.0625 + r0.w;
  r4.xyzw = Texture0.SampleLevel(Sampler19_s, r3.zw, 0).xyzw;
  r3.xyzw = Texture3.SampleLevel(Sampler19_s, r3.zw, 0).xyzw;
  ...
  r1.x = r3.x * r1.y + r1.x;
  r0.w = r1.y + r0.w;
  r3.xyzw = r2.xyxy * float4(-2,2,-2,0) + r0.xzxz;
  r4.xyzw = Texture0.SampleLevel(Sampler19_s, r3.xy, 0).xyzw;
  r5.xyzw = Texture3.SampleLevel(Sampler19_s, r3.xy, 0).xyzw;
  r1.y = saturate(1 + -r4.x);
  r1.y = -r1.y * r0.y + 1;
  ...
  r1.x = r5.x * r1.y + r1.x;
  r0.w = r1.y + r0.w;
  r1.yz = r2.xy * float2(2,2) + r0.xz;
  r4.xyzw = Texture0.SampleLevel(Sampler19_s, r1.yz, 0).xyzw;
  r5.xyzw = Texture3.SampleLevel(Sampler19_s, r1.yz, 0).xyzw;
  r1.y = saturate(1 + -r4.x);
  r1.y = -r1.y * r0.y + 1;
  r1.z = 6 * r1.y;
  r1.z = -abs(r1.z) * 0.75 + 0.5;
  ...
  r1.x = r3.x * r1.y + r1.x;
  r0.w = r1.y + r0.w;
  r3.xyzw = r2.xyxy * float4(0,-2,2,0) + r0.xzxz;
  r4.xyzw = Texture0.SampleLevel(Sampler19_s, r3.xy, 0).xyzw;
  r5.xyzw = Texture3.SampleLevel(Sampler19_s, r3.xy, 0).xyzw;
  r1.y = saturate(1 + -r4.x);
  r1.y = -r1.y * r0.y + 1;
  ...
  r1.x = r3.x * r1.y + r1.x;
  r0.w = r1.y + r0.w;
  r0.xz = r2.xy * float2(0,2) + r0.xz;
  r2.xyzw = Texture0.SampleLevel(Sampler19_s, r0.xz, 0).xyzw;
  r3.xyzw = Texture3.SampleLevel(Sampler19_s, r0.xz, 0).xyzw;
  r0.x = saturate(1 + -r2.x);
  r0.x = -r0.x * r0.y + 1;
  r0.y = 6 * r0.x;
  r0.y = -abs(r0.y) * 0.75 + 0.5;
  r0.x = saturate(-r0.x * 1.5 + r0.y);
  r0.y = r3.x * r0.x + r1.x;
  r0.x = r0.w + r0.x;
  r0.x = 1 / r0.x;
  r0.x = saturate(r0.y * r0.x);
  r0.y = 1 + -r0.x;
  r0.x = Parameters01.x * r0.y + r0.x;
  o0.xyzw = Parameters01.yyyy * r0.xxxx;
  return;
}