  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r4.w == 0) {
    ...
    if (r4.w == 0) {
      ...
      r8.xyz = gLightPositionAndInvDistSqr[3].xyz + -v2.xyz;
      r10.xyz = -gLightPositionAndInvDistSqr[3].xyz + v2.xyz;
      r8.w = dot(r10.xyz, gLightDirectionAndFalloffExponent[3].xyz);
      r9.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[3].w;
      r8.w = saturate(r8.w / r9.w);
      r8.w = gLightColourAndCapsuleExtent[3].w * r8.w;
      r10.xyz = gLightDirectionAndFalloffExponent[3].xyz * r8.www + gLightPositionAndInvDistSqr[3].xyz;
      r10.xyz = -v2.xyz + r10.xyz;
      ...
      r8.w = 1 + -gLightDirectionAndFalloffExponent[3].w;
      r8.w = r8.w * r4.w + gLightDirectionAndFalloffExponent[3].w;
      r4.w = r4.w / r8.w;
      r8.w = dot(r8.xyz, -gLightDirectionAndFalloffExponent[3].xyz);
      r8.w = saturate(r8.w * gLightConeScale[3] + gLightConeOffset[3]);
      r9.w = dot(r8.xyz, r3.xyz);
      r10.x = saturate(r9.w);
      r10.x = r10.x + -abs(r9.w);
      r9.w = r0.w * r10.x + abs(r9.w);
      r10.x = cmp(gLocalLightShadowData[3]._m03 != 0.000000);
      r10.y = cmp(gShadowTexParam.x == 1.000000);
      r10.x = r10.y ? r10.x : 0;
      if (r10.x != 0) {
        r6.xyz = gLocalLightShadowData[3]._m30_m31_m32 + r6.xyz;
        r10.x = dot(r6.xyz, gLocalLightShadowData[3]._m00_m01_m02);
        r10.y = dot(r6.xyz, gLocalLightShadowData[3]._m10_m11_m12);
        r10.z = dot(r6.xyz, gLocalLightShadowData[3]._m20_m21_m22);
        ...
        if (r10.w != 0) {
          ...
          r10.w = gLocalLightShadowCM3.SampleCmpLevelZero(gShadowZSamplerCache_s, r11.xyz, r10.w).x;
        } else {
          r10.xy = r10.xy / -r10.zz;
          r10.xy = r10.xy * float2(0.5,-0.5) + float2(0.5,0.5);
          r6.x = dot(r6.xyz, r6.xyz);
          r6.x = sqrt(r6.x);
          r6.x = gLocalLightShadowData[3]._m23 * r6.x;
          r10.w = gLocalLightShadowSpot3.SampleCmpLevelZero(gShadowZSamplerCache_s, r10.xy, r6.x).x;
        }
      } else {
        r10.w = 1;
      }
      ...
      r6.x = r6.x * r8.w;
      r6.x = r6.x * r4.w;
      r6.xyz = gLightColourAndCapsuleExtent[3].xyz * r6.xxx;
