...
TextureCube<float4> EnvironmentSampler : register(t3);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.x = rsqrt(r1.x);
  r3.xyz = v4.xzy * r1.xxx;
  r1.x = dot(-r3.xzy, r2.xyz);
  r1.x = r1.x + r1.x;
  r3.xyz = r2.xzy * -r1.xxx + -r3.xyz;
  r1.x = dot(r3.xyz, r3.xyz);
  r1.x = rsqrt(r1.x);
  r3.xyz = r3.xyz * r1.xxx;
  r3.xyzw = EnvironmentSampler.Sample(EnvironmentSampler_s, r3.xyz).xyzw;
