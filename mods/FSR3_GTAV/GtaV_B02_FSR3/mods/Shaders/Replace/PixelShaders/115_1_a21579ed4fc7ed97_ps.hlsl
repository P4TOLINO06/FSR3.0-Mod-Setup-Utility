  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.y = saturate(0.0500000007 * v5.w);
  r0.z = abs(r0.x) * -24 + 27;
  ...
  if (r0.w != 0) {
    ...
    r0.w = trunc(r0.w);
    r0.w = r0.y * 5 + -r0.w;
    r1.y = icb[r1.y+0].x + -icb[r1.x+0].x;
    r0.w = r0.w * r1.y + icb[r1.x+0].x;
  } else {
    r0.w = 0;
  }
  r1.x = r0.z * r0.w;
  ...
  if (r1.w == 0) {
    ...
    if (r0.z != 0) {
      ...
      if (r2.w != 0) {
        ...
        r7.xyzw = heightMapSamplerLayer1.SampleLevel(heightMapSamplerLayer1_s, v1.zw, 0).xyzw;
        r0.x = r7.x * r0.z;
        r0.x = r6.x * r0.w + r0.x;
        r6.xyzw = heightMapSamplerLayer2.SampleLevel(heightMapSamplerLayer2_s, v1.zw, 0).xyzw;
        r0.x = r6.x * r2.x + r0.x;
        r6.xyzw = heightMapSamplerLayer3.SampleLevel(heightMapSamplerLayer3_s, v1.zw, 0).xyzw;
        r0.x = r6.x * r1.w + r0.x;
        ...
        while (true) {
          ...
          if (r6.y != 0) {
            ...
            r7.xyzw = v1.xyzw + r3.xyxy;
            r8.xyzw = heightMapSamplerLayer0.SampleLevel(heightMapSamplerLayer0_s, r7.xy, 0).xyzw;
            r9.xyzw = heightMapSamplerLayer1.SampleLevel(heightMapSamplerLayer1_s, r7.zw, 0).xyzw;
            r6.z = r9.x * r0.z;
            r6.z = r8.x * r0.w + r6.z;
            r8.xyzw = heightMapSamplerLayer2.SampleLevel(heightMapSamplerLayer2_s, r7.zw, 0).xyzw;
            r6.z = r8.x * r2.x + r6.z;
            r7.xyzw = heightMapSamplerLayer3.SampleLevel(heightMapSamplerLayer3_s, r7.zw, 0).xyzw;
            r6.z = r7.x * r1.w + r6.z;
            r4.w = r3.z;
            r5.w = r5.z;
            r3.z = r6.y;
        ...
        if (r1.x != 0) {
          ...
          while (true) {
            ...
            if (r2.y != 0) break;
            r2.y = (int)r1.y;
            r2.y = -r2.y * 0.142857149 + 1;
            r5.xyzw = r4.xyzw * r2.yyyy + v1.xyzw;
            r6.xyzw = heightMapSamplerLayer0.SampleLevel(heightMapSamplerLayer0_s, r5.xy, 0).xyzw;
            r7.xyzw = heightMapSamplerLayer1.SampleLevel(heightMapSamplerLayer1_s, r5.zw, 0).xyzw;
            r2.z = r7.x * r0.z;
            r2.z = r6.x * r0.w + r2.z;
            r6.xyzw = heightMapSamplerLayer2.SampleLevel(heightMapSamplerLayer2_s, r5.zw, 0).xyzw;
            r2.z = r6.x * r2.x + r2.z;
            r5.xyzw = heightMapSamplerLayer3.SampleLevel(heightMapSamplerLayer3_s, r5.zw, 0).xyzw;
            r2.z = r5.x * r1.w + r2.z;
            r2.z = r2.z + -r0.x;
            r2.y = r2.z + -r2.y;
            r1.y = (int)r1.y + 1;
  ...
  r1.y = r1.x * r3.z;
  r1.x = r1.x * r1.w;
  r3.xyzw = TextureSampler_layer0.Sample(TextureSampler_layer0_s, r2.xy).xyzw;
  r4.xyzw = TextureSampler_layer1.Sample(TextureSampler_layer1_s, r2.zw).xyzw;
  r4.xyz = r4.xyz * r0.xxx;
  r3.xyz = r3.xyz * r0.zzz + r4.xyz;
  r4.xyzw = TextureSampler_layer2.Sample(TextureSampler_layer2_s, r2.zw).xyzw;
  r3.xyz = r4.xyz * r1.yyy + r3.xyz;
  r4.xyzw = TextureSampler_layer3.Sample(TextureSampler_layer3_s, r2.zw).xyzw;
  r1.xyw = r4.xyz * r1.xxx + r3.xyz;
  r3.xyz = float3(1,1,1) + -v2.xyz;
  r0.x = r3.x * r3.y;
  r0.z = r0.x * r3.z;
  r0.x = v2.z * r0.x;
  r3.x = v2.y * r3.x;
  r3.y = r3.x * r3.z;
  r3.x = v2.z * r3.x;
  r4.xyzw = BumpSampler_layer0.Sample(BumpSampler_layer0_s, r2.xy).xyzw;
  r5.xyzw = BumpSampler_layer1.Sample(BumpSampler_layer1_s, r2.zw).xyzw;
  r2.xy = r5.xy * r0.xx;
  r2.xy = r4.xy * r0.zz + r2.xy;
  r4.xyzw = BumpSampler_layer2.Sample(BumpSampler_layer2_s, r2.zw).xyzw;
  r2.xy = r4.xy * r3.yy + r2.xy;
  r4.xyzw = BumpSampler_layer3.Sample(BumpSampler_layer3_s, r2.zw).xyzw;
  r2.xy = r4.xy * r3.xx + r2.xy;
  r2.xy = r2.xy * float2(2,2) + float2(-1,-1);
  r2.z = dot(r2.xy, r2.xy);
  r2.z = 1 + -r2.z;
  r2.z = sqrt(abs(r2.z));
  r2.w = max(0.00100000005, bumpiness);
  r2.xy = r2.xy * r2.ww;
  r4.xyz = v6.xyz * r2.yyy;
  r2.xyw = r2.xxx * v5.xyz + r4.xyz;
  r2.xyz = r2.zzz * v3.xyz + r2.xyw;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
  r4.xyz = r2.xyz * r2.www;
  r0.x = materialWetnessMultiplier.y * r0.x;
  r0.x = materialWetnessMultiplier.x * r0.z + r0.x;
  r0.x = materialWetnessMultiplier.z * r3.y + r0.x;
  r0.x = materialWetnessMultiplier.w * r3.x + r0.x;
  r0.z = specularIntensityMult * specularIntensityMult;
  r2.x = cmp(r0.y == 1.000000);
  r2.y = dot(r1.xyw, float3(1.27499998,4.29239988,0.432599992));
  r2.y = 0.5 + -r2.y;
  r2.y = saturate(v3.w + -r2.y);
  r3.x = cmp(0.800000012 < r0.y);
