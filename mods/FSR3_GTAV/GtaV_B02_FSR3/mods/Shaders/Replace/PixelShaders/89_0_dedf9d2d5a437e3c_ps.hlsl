  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = cmp(r0.x < 1);
  if (r0.x != 0) discard;
  r0.xyzw = distanceMapSampler.SampleLevel(distanceMapSampler_s, v1.xy, 0).xyzw;
  r0.yz = ddx(v1.xy);
  r1.xy = ddy(v1.xy);
  r0.yz = max(abs(r1.xy), abs(r0.yz));
  r0.y = max(r0.y, r0.z);
  r0.z = -r0.y * 10 + 0.5;
  r0.y = r0.y * 10 + 0.5;
  r0.xy = r0.xy + -r0.zz;
  ...
  r1.x = gLightArtificialIntAmbient0.w + v2.x;
  r1.y = v2.y;
  r0.zw = float2(0.5,0.5) * r1.xy;
  o3.xy = sqrt(r0.zw);
  r0.y = v3.z * r0.y + -0.349999994;
