  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r0.x == 0) {
    ...
    r1.zw = abs(r0.ww) * float2(-24,-24) + float2(26,27);
    r1.z = saturate(r1.z);
    r0.y = r1.z * r0.y;
    r2.x = saturate(r2.x);
    r0.y = r2.x * r0.y;
    r2.xy = -r1.xy / r0.zz;
    r2.xy = heightScale * r2.xy;
    r2.xy = r2.xy * r0.yy;
    r0.zw = r1.xy / r0.zz;
    ...
    if (r0.x == 0) {
      ...
      r1.xy = ddx(v2.xy);
      r1.zw = ddy(v2.xy);
      r3.xyzw = heightSampler.SampleGrad(heightSampler_s, v2.xy, r1.xyxx, r1.zwzz).xyzw;
      ...
      while (true) {
        ...
        if (r4.z != 0) {
          r4.z = r2.w + -r0.x;
          r3.xy = r2.xy * r0.xx + r3.xy;
          r5.xy = v2.xy + r3.xy;
          r5.xyzw = heightSampler.SampleGrad(heightSampler_s, r5.xy, r1.xyxx, r1.zwzz).xyzw;
          r3.z = r2.w;
          r4.x = r3.w;
          r2.w = r4.z;
          r3.w = r5.x;
