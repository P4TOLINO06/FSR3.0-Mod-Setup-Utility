  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xyzw = TexelSize.xyxy * float4(-0.949999988,-0.949999988,-0.949999988,0.949999988) + v1.xyxy;
  r1.xyzw = HDRSampler.Sample(HDRSampler_s, r0.xy).xyzw;
  r0.xyzw = HDRSampler.Sample(HDRSampler_s, r0.zw).xyzw;
  r0.xyz = min(r1.xyz, r0.xyz);
  r1.xyzw = TexelSize.xyxy * float4(0.949999988,0.949999988,0.949999988,-0.949999988) + v1.xyxy;
  r2.xyzw = HDRSampler.Sample(HDRSampler_s, r1.xy).xyzw;
  r1.xyzw = HDRSampler.Sample(HDRSampler_s, r1.zw).xyzw;
  r1.xyz = min(r2.xyz, r1.xyz);
  o0.xyz = min(r1.xyz, r0.xyz);
  o0.w = 1;
  return;
}