...
cbuffer megashader_locals : register(b12)
{
  ...
  float wetnessMultiplier : packoffset(c0.w);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  o1.w = r0.z;
  o2.w = r0.z;
  r0.y = saturate(0.699999988 + specularIntensityMult);
  r1.xy = float2(0.5,0.48828125) * r0.yy;
  r0.yw = -float2(specularIntensityMult, specularFresnel);
  r1.z = 0.970000029;
  r1.w = 0.001953125 * specularFalloffMult;
  r0.z = -r1.w;
  r0.yzw = r1.xyz + r0.yzw;
  r0.yzw = max(float3(0,0,0), r0.yzw);
  r1.y = r0.z * r0.x + r1.w;
  r1.xz = r0.yw * r0.xx + float2(specularIntensityMult, specularFresnel);
  o2.xy = sqrt(r1.xy);
  o2.z = r1.z;
