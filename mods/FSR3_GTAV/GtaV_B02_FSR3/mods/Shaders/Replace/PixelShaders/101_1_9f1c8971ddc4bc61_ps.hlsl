  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.w = emissiveMultiplier * r0.w;
  r2.w = globalScalars.w * r2.w;
  r2.w = globalScalars2.y * r2.w;
  r0.w = v1.w * r0.w;
  ...
  o3.xy = sqrt(r2.xy);
  o3.z = saturate(0.0625 * r2.w);
  o0.w = globalScalars2.y * r0.w;
