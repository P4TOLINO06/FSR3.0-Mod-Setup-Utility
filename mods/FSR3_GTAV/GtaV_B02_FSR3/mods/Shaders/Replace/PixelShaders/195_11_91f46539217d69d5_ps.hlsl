  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r3.w == 0) {
    r5.x = cmp(gLightColourAndCapsuleExtent[0].w == 0.000000);
    r5.yzw = gLightPositionAndInvDistSqr[0].xyz + -v2.xyz;
    r6.xyz = -gLightPositionAndInvDistSqr[0].xyz + v2.xyz;
    r6.x = dot(r6.xyz, gLightDirectionAndFalloffExponent[0].xyz);
    r6.y = 9.99999975e-05 + gLightColourAndCapsuleExtent[0].w;
    r6.x = saturate(r6.x / r6.y);
    r6.x = gLightColourAndCapsuleExtent[0].w * r6.x;
    r6.xyz = gLightDirectionAndFalloffExponent[0].xyz * r6.xxx + gLightPositionAndInvDistSqr[0].xyz;
    r6.xyz = -v2.xyz + r6.xyz;
    r5.xyz = r5.xxx ? r5.yzw : r6.xyz;
    ...
    r6.x = 1 + -gLightDirectionAndFalloffExponent[0].w;
    r6.x = r6.x * r5.w + gLightDirectionAndFalloffExponent[0].w;
    r5.w = r5.w / r6.x;
    r6.x = dot(r5.xyz, -gLightDirectionAndFalloffExponent[0].xyz);
    r6.x = saturate(r6.x * gLightConeScale[0] + gLightConeOffset[0]);
    r5.x = saturate(dot(r5.xyz, r1.yzw));
    r5.x = r5.x * r6.x;
    r5.x = r5.x * r5.w;
    r5.xyz = gLightColourAndCapsuleExtent[0].xyz * r5.xxx;
  ...
  if (r5.w != 0) {
    r6.x = cmp(1 >= gNumForwardLights);
    r5.w = (int)r3.w | (int)r5.w;
    r3.w = r6.x ? r5.w : r3.w;
    if (r3.w == 0) {
      r5.w = cmp(gLightColourAndCapsuleExtent[1].w == 0.000000);
      r6.xyz = gLightPositionAndInvDistSqr[1].xyz + -v2.xyz;
      r7.xyz = -gLightPositionAndInvDistSqr[1].xyz + v2.xyz;
      r6.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[1].xyz);
      r7.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[1].w;
      r6.w = saturate(r6.w / r7.x);
      r6.w = gLightColourAndCapsuleExtent[1].w * r6.w;
      r7.xyz = gLightDirectionAndFalloffExponent[1].xyz * r6.www + gLightPositionAndInvDistSqr[1].xyz;
      ...
      r6.w = 1 + -gLightDirectionAndFalloffExponent[1].w;
      r6.w = r6.w * r5.w + gLightDirectionAndFalloffExponent[1].w;
      r5.w = r5.w / r6.w;
      r6.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[1].xyz);
      r6.w = saturate(r6.w * gLightConeScale[1] + gLightConeOffset[1]);
      r6.x = saturate(dot(r6.xyz, r1.yzw));
      r6.x = r6.x * r6.w;
      r5.w = r6.x * r5.w;
      r6.xyz = gLightColourAndCapsuleExtent[1].xyz * r5.www;
  ...
  if (r3.w == 0) {
    r5.w = cmp(2 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r5.w;
    if (r3.w == 0) {
      r5.w = cmp(gLightColourAndCapsuleExtent[2].w == 0.000000);
      r6.xyz = gLightPositionAndInvDistSqr[2].xyz + -v2.xyz;
      r7.xyz = -gLightPositionAndInvDistSqr[2].xyz + v2.xyz;
      r6.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[2].xyz);
      r7.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[2].w;
      r6.w = saturate(r6.w / r7.x);
      r6.w = gLightColourAndCapsuleExtent[2].w * r6.w;
      r7.xyz = gLightDirectionAndFalloffExponent[2].xyz * r6.www + gLightPositionAndInvDistSqr[2].xyz;
      r7.xyz = -v2.xyz + r7.xyz;
      r6.xyz = r5.www ? r6.xyz : r7.xyz;
      r5.w = dot(r6.xyz, r6.xyz);
      r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
      ...
      r6.w = 1 + -gLightDirectionAndFalloffExponent[2].w;
      r6.w = r6.w * r5.w + gLightDirectionAndFalloffExponent[2].w;
      r5.w = r5.w / r6.w;
      r6.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[2].xyz);
      r6.w = saturate(r6.w * gLightConeScale[2] + gLightConeOffset[2]);
      r6.x = saturate(dot(r6.xyz, r1.yzw));
      r6.x = r6.x * r6.w;
      r5.w = r6.x * r5.w;
      r6.xyz = gLightColourAndCapsuleExtent[2].xyz * r5.www;
      r5.xyz = r6.xyz * r0.xyz + r5.xyz;
    }
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    r5.w = cmp(3 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r5.w;
    if (r3.w == 0) {
      r5.w = cmp(gLightColourAndCapsuleExtent[3].w == 0.000000);
      r6.xyz = gLightPositionAndInvDistSqr[3].xyz + -v2.xyz;
      r7.xyz = -gLightPositionAndInvDistSqr[3].xyz + v2.xyz;
      r6.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[3].xyz);
      r7.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[3].w;
      r6.w = saturate(r6.w / r7.x);
      r6.w = gLightColourAndCapsuleExtent[3].w * r6.w;
      r7.xyz = gLightDirectionAndFalloffExponent[3].xyz * r6.www + gLightPositionAndInvDistSqr[3].xyz;
      r7.xyz = -v2.xyz + r7.xyz;
      r6.xyz = r5.www ? r6.xyz : r7.xyz;
      r5.w = dot(r6.xyz, r6.xyz);
      r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
      ...
      r6.w = r6.w * r5.w + gLightDirectionAndFalloffExponent[3].w;
      r5.w = r5.w / r6.w;
      r6.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[3].xyz);
      r6.w = saturate(r6.w * gLightConeScale[3] + gLightConeOffset[3]);
      r6.x = saturate(dot(r6.xyz, r1.yzw));
      r6.x = r6.x * r6.w;
      r5.w = r6.x * r5.w;
      r6.xyz = gLightColourAndCapsuleExtent[3].xyz * r5.www;
      r5.xyz = r6.xyz * r0.xyz + r5.xyz;
    }
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    r5.w = cmp(4 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r5.w;
    if (r3.w == 0) {
      r5.w = cmp(gLightColourAndCapsuleExtent[4].w == 0.000000);
      r6.xyz = gLightPositionAndInvDistSqr[4].xyz + -v2.xyz;
      r7.xyz = -gLightPositionAndInvDistSqr[4].xyz + v2.xyz;
      r6.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[4].xyz);
      r7.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[4].w;
      r6.w = saturate(r6.w / r7.x);
      r6.w = gLightColourAndCapsuleExtent[4].w * r6.w;
      r7.xyz = gLightDirectionAndFalloffExponent[4].xyz * r6.www + gLightPositionAndInvDistSqr[4].xyz;
      r7.xyz = -v2.xyz + r7.xyz;
      r6.xyz = r5.www ? r6.xyz : r7.xyz;
      r5.w = dot(r6.xyz, r6.xyz);
      r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
      ...
      r6.w = 1 + -gLightDirectionAndFalloffExponent[4].w;
      r6.w = r6.w * r5.w + gLightDirectionAndFalloffExponent[4].w;
      r5.w = r5.w / r6.w;
      r6.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[4].xyz);
      r6.w = saturate(r6.w * gLightConeScale[4] + gLightConeOffset[4]);
      r6.x = saturate(dot(r6.xyz, r1.yzw));
      r6.x = r6.x * r6.w;
      r5.w = r6.x * r5.w;
      r6.xyz = gLightColourAndCapsuleExtent[4].xyz * r5.www;
      r5.xyz = r6.xyz * r0.xyz + r5.xyz;
    }
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    r5.w = cmp(5 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r5.w;
    if (r3.w == 0) {
      r5.w = cmp(gLightColourAndCapsuleExtent[5].w == 0.000000);
      r6.xyz = gLightPositionAndInvDistSqr[5].xyz + -v2.xyz;
      r7.xyz = -gLightPositionAndInvDistSqr[5].xyz + v2.xyz;
      r6.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[5].xyz);
      r7.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[5].w;
      r6.w = saturate(r6.w / r7.x);
      r6.w = gLightColourAndCapsuleExtent[5].w * r6.w;
      r7.xyz = gLightDirectionAndFalloffExponent[5].xyz * r6.www + gLightPositionAndInvDistSqr[5].xyz;
      r7.xyz = -v2.xyz + r7.xyz;
      r6.xyz = r5.www ? r6.xyz : r7.xyz;
      r5.w = dot(r6.xyz, r6.xyz);
      r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
      ...
      r6.w = 1 + -gLightDirectionAndFalloffExponent[5].w;
      r6.w = r6.w * r5.w + gLightDirectionAndFalloffExponent[5].w;
      r5.w = r5.w / r6.w;
      r6.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[5].xyz);
      r6.w = saturate(r6.w * gLightConeScale[5] + gLightConeOffset[5]);
      r6.x = saturate(dot(r6.xyz, r1.yzw));
      r6.x = r6.x * r6.w;
      r5.w = r6.x * r5.w;
      r6.xyz = gLightColourAndCapsuleExtent[5].xyz * r5.www;
      r5.xyz = r6.xyz * r0.xyz + r5.xyz;
    }
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    r5.w = cmp(6 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r5.w;
    if (r3.w == 0) {
      r5.w = cmp(gLightColourAndCapsuleExtent[6].w == 0.000000);
      r6.xyz = gLightPositionAndInvDistSqr[6].xyz + -v2.xyz;
      r7.xyz = -gLightPositionAndInvDistSqr[6].xyz + v2.xyz;
      r6.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[6].xyz);
      r7.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[6].w;
      r6.w = saturate(r6.w / r7.x);
      r6.w = gLightColourAndCapsuleExtent[6].w * r6.w;
      r7.xyz = gLightDirectionAndFalloffExponent[6].xyz * r6.www + gLightPositionAndInvDistSqr[6].xyz;
      r7.xyz = -v2.xyz + r7.xyz;
      r6.xyz = r5.www ? r6.xyz : r7.xyz;
      r5.w = dot(r6.xyz, r6.xyz);
      r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
      ...
      r6.w = 1 + -gLightDirectionAndFalloffExponent[6].w;
      r6.w = r6.w * r5.w + gLightDirectionAndFalloffExponent[6].w;
      r5.w = r5.w / r6.w;
      r6.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[6].xyz);
      r6.w = saturate(r6.w * gLightConeScale[6] + gLightConeOffset[6]);
      r6.x = saturate(dot(r6.xyz, r1.yzw));
      r6.x = r6.x * r6.w;
      r5.w = r6.x * r5.w;
      r6.xyz = gLightColourAndCapsuleExtent[6].xyz * r5.www;
      r5.xyz = r6.xyz * r0.xyz + r5.xyz;
    }
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    r5.w = cmp(7 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r5.w;
    if (r3.w == 0) {
      r3.w = cmp(gLightColourAndCapsuleExtent[7].w == 0.000000);
      r6.xyz = gLightPositionAndInvDistSqr[7].xyz + -v2.xyz;
      r7.xyz = -gLightPositionAndInvDistSqr[7].xyz + v2.xyz;
      r5.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[7].xyz);
      r6.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[7].w;
      r5.w = saturate(r5.w / r6.w);
      r5.w = gLightColourAndCapsuleExtent[7].w * r5.w;
      r7.xyz = gLightDirectionAndFalloffExponent[7].xyz * r5.www + gLightPositionAndInvDistSqr[7].xyz;
      r7.xyz = -v2.xyz + r7.xyz;
      ...
      r3.w = saturate(-r3.w * gLightPositionAndInvDistSqr[7].w + 1);
      r5.w = 1 + -gLightDirectionAndFalloffExponent[7].w;
      r5.w = r5.w * r3.w + gLightDirectionAndFalloffExponent[7].w;
      r3.w = r3.w / r5.w;
      r5.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[7].xyz);
      r5.w = saturate(r5.w * gLightConeScale[7] + gLightConeOffset[7]);
      r6.x = saturate(dot(r6.xyz, r1.yzw));
      r5.w = r6.x * r5.w;
      r3.w = r5.w * r3.w;
      r6.xyz = gLightColourAndCapsuleExtent[7].xyz * r3.www;
      r5.xyz = r6.xyz * r0.xyz + r5.xyz;
    }
  }
  r4.yzw = r4.yzw * r2.www + r5.xyz;
