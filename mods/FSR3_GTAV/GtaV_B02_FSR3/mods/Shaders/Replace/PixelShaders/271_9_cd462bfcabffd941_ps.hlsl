  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r5.w == 0) {
    ...
    if (r5.w == 0) {
      ...
      r6.y = dot(r10.xyz, gLightDirectionAndFalloffExponent[3].xyz);
      r7.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[3].w;
      r6.y = saturate(r6.y / r7.w);
      r6.y = gLightColourAndCapsuleExtent[3].w * r6.y;
      r10.xyz = gLightDirectionAndFalloffExponent[3].xyz * r6.yyy + gLightPositionAndInvDistSqr[3].xyz;
      r10.xyz = -v2.xyz + r10.xyz;
      ...
      r6.y = r6.y * r5.w + gLightDirectionAndFalloffExponent[3].w;
      r5.w = r5.w / r6.y;
      r6.y = dot(r9.xyz, -gLightDirectionAndFalloffExponent[3].xyz);
      ...
      r6.y = r7.w * r6.y;
      r7.w = r6.y * r5.w;
      r10.xyz = gLightColourAndCapsuleExtent[3].xyz * r7.www;
      r8.xyz = r10.xyz * r0.xyz + r8.xyz;
      ...
      r3.x = r3.x * r5.w;
      r3.x = r3.x * r6.z;
      r7.xyz = r3.xxx * gLightColourAndCapsuleExtent[3].xyz + r7.xyz;
    }
  }
  r3.x = r6.x * r6.x;
  r2.x = r2.x * r2.x;
