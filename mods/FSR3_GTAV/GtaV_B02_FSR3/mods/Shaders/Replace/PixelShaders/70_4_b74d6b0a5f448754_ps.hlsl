  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.x = 1 + -r2.x;
  r3.xy = float2(specularFalloffMult, specularIntensityMult) * r2.xx;
  o1.w = saturate(v3.z * 128 + -127);
  r2.y = emissiveMultiplier * r0.w;
  r2.y = globalScalars.w * r2.y;
  r0.w = v1.w * r0.w;
