  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r4.xyzw = SpecSampler.Sample(SpecSampler_s, r0.xy).xyzw;
  r4.xy = r4.xy * r4.xy;
  r0.x = dot(r4.xyz, specMapIntMask.xyz);
  r0.y = specularIntensityMult * r0.x;
  ...
  r0.x = dot(r3.xyz, r2.yzw);
  r0.x = saturate(9.99999994e-09 + r0.x);
  r2.y = r4.w * 15 + 9.99999994e-09;
  r0.x = log2(r0.x);
  r0.x = r2.y * r0.x;
  r0.x = exp2(r0.x);
  ...
  r0.y = saturate(r0.y * r2.x + 0.400000006);
