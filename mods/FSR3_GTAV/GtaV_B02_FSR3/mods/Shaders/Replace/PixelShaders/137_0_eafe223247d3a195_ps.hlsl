  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.y = cmp(UIPremultiplyAlpha == 0.000000);
  r1.xyzw = v1.xyzw * UIColorXformScale.xyzw + UIColorXformOffset.xyzw;
  r2.xyz = r1.xyz * r1.www;
  r0.yzw = r0.yyy ? r1.xyz : r2.xyz;
  r1.xy = globalScalars.wx * r1.ww;
  r1.x = r1.x * r1.x;
  o0.w = saturate(r1.y);
  o0.z = r0.x ? r1.x : r0.w;
  o0.xy = r0.yz;
