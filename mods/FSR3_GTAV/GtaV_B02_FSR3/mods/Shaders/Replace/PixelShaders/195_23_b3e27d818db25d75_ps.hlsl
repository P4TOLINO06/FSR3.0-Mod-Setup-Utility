  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.z = 1 + -r2.x;
  r2.xy = cmp(float2(0,0) != postProcess_FlipDepth_NearPlaneFade_Params.zw);
  r1.w = 1 + -r1.z;
  r1.z = r2.x ? r1.w : r1.z;
  r1.z = 1 + -r1.z;
  r1.z = r1.z * NearFarPlane.z + NearFarPlane.w;
  r1.z = 1 / r1.z;
  r1.z = -v7.w + r1.z;
  r1.z = r1.z * r1.z + -v7.x;
  r1.w = saturate(v5.x * r1.z);
  r1.w = v0.w * r1.w;
  r1.z = -gSoftnessShadowOffset + r1.z;
  r1.z = saturate(v5.x * r1.z);
  r2.x = 1 + -r1.z;
  r2.z = 1 + -gSoftnessShadowMult;
  r1.z = r2.x * r2.z + r1.z;
  r3.xyz = v0.xyz * r1.zzz;
  r1.z = saturate(20 * v12.x);
  r1.z = r2.y ? r1.z : 1;
  r3.w = r1.w * r1.z;
  ...
  r2.w = saturate(r2.w);
  r0.xyz = -r3.xyz * r0.xyz + v4.xyz;
  r0.xyz = r0.www * r0.xyz + r2.xyz;
  o0.xyz = globalScalars3.zzz * r0.xyz;
  r0.x = gGlobalParticleDofAlphaScale * r2.w;
  o0.w = r2.w;
  r0.y = v7.w;
  o1.x = r0.y;
  o2.x = r0.x;
