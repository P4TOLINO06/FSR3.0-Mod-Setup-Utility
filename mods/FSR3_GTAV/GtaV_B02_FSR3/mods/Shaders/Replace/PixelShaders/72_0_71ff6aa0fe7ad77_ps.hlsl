  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = r0.x * r0.y;
  r1.yz = globalScalars.zy * v0.xy;
  r0.x = r1.y * r0.x;
  r0.y = -specularIntensityMult * 0.5 + 1;
  r0.y = r0.x * r0.y;
  r0.y = r0.y * -0.5 + 1;
  ...
  r0.y = saturate(0.400000006 + specularIntensityMult);
  r2.xy = float2(0.5,0.48828125) * r0.yy;
  r0.yw = -float2(specularIntensityMult, specularFresnel);
  r2.z = 0.970000029;
  ...
  r2.y = r0.z * r0.x + r1.y;
  r2.xz = r0.yw * r0.xx + float2(specularIntensityMult, specularFresnel);
  o2.xy = sqrt(r2.xy);
  o2.z = r2.z;
  o2.w = 1;
  r1.x = v0.x * globalScalars.z + gLightArtificialIntAmbient0.w;
