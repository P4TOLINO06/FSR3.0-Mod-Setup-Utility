  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xy = r2.yy * r0.xy;
  r2.yzw = v7.xyz * r0.yyy;
  r2.yzw = r0.xxx * v6.xyz + r2.yzw;
  r2.xyz = r2.xxx * v4.xyz + r2.yzw;
  r0.x = dot(r2.xyz, r2.xyz);
  r0.x = rsqrt(r0.x);
  r2.xyw = r2.xyz * r0.xxx;
  r3.x = dot(v6.xyz, gDirectionalLight.xyz);
  r3.y = dot(v7.xyz, gDirectionalLight.xyz);
  r0.y = dot(v4.xyz, gDirectionalLight.xyz);
  r3.z = 1 + -v3.z;
