  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.y = dot(r0.xyz, SpecDesaturateExponent.xyz);
  r2.w = cmp(r1.x < 0.5);
  r3.x = dot(SpecDesaturateIntensity.ww, r1.xx);
  r1.x = 1 + -r1.x;
  r1.x = r1.x + r1.x;
  r3.y = 1 + -SpecDesaturateIntensity.w;
  r1.x = -r1.x * r3.y + 1;
  r3.x = r2.w ? r3.x : r1.x;
  r1.x = cmp(r1.y < 0.5);
  r2.w = dot(SpecDesaturateExponent.ww, r1.yy);
  r1.y = 1 + -r1.y;
  r1.y = r1.y + r1.y;
  r3.z = 1 + -SpecDesaturateExponent.w;
  r1.y = -r1.y * r3.z + 1;
  r3.y = r1.x ? r2.w : r1.y;
  r1.x = dot(r3.xy, specMapIntMask.xy);
  r3.x = specularIntensityMult * r1.x;
  r1.y = saturate(v4.z * 128 + -127);
