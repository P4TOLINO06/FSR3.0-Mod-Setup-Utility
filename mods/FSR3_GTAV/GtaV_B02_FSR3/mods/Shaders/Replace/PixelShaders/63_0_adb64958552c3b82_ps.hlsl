  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.z = dot(-r4.xyz, r1.yzw);
  r2.z = r2.z + r2.z;
  r4.xyz = r1.yzw * -r2.zzz + -r4.xyz;
  r2.z = dot(r4.xyz, r4.xyz);
  r2.z = rsqrt(r2.z);
  r2.zw = r4.xz * r2.zz + float2(1,1);
  r2.zw = float2(-0.5,-0.5) * r2.zw;
  r4.xyzw = EnvironmentSampler.Sample(EnvironmentSampler_s, r2.zw).xyzw;
  r4.xyz = reflectivePower * r4.xyz;
  r2.z = cmp(globalScalars.w == 0.000000);
  r2.z = r2.z ? 0 : 1;
