// ---- FNV Hash e3ae5b8d711f2582

// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 23 17:40:50 2023
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.xy = r1.xy * r1.xy;
  r0.x = dot(r1.xyz, specMapIntMask.xyz);
  r1.x = specularIntensityMult * r0.x;
  ...
  r0.x = saturate(r0.x * specularIntensityMult + 0.699999988);
