...
SamplerState lookupSampler_s : register(s10);
...
Texture2D<float4> lookupSampler : register(t10);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xyzw = BumpSampler_layer2.Sample(BumpSampler_layer2_s, v1.xy).xyzw;
  r1.xyzw = BumpSampler_layer0.Sample(BumpSampler_layer0_s, v1.xy).xyzw;
  r2.xyzw = BumpSampler_layer1.Sample(BumpSampler_layer1_s, v1.xy).xyzw;
  r3.xyzw = lookupSampler.Sample(lookupSampler_s, v1.zw).xyzw;
  r4.xyz = v2.xyz + -r3.xyz;
  r3.xyz = v2.www * r4.xyz + r3.xyz;
  ...
  r0.w = materialWetnessMultiplier.x * r0.z + r0.w;
  r1.xy = r1.xy * r0.zz + r1.zw;
  r0.z = r4.x * r3.y;
  r1.z = r0.z * r4.z;
  r0.z = r0.z * r3.z;
  r3.xyz = saturate(r3.xyz);
  r0.xy = r0.xy * r1.zz + r1.xy;
  r0.w = materialWetnessMultiplier.z * r1.z + r0.w;
  r0.w = materialWetnessMultiplier.w * r0.z + r0.w;
  r1.xyzw = BumpSampler_layer3.Sample(BumpSampler_layer3_s, v1.xy).xyzw;
  r0.xy = r1.xy * r0.zz + r0.xy;
  r0.xy = r0.xy * float2(2,2) + float2(-1,-1);
  r0.z = max(0.00100000005, bumpiness);
  r1.xy = r0.xy * r0.zz;
  ...
  r0.xyz = r0.xxx * v3.xyz + r1.xyz;
  r1.x = dot(r0.xyz, r0.xyz);
  r1.x = rsqrt(r1.x);
  r1.y = r0.z * r1.x + -0.349999994;
  r0.xyz = r1.xxx * r0.xyz;
  o1.xyz = r0.xyz * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  r0.x = saturate(1.53846157 * r1.y);
  ...
  r0.z = r1.x * r0.z;
  r0.z = r0.z * -0.5 + 1;
  r1.xyzw = TextureSampler_layer0.Sample(TextureSampler_layer0_s, v1.xy).xyzw;
  r2.xyzw = TextureSampler_layer1.Sample(TextureSampler_layer1_s, v1.xy).xyzw;
  r4.xyz = float3(1,1,1) + -r3.xyz;
  r1.w = r4.x * r4.y;
  r2.w = r1.w * r3.z;
  r1.w = r1.w * r4.z;
  ...
  r3.xyzw = TextureSampler_layer3.Sample(TextureSampler_layer3_s, v1.xy).xyzw;
  r1.xyz = r3.xyz * r2.xxx + r1.xyz;
  o0.xyz = r1.xyz * r0.zzz;
  r0.z = dot(r1.xyz, float3(1.27499998,4.29239988,0.432599992));
  r0.z = 0.5 + -r0.z;
  o2.w = saturate(v3.w + -r0.z);
  o0.w = globalScalars.x;
  r0.z = dot(v3.xyz, v3.xyz);
  r0.z = rsqrt(r0.z);
  r0.z = v3.z * r0.z;
  r0.z = saturate(r0.z * 128 + -127);
  o1.w = r0.z * r0.w;
