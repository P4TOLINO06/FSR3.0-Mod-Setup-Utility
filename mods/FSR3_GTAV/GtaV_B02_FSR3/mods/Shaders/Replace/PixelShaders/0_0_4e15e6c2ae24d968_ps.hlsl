...
SamplerState WrinkleMaskSampler_4_s : register(s11);
SamplerState WrinkleMaskSampler_5_s : register(s12);
SamplerState WrinkleSampler_A_s : register(s13);
SamplerState WrinkleSampler_B_s : register(s14);
...
Texture2D<float4> WrinkleMaskSampler_4 : register(t11);
Texture2D<float4> WrinkleMaskSampler_5 : register(t12);
Texture2D<float4> WrinkleSampler_A : register(t13);
Texture2D<float4> WrinkleSampler_B : register(t14);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r3.w = dot(wrinkleMaskStrengths3.xyzw, r4.xyzw);
  r4.xyzw = WrinkleMaskSampler_4.Sample(WrinkleMaskSampler_4_s, v1.xy).xyzw;
  r4.x = dot(wrinkleMaskStrengths4.xyzw, r4.xyzw);
  r3.w = r4.x + r3.w;
  r4.xyzw = WrinkleMaskSampler_5.Sample(WrinkleMaskSampler_5_s, v1.xy).xyzw;
  r4.x = dot(wrinkleMaskStrengths5.xyzw, r4.xyzw);
  r3.w = r4.x + r3.w;
  ...
  if (r4.w != 0) {
    ...
    if (r2.x != 0) {
      ...
      r2.x = r2.z ? 1.000000 : 0;
      r9.x = r6.w + -r8.w;
      r9.y = r7.w + -r8.w;
      r6.x = r8.y;
      r6.y = r7.x;
      r2.y = r6.x * r5.z;
      r5.yz = r6.zy * r5.zz + -r2.yy;
      r2.xy = r2.xx * r9.xy + r5.yz;
