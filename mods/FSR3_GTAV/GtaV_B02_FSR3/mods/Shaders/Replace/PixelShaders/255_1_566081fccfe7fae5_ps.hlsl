  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r3.w == 0) {
    r4.w = cmp(4 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r4.w;
    r4.w = cmp(gLightColourAndCapsuleExtent[4].w == 0.000000);
    r6.xyz = gLightPositionAndInvDistSqr[4].xyz + -v3.xyz;
    r7.xyz = -gLightPositionAndInvDistSqr[4].xyz + v3.xyz;
    r5.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[4].xyz);
    r6.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[4].w;
    r5.w = saturate(r5.w / r6.w);
    r5.w = gLightColourAndCapsuleExtent[4].w * r5.w;
    r7.xyz = gLightDirectionAndFalloffExponent[4].xyz * r5.www + gLightPositionAndInvDistSqr[4].xyz;
    r7.xyz = -v3.xyz + r7.xyz;
    r6.xyz = r4.www ? r6.xyz : r7.xyz;
    r4.w = dot(r6.xyz, r6.xyz);
    r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
    ...
    r5.w = rsqrt(r5.w);
    r6.xyz = r6.xyz * r5.www;
    r4.w = saturate(-r4.w * gLightPositionAndInvDistSqr[4].w + 1);
    r5.w = 1 + -gLightDirectionAndFalloffExponent[4].w;
    r5.w = r5.w * r4.w + gLightDirectionAndFalloffExponent[4].w;
    r4.w = r4.w / r5.w;
    r5.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[4].xyz);
    r5.w = saturate(r5.w * gLightConeScale[4] + gLightConeOffset[4]);
    r6.x = saturate(dot(r6.xyz, r1.yzw));
    r5.w = r6.x * r5.w;
    r4.w = r5.w * r4.w;
    r6.xyz = gLightColourAndCapsuleExtent[4].xyz * r4.www;
    r6.xyz = r6.xyz * r0.xyz + r5.xyz;
    r5.xyz = r3.www ? r5.xyz : r6.xyz;
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    r4.w = cmp(5 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r4.w;
    r4.w = cmp(gLightColourAndCapsuleExtent[5].w == 0.000000);
    r6.xyz = gLightPositionAndInvDistSqr[5].xyz + -v3.xyz;
    r7.xyz = -gLightPositionAndInvDistSqr[5].xyz + v3.xyz;
    r5.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[5].xyz);
    r6.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[5].w;
    r5.w = saturate(r5.w / r6.w);
    r5.w = gLightColourAndCapsuleExtent[5].w * r5.w;
    r7.xyz = gLightDirectionAndFalloffExponent[5].xyz * r5.www + gLightPositionAndInvDistSqr[5].xyz;
    r7.xyz = -v3.xyz + r7.xyz;
    r6.xyz = r4.www ? r6.xyz : r7.xyz;
    r4.w = dot(r6.xyz, r6.xyz);
    r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
    ...
    r5.w = rsqrt(r5.w);
    r6.xyz = r6.xyz * r5.www;
    r4.w = saturate(-r4.w * gLightPositionAndInvDistSqr[5].w + 1);
    r5.w = 1 + -gLightDirectionAndFalloffExponent[5].w;
    r5.w = r5.w * r4.w + gLightDirectionAndFalloffExponent[5].w;
    r4.w = r4.w / r5.w;
    r5.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[5].xyz);
    r5.w = saturate(r5.w * gLightConeScale[5] + gLightConeOffset[5]);
    r6.x = saturate(dot(r6.xyz, r1.yzw));
    r5.w = r6.x * r5.w;
    r4.w = r5.w * r4.w;
    r6.xyz = gLightColourAndCapsuleExtent[5].xyz * r4.www;
    r6.xyz = r6.xyz * r0.xyz + r5.xyz;
    r5.xyz = r3.www ? r5.xyz : r6.xyz;
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    r4.w = cmp(6 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r4.w;
    r4.w = cmp(gLightColourAndCapsuleExtent[6].w == 0.000000);
    r6.xyz = gLightPositionAndInvDistSqr[6].xyz + -v3.xyz;
    r7.xyz = -gLightPositionAndInvDistSqr[6].xyz + v3.xyz;
    r5.w = dot(r7.xyz, gLightDirectionAndFalloffExponent[6].xyz);
    r6.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[6].w;
    r5.w = saturate(r5.w / r6.w);
    r5.w = gLightColourAndCapsuleExtent[6].w * r5.w;
    r7.xyz = gLightDirectionAndFalloffExponent[6].xyz * r5.www + gLightPositionAndInvDistSqr[6].xyz;
    r7.xyz = -v3.xyz + r7.xyz;
    r6.xyz = r4.www ? r6.xyz : r7.xyz;
    r4.w = dot(r6.xyz, r6.xyz);
    r6.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r6.xyz;
    ...
    r5.w = rsqrt(r5.w);
    r6.xyz = r6.xyz * r5.www;
    r4.w = saturate(-r4.w * gLightPositionAndInvDistSqr[6].w + 1);
    r5.w = 1 + -gLightDirectionAndFalloffExponent[6].w;
    r5.w = r5.w * r4.w + gLightDirectionAndFalloffExponent[6].w;
    r4.w = r4.w / r5.w;
    r5.w = dot(r6.xyz, -gLightDirectionAndFalloffExponent[6].xyz);
    r5.w = saturate(r5.w * gLightConeScale[6] + gLightConeOffset[6]);
    r6.x = saturate(dot(r6.xyz, r1.yzw));
    r5.w = r6.x * r5.w;
    r4.w = r5.w * r4.w;
    r6.xyz = gLightColourAndCapsuleExtent[6].xyz * r4.www;
    r6.xyz = r6.xyz * r0.xyz + r5.xyz;
    r5.xyz = r3.www ? r5.xyz : r6.xyz;
  } else {
    r3.w = -1;
  ...
  if (r3.w == 0) {
    ...
    r5.w = r6.x * r5.w;
    r4.w = r5.w * r4.w;
    r6.xyz = gLightColourAndCapsuleExtent[7].xyz * r4.www;
    r6.xyz = r6.xyz * r0.xyz + r5.xyz;
    r5.xyz = r3.www ? r5.xyz : r6.xyz;
  }
