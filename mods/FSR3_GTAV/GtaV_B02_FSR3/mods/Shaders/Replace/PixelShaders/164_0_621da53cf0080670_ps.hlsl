  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = CurLumSampler.Sample(CurLumSampler_s, v1.xy).y;
  r0.x = max(BokehParams2.y, r0.x);
  r0.x = min(BokehParams2.x, r0.x);
  r0.x = abs(BokehParams2.y) + r0.x;
  r0.y = BokehParams2.x + -BokehParams2.y;
  r0.x = r0.x / r0.y;
  r0.x = r0.x * -15 + 15;
  r0.x = trunc(r0.x);
  ...
  r0.x = r0.x * 0.25 + r0.y;
  r0.y = r0.z * 0.25 + r0.w;
  r0.x = HeatHazeSampler.Sample(HeatHazeSampler_s, r0.xy).y;
