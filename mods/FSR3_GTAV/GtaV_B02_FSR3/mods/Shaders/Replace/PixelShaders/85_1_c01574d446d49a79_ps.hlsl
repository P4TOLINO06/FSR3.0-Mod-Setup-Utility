  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.xy = r2.xy * r2.xy;
  r1.w = dot(r2.xyz, specMapIntMask.xyz);
  r2.x = specularIntensityMult * r1.w;
  r2.w = specularFalloffMult * r2.w;
  r3.x = saturate(v3.z * 128 + -127);
  ...
  r0.x = saturate(r1.w * specularIntensityMult + 0.400000006);
