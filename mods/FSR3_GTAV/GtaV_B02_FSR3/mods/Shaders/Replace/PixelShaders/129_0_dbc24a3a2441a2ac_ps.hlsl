...
cbuffer vehiclecommonlocals : register(b11)
{
  ...
  float diffuse3SpecMod : packoffset(c7.y);
...
SamplerState DiffuseSampler3_s : register(s3);
...
Texture2D<float4> DiffuseSampler3 : register(t3);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xyzw = DiffuseSampler3.Sample(DiffuseSampler3_s, v1.zw).xyzw;
  ...
  r0.xyz = r0.xyz * matDiffuseColor2.xyz + -r4.yzw;
  r0.xyz = r0.www * r0.xyz + r4.yzw;
  r0.w = cmp(r0.w >= 1);
  r0.w = r0.w ? 1.000000 : 0;
  r4.yzw = r0.xyz * r5.xyz + -r0.xyz;
  r1.xyz = r0.www * r4.yzw + r0.xyz;
