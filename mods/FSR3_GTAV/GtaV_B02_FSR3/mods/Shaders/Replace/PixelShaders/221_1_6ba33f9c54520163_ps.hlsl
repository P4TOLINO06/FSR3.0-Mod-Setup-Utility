  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xy = UpdateOffset.zw + v1.xy;
  r0.xyzw = HeightMapSampler.Sample(HeightMapSampler_s, r0.xy).xyzw;
  r1.xyzw = VelocityMapSampler.Sample(VelocityMapSampler_s, v1.xy).xyzw;
  r0.x = UpdateParams0.x * r1.x + r0.x;
  r0.x = max(-2000, r0.x);
  o0.x = min(2000, r0.x);
  return;
}