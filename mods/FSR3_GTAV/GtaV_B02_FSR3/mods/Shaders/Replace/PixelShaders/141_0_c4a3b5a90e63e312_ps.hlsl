  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.w = rsqrt(r2.w);
  r4.xyz = v4.xzy * r2.www;
  r2.w = dot(-r4.xzy, r2.xyz);
  r2.w = r2.w + r2.w;
  r4.xyz = r2.xzy * -r2.www + -r4.xyz;
  r2.w = dot(r4.xyz, r4.xyz);
  r2.w = rsqrt(r2.w);
  r4.xyz = r4.xyz * r2.www;
  r4.xyzw = EnvironmentSampler.Sample(EnvironmentSampler_s, r4.xyz).xyzw;
  r4.xyz = reflectivePower * r4.xyz;
  r2.w = cmp(globalScalars.w == 0.000000);
  r2.w = r2.w ? 0 : 1;
  ...
  r0.x = saturate(r1.x * specularIntensityMult + 0.400000006);
