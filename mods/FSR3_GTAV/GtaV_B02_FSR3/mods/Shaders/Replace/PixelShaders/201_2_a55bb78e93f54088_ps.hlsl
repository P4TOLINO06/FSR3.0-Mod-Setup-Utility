  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r6.w == 0) {
    ...
    r10.y = r10.y * r10.y;
    r10.x = r10.x * r10.y;
    r10.x = r10.x * 0.967999995 + 0.0320000015;
  ...
  if (r7.z != 0) {
    ...
    if (r6.w == 0) {
      ...
      r11.x = r11.x * r11.x;
      r10.w = r11.x * r10.w;
      r10.w = r10.w * 0.967999995 + 0.0320000015;
  ...
  if (r6.w == 0) {
    ...
    if (r6.w == 0) {
      ...
      r7.z = r7.z * r6.w + gLightDirectionAndFalloffExponent[3].w;
      r6.w = r6.w / r7.z;
      ...
      r9.x = r9.x * r9.x;
      r3.w = r9.x * r3.w;
      r3.w = r3.w * 0.967999995 + 0.0320000015;
      ...
      r3.x = r3.x * r6.w;
      r3.x = r3.x * r7.w;
      r8.xzw = r3.xxx * gLightColourAndCapsuleExtent[3].xyz + r8.xzw;
    }
  }
  r3.x = r7.y * r7.y;
  r2.x = r2.x * r2.x;
