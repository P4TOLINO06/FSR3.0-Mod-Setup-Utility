  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.xyzw = UITexture0.Sample(UITexture0_s, v1.xy).xyzw;
  r2.xyzw = v2.xyzw * UIColorXformScale.xyzw + UIColorXformOffset.xyzw;
  r0.y = r2.w * r1.w;
  r1.xyz = r2.xyz * r0.yyy;
  r0.yz = globalScalars.wx * r0.yy;
  r1.xyz = r0.xxx ? r2.xyz : r1.xyz;
  r0.x = cmp(globalScalars.w != 1.000000);
  r0.y = r0.y * r0.y;
  o0.w = saturate(r0.z);
  o0.z = r0.x ? r0.y : r1.z;
  o0.xy = r1.xy;
