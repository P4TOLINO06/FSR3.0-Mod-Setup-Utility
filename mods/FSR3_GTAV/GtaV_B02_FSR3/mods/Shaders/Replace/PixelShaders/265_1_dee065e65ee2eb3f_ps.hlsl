  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.xyzw = cb5[71].xyxy * float4(1.38461995,0,-1.38461995,0) + v1.xyxy;
  ...
  r1.xyzw = cb5[71].xyxy * float4(3.23077011,0,-3.23077011,0) + v1.xyxy;
  r2.xyzw = t5.Sample(s5_s, r1.xy).xyzw;
  r1.xyzw = t5.Sample(s5_s, r1.zw).xyzw;
  r0.xyzw = r2.xyzw * float4(0.0702700019,0.0702700019,0.0702700019,0.0702700019) + r0.xyzw;
  o0.xyzw = r1.xyzw * float4(0.0702700019,0.0702700019,0.0702700019,0.0702700019) + r0.xyzw;
  return;
}