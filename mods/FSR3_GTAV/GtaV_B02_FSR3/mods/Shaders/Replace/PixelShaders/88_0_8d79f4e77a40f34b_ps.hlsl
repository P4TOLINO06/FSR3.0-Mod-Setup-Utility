  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = rsqrt(r0.x);
  r0.y = v4.z * r0.x + -0.349999994;
  r0.xzw = v4.xyz * r0.xxx;
  r0.xzw = r0.xzw * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  ...
  r4.xyz = float3(256,256,256) * r0.xzw;
  r4.xyz = floor(r4.xyz);
  r0.xzw = r0.xzw * float3(256,256,256) + -r4.xyz;
  o1.xyz = float3(0.00390625,0.00390625,0.00390625) * r4.xyz;
  r0.xzw = float3(8,8,4) * r0.xzw;
  r0.xzw = floor(r0.xzw);
  r0.x = dot(r0.xzw, float3(32,4,1));
