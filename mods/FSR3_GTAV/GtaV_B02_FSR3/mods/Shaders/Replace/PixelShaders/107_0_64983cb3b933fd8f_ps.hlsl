  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.w = saturate(v3.z * 128 + -127);
  r0.w = v1.w * r0.w;
  r4.y = globalScalars.y * v1.y;
  r5.xyz = r0.xyz * v6.xyz + -r0.xyz;
  r0.xyz = v6.www * r5.xyz + r0.xyz;
  ...
  r4.x = gLightArtificialIntAmbient0.w + v2.z;
