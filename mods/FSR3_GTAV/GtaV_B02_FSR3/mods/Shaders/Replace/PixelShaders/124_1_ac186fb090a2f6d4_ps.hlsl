...
cbuffer vehiclecommonlocals : register(b12)
{
  ...
  float4 specular2Color_DirLerp : packoffset(c5);
  float reflectivePower : packoffset(c6);
  float envEffThickness : packoffset(c6.y);
  float2 envEffScale : packoffset(c6.z);
  float envEffTexTileUV : packoffset(c7);
}
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r3.y = globalScalars.y * r1.y;
  r1.y = emissiveMultiplier * v3.x;
  r1.y = dirtLevelMod.z * r1.y;
  r2.w = v3.x * r4.y;
  r3.zw = float2(1,2) + -dirtLevelMod.zz;
  r5.x = v3.z * r3.z;
  r5.yz = v1.zw * r3.ww;
  r6.xyzw = DirtSampler.Sample(DirtSampler_s, r5.yz).xyzw;
  r3.w = dirtLevelMod.z * gDynamicBakesAndWetness.z;
  r5.y = r6.z + -r6.x;
  r6.x = r3.w * r5.y + r6.x;
  r5.yz = dirtLevelMod.xx * r6.xy;
  r3.w = v3.z * r3.z + -1;
  r3.z = r3.z * r3.w + 1;
  r3.w = r5.y * r3.z;
  r6.xyw = dirtColor.xyz * dirtLevelMod.yyy + -r0.xyz;
  r0.xyz = r3.www * r6.xyw + r0.xyz;
  r3.w = dirtLevelMod.x * r5.x;
  r5.xyw = r6.zzz + -r0.xyz;
