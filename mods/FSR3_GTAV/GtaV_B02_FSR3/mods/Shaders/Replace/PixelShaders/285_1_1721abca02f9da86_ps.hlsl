  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r6.xy = envEffTexTileUV * v1.xy;
  r7.xyzw = SnowSampler0.Sample(SnowSampler0_s, r6.xy).xyzw;
  r6.xyzw = SnowSampler1.Sample(SnowSampler1_s, r6.xy).xyzw;
  r5.w = saturate(v4.w + v4.w);
  r6.w = -0.5 + v4.w;
  ...
  r1.xy = r0.yy * float2(0.5,0.48828125) + -r5.xy;
  r1.z = 0;
