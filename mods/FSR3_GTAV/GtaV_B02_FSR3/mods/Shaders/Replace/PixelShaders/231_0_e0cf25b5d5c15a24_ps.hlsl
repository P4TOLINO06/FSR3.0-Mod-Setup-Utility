  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xy = frac(r0.xy);
  r0.xyzw = Texture1.Sample(Sampler8_s, r0.xy).xyzw;
  r0.xyz = r0.xyz * float3(2,2,2) + float3(-1,-1,-1);
  o0.w = r0.w;
  r1.x = dot(r0.xyz, Matrix04[0].xyz);
  r1.y = dot(r0.xyz, Matrix04[1].xyz);
  r1.z = dot(r0.xyz, Matrix04[2].xyz);
