  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xyz = Texture4.Sample(Sampler8_s, v1.xy).xyz;
  r0.xyz = r0.xyz * r0.xyz;
  r0.w = max(r0.y, r0.z);
  r0.w = max(r0.x, r0.w);
  r0.w = -r0.w * 0.899999976 + 1;
  r0.w = max(0, r0.w);
  r1.xyzw = Texture0.Sample(Sampler8_s, v1.xy).xyzw;
  r2.xyz = r1.xyz * r0.xyz;
  r3.xyz = r2.xyz * r0.xyz;
  r3.xyz = r3.xyz * float3(0.300000012,0.300000012,0.300000012) + -r2.xyz;
  r2.xyz = r0.www * r3.xyz + r2.xyz;
  r1.xyz = -r2.xyz + r1.xyz;
  o0.w = r1.w;
  r3.xyzw = Texture3.Sample(Sampler8_s, v1.xy).xyzw;
  r0.w = log2(r3.w);
  r0.w = Parameters01.x * r0.w;
  r0.w = exp2(r0.w);
  r1.xyz = r0.www * r1.xyz + r2.xyz;
  r2.xyz = r3.xyz * r3.xyz;
  r2.xyz = r2.xyz * r3.xyz;
  r2.xyz = Parameters01.yyy * r2.xyz;
  r0.xyz = r2.xyz * r0.xyz;
  o0.xyz = r0.xyz * float3(25,25,25) + r1.xyz;
  return;
}