  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r3.w == 0) {
    ...
    r3.w = (int)r3.w | (int)r9.x;
    if (r3.w == 0) {
      r9.x = cmp(gLightColourAndCapsuleExtent[3].w == 0.000000);
      r9.yzw = gLightPositionAndInvDistSqr[3].xyz + -v6.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[3].xyz + v6.xyz;
      r10.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[3].xyz);
      r11.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[3].w;
      r10.w = saturate(r10.w / r11.x);
      r10.w = gLightColourAndCapsuleExtent[3].w * r10.w;
      r11.xyz = gLightDirectionAndFalloffExponent[3].xyz * r10.www + gLightPositionAndInvDistSqr[3].xyz;
      r11.xyz = -v6.xyz + r11.xyz;
      r9.xyz = r9.xxx ? r9.yzw : r11.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r9.xyz;
      ...
      r10.w = rsqrt(r10.w);
      r9.xyz = r10.www * r9.xyz;
      r9.w = saturate(-r9.w * gLightPositionAndInvDistSqr[3].w + 1);
      r10.w = 1 + -gLightDirectionAndFalloffExponent[3].w;
      r10.w = r10.w * r9.w + gLightDirectionAndFalloffExponent[3].w;
      r9.w = r9.w / r10.w;
      r10.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[3].xyz);
      r10.w = saturate(r10.w * gLightConeScale[3] + gLightConeOffset[3]);
      r11.x = dot(r9.xyz, r2.xyz);
      r11.y = saturate(r11.x);
      r11.y = r11.y + -abs(r11.x);
      r11.x = r0.w * r11.y + abs(r11.x);
      ...
      r9.x = r9.x * r9.w;
      r9.x = r9.x * r5.w;
      r8.xyz = r9.xxx * gLightColourAndCapsuleExtent[3].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r9.x = cmp(4 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r9.x;
    if (r3.w == 0) {
      r9.x = cmp(gLightColourAndCapsuleExtent[4].w == 0.000000);
      r9.yzw = gLightPositionAndInvDistSqr[4].xyz + -v6.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[4].xyz + v6.xyz;
      r10.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[4].xyz);
      r11.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[4].w;
      r10.w = saturate(r10.w / r11.x);
      r10.w = gLightColourAndCapsuleExtent[4].w * r10.w;
      r11.xyz = gLightDirectionAndFalloffExponent[4].xyz * r10.www + gLightPositionAndInvDistSqr[4].xyz;
      r11.xyz = -v6.xyz + r11.xyz;
      r9.xyz = r9.xxx ? r9.yzw : r11.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r9.xyz;
      ...
      r10.w = rsqrt(r10.w);
      r9.xyz = r10.www * r9.xyz;
      r9.w = saturate(-r9.w * gLightPositionAndInvDistSqr[4].w + 1);
      r10.w = 1 + -gLightDirectionAndFalloffExponent[4].w;
      r10.w = r10.w * r9.w + gLightDirectionAndFalloffExponent[4].w;
      r9.w = r9.w / r10.w;
      r10.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[4].xyz);
      r10.w = saturate(r10.w * gLightConeScale[4] + gLightConeOffset[4]);
      r11.x = dot(r9.xyz, r2.xyz);
      r11.y = saturate(r11.x);
      r11.y = r11.y + -abs(r11.x);
      r11.x = r0.w * r11.y + abs(r11.x);
      ...
      r9.x = r9.x * r9.w;
      r9.x = r9.x * r5.w;
      r8.xyz = r9.xxx * gLightColourAndCapsuleExtent[4].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r9.x = cmp(5 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r9.x;
    if (r3.w == 0) {
      r9.x = cmp(gLightColourAndCapsuleExtent[5].w == 0.000000);
      r9.yzw = gLightPositionAndInvDistSqr[5].xyz + -v6.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[5].xyz + v6.xyz;
      r10.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[5].xyz);
      r11.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[5].w;
      r10.w = saturate(r10.w / r11.x);
      r10.w = gLightColourAndCapsuleExtent[5].w * r10.w;
      r11.xyz = gLightDirectionAndFalloffExponent[5].xyz * r10.www + gLightPositionAndInvDistSqr[5].xyz;
      r11.xyz = -v6.xyz + r11.xyz;
      r9.xyz = r9.xxx ? r9.yzw : r11.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r9.xyz;
      ...
      r10.w = rsqrt(r10.w);
      r9.xyz = r10.www * r9.xyz;
      r9.w = saturate(-r9.w * gLightPositionAndInvDistSqr[5].w + 1);
      r10.w = 1 + -gLightDirectionAndFalloffExponent[5].w;
      r10.w = r10.w * r9.w + gLightDirectionAndFalloffExponent[5].w;
      r9.w = r9.w / r10.w;
      r10.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[5].xyz);
      r10.w = saturate(r10.w * gLightConeScale[5] + gLightConeOffset[5]);
      r11.x = dot(r9.xyz, r2.xyz);
      r11.y = saturate(r11.x);
      r11.y = r11.y + -abs(r11.x);
      r11.x = r0.w * r11.y + abs(r11.x);
      ...
      r9.x = r9.x * r9.w;
      r9.x = r9.x * r5.w;
      r8.xyz = r9.xxx * gLightColourAndCapsuleExtent[5].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r9.x = cmp(6 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r9.x;
    if (r3.w == 0) {
      r9.x = cmp(gLightColourAndCapsuleExtent[6].w == 0.000000);
      r9.yzw = gLightPositionAndInvDistSqr[6].xyz + -v6.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[6].xyz + v6.xyz;
      r10.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[6].xyz);
      r11.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[6].w;
      r10.w = saturate(r10.w / r11.x);
      r10.w = gLightColourAndCapsuleExtent[6].w * r10.w;
      r11.xyz = gLightDirectionAndFalloffExponent[6].xyz * r10.www + gLightPositionAndInvDistSqr[6].xyz;
      r11.xyz = -v6.xyz + r11.xyz;
      r9.xyz = r9.xxx ? r9.yzw : r11.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r9.xyz;
      ...
      r10.w = rsqrt(r10.w);
      r9.xyz = r10.www * r9.xyz;
      r9.w = saturate(-r9.w * gLightPositionAndInvDistSqr[6].w + 1);
      r10.w = 1 + -gLightDirectionAndFalloffExponent[6].w;
      r10.w = r10.w * r9.w + gLightDirectionAndFalloffExponent[6].w;
      r9.w = r9.w / r10.w;
      r10.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[6].xyz);
      r10.w = saturate(r10.w * gLightConeScale[6] + gLightConeOffset[6]);
      r11.x = dot(r9.xyz, r2.xyz);
      r11.y = saturate(r11.x);
      r11.y = r11.y + -abs(r11.x);
      r11.x = r0.w * r11.y + abs(r11.x);
      ...
      r9.x = r9.x * r9.w;
      r9.x = r9.x * r5.w;
      r8.xyz = r9.xxx * gLightColourAndCapsuleExtent[6].xyz + r8.xyz;
    }
  } else {
    r3.w = -1;
  }
  if (r3.w == 0) {
    r9.x = cmp(7 >= gNumForwardLights);
    r3.w = (int)r3.w | (int)r9.x;
    if (r3.w == 0) {
      r3.w = cmp(gLightColourAndCapsuleExtent[7].w == 0.000000);
      r9.xyz = gLightPositionAndInvDistSqr[7].xyz + -v6.xyz;
      r11.xyz = -gLightPositionAndInvDistSqr[7].xyz + v6.xyz;
      r9.w = dot(r11.xyz, gLightDirectionAndFalloffExponent[7].xyz);
      r10.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[7].w;
      r9.w = saturate(r9.w / r10.w);
      r9.w = gLightColourAndCapsuleExtent[7].w * r9.w;
      r11.xyz = gLightDirectionAndFalloffExponent[7].xyz * r9.www + gLightPositionAndInvDistSqr[7].xyz;
      r11.xyz = -v6.xyz + r11.xyz;
      ...
      r9.w = 1 + -gLightDirectionAndFalloffExponent[7].w;
      r9.w = r9.w * r3.w + gLightDirectionAndFalloffExponent[7].w;
      r3.w = r3.w / r9.w;
      r9.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[7].xyz);
      r9.w = saturate(r9.w * gLightConeScale[7] + gLightConeOffset[7]);
      ...
      r0.w = r0.w * r9.w;
      r9.w = r0.w * r3.w;
      r11.xyz = gLightColourAndCapsuleExtent[7].xyz * r9.www;
      r10.xyz = r11.xyz * r0.xyz + r10.xyz;
      ...
      r0.w = r0.w * r3.w;
      r0.w = r0.w * r5.w;
      r8.xyz = r0.www * gLightColourAndCapsuleExtent[7].xyz + r8.xyz;
    }
  }
  r0.w = r7.w * r7.w;
  r1.x = r1.x * r1.x;
