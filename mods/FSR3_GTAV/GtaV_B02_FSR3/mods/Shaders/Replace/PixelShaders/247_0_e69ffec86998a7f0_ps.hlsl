  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = saturate(-GradientFilterColMiddle.w + v1.y);
  r0.x = saturate(VignettingParams.w * r0.x);
  r0.x = saturate(-GradientFilterColBottom.w + r0.x);
  r0.yzw = -GradientFilterColMiddle.xyz + GradientFilterColBottom.xyz;
  r0.xyz = r0.xxx * r0.yzw + GradientFilterColMiddle.xyz;
  r0.w = saturate(VignettingColor.w * v1.y);
  r0.w = saturate(GradientFilterColTop.w + r0.w);
  r1.xyz = GradientFilterColMiddle.xyz + -GradientFilterColTop.xyz;
  r1.xyz = r0.www * r1.xyz + GradientFilterColTop.xyz;
  r0.xyz = -r1.xyz + r0.xyz;
  o0.xyz = v1.yyy * r0.xyz + r1.xyz;
  o0.w = 1;
  return;
}