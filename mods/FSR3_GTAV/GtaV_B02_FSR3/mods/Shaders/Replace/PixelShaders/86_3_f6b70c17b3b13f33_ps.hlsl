  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = -r2.x * 0.5 + 1;
  r4.xyzw = BumpSampler.Sample(BumpSampler_s, v2.xy).xyzw;
  ...
  r4.xyz = r0.yyy * v4.xyz + r4.xyz;
  r0.yzw = r0.www * v3.xyz + r4.xyz;
