  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r2.y != 0) {
    r6.x = saturate(dot(r1.yzw, -r5.xyz));
    r6.y = 0;
    r6.xyzw = SpecularRampTextureSampler.Sample(SpecularRampTextureSampler_s, r6.xy).xyzw;
  } else {
    r6.xyz = specular2Color_DirLerp.xyz;
  }
  r2.xyz = r6.xyz * r2.xxx;
  r5.xyz = v4.xyz * r3.xxx + -r5.xyz;
  r3.x = dot(r5.xyz, r5.xyz);
  r3.x = rsqrt(r3.x);
  r5.xyz = r5.xyz * r3.xxx;
  r3.x = dot(r1.yzw, r5.xyz);
  ...
  r5.xyz = float3(256,256,256) * r1.yzw;
  r5.xyz = floor(r5.xyz);
  r1.yzw = r1.yzw * float3(256,256,256) + -r5.xyz;
