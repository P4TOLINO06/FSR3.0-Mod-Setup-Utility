...
Texture2D<float4> EnvironmentSampler : register(t4);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.w = r2.w + r2.w;
  r4.xyz = r2.xyz * -r2.www + -r4.xyz;
  r2.w = dot(r4.xyz, r4.xyz);
  r2.w = rsqrt(r2.w);
  r4.xy = r4.xz * r2.ww + float2(1,1);
  r4.xy = float2(-0.5,-0.5) * r4.xy;
  r4.xyzw = EnvironmentSampler.Sample(EnvironmentSampler_s, r4.xy).xyzw;
