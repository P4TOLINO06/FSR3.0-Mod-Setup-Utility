  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r7.zw = r7.zw * r7.zw;
  r7.xy = r7.zw * r7.xy;
  r7.xy = r7.xy * float2(0.967999995,0.967999995) + float2(0.0320000015,0.0320000015);
  ...
  if (r5.w == 0) {
    ...
    r9.w = r9.w * r9.w;
    r8.w = r9.w * r8.w;
    r8.w = r8.w * 0.967999995 + 0.0320000015;
  ...
  if (r5.w == 0) {
    ...
    if (r5.w == 0) {
      ...
      r3.x = r3.x * r5.w;
      r3.x = r3.x * r6.w;
      r8.xyz = r3.xxx * gLightColourAndCapsuleExtent[7].xyz + r8.xyz;
    }
  }
  r3.x = r7.x * r7.x;
  r2.x = r2.x * r2.x;
