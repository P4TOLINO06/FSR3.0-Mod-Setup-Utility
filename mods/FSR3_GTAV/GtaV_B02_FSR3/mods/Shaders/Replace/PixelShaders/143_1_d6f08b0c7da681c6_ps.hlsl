  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = rsqrt(r0.x);
  r0.xyz = v5.xyz * r0.xxx + -gDirectionalLight.xyz;
  ...
  r2.xyzw = BumpSampler.Sample(BumpSampler_s, v3.xy).xyzw;
