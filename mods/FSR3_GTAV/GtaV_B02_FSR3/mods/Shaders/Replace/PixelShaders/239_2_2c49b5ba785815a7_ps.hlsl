  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.zw = floor(r0.xy);
  r0.zw = float2(0.00390625,0.00390625) * r0.zw;
  r1.xyzw = NoiseSampler.Sample(NoiseSampler_s, r0.zw).xyzw;
  r0.zw = r1.wy * float2(100,100) + r0.xy;
  r1.xyzw = WaterBumpSampler2.Sample(WaterBumpSampler2_s, r0.zw).xyzw;
  r2.xyzw = WaterBumpSampler2.Sample(WaterBumpSampler2_s, r0.xy).xyzw;
  r0.xy = frac(r0.xy);
  ...
  r1.xyw = r1.xxx * gReflectionWorldViewProj._m00_m03_m01 + r3.xyz;
  r1.xyz = r1.zzz * gReflectionWorldViewProj._m20_m23_m21 + r1.xyw;
  r1.xzw = float3(0.5,0.5,0.5) * r1.xyz;
  r3.y = r1.y * 0.5 + -r1.w;
  r3.x = r1.x + r1.z;
  r1.xy = r3.xy / r1.yy;
  r1.xyzw = PlanarReflectionSampler.Sample(PlanarReflectionSampler_s, r1.xy).xyzw;
  r3.xyzw = WetSampler.Sample(WetSampler_s, v1.zw).xyzw;
  r1.w = 0.649999976 * r3.x;
  r3.x = 512 + -v3.w;
  r3.x = saturate(0.001953125 * r3.x);
  r1.w = r3.x * r1.w;
  r3.xyzw = StaticFoamSampler.Sample(StaticFoamSampler_s, v4.zw).xyzw;
  r3.x = 0.349999994 * r3.y;
  r3.x = r3.x * r0.x + r1.w;
  r3.yw = float2(0.5,0.5);
  r4.xyzw = BlendSampler.Sample(BlendSampler_s, r3.xy).xyzw;
  r3.xy = v1.xy / v3.ww;
  r5.xyzw = LightingSampler.Sample(LightingSampler_s, r3.xy).xyzw;
  r6.xyzw = RefractionSampler.Sample(RefractionSampler_s, r3.xy).xyzw;
  r0.x = r5.y * r4.y;
  r1.w = dot(r0.yzw, -gDirectionalLight.xyz);
  r1.w = saturate(r1.w * 0.699999988 + 0.300000012);
  r4.xyz = gWaterDirectionalColor.xyz * r1.www;
  r4.xyz = r4.xyz * r5.www + gWaterAmbientColor.xyz;
