  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xy = cb11[0].xx * v7.xy;
  r0.zw = cb11[6].ww * v7.xy;
  ...
  r2.w = v3.z * r2.y;
  r6.yz = v7.xy * r2.zz;
  r7.xyz = t6.Sample(s6_s, r6.yz).xyz;
  r2.z = t6.Load(float4(0,0,0,0)).w;
  r5.z = cmp(0.49000001 < r2.z);
  ...
  r8.z = r7.y;
  r8.yz = r2.zz ? r8.yz : r7.yz;
  r2.z = t6.Sample(s6_s, r6.yz, int2(0, 0)).x;
  r5.z = t6.Sample(s6_s, r6.yz, int2(0, 0)).x;
  r6.w = t6.Sample(s6_s, r6.yz, int2(0, 0)).x;
  r6.y = t6.Sample(s6_s, r6.yz, int2(0, 0)).x;
  r2.z = 0.333332986 * r2.z;
  r5.z = 0.333332986 * r5.z;
  r6.yz = float2(0.333332986,0.333332986) * r6.yw;
  r6.w = -0.0170000009 + r6.x;
  r7.y = dot(cb11[4].xyz, float3(0.212599993,0.715200007,0.0722000003));
  r6.w = cmp(r6.w < r7.y);
  r2.z = r6.w ? r2.z : -r2.z;
  r5.z = r6.w ? r5.z : -r5.z;
  r6.yz = r6.ww ? r6.yz : -r6.yz;
  r6.y = r6.y + -r6.z;
  r9.x = r6.y + r6.y;
  r2.z = r5.z + -r2.z;
  r9.y = r2.z + r2.z;
  ...
  r9.xyz = v4.xyz * r4.xxx + -r7.yzw;
  r2.z = dot(r9.xyz, r9.xyz);
  r2.z = rsqrt(r2.z);
  r9.xyz = -r9.xyz * r2.zzz + float3(1,1,1);
  r9.xyz = sqrt(r9.xyz);
  r2.z = dot(r6.yzw, r9.xyz);
  r5.z = r7.x * r2.z;
  ...
  r8.xyw = r8.xyw * float3(1.07558298,0.994183004,0.930234015) + -r1.xyz;
  r1.xyz = r2.zzz * r8.xyw + r1.xyz;
  r2.z = cb11[3].x * r2.w;
  r8.xyz = r8.zzz + -r1.xyz;
  r1.xyz = r2.zzz * r8.xyz + r1.xyz;
  r2.y = -r6.z * r2.y + 1;
  r8.x = r2.y * r0.z;
  r2.z = cmp(0 < cb11[7].y);
  if (r2.z != 0) {
    r2.z = 0.075000003 + r4.x;
    r2.z = cmp(r4.y < r2.z);
    r2.w = r5.w ? 1.07500005 : 0.075000003;
    r5.z = cmp(r4.x < r2.w);
    r2.z = r2.z ? r5.z : 0;
    r2.w = cmp(r4.z < r2.w);
    r2.z = r2.w ? r2.z : 0;
    r2.w = 0.075000003 + r4.z;
    r2.w = cmp(r4.y < r2.w);
    r2.z = r2.w ? r2.z : 0;
    r2.w = cmp(0.779999971 < r6.x);
    r2.z = r2.z ? r2.w : 0;
    r2.w = 0.796000004 * r4.x;
    r2.z = r2.z ? r2.w : r4.x;
    ...
    if (r2.w != 0) {
      r4.x = saturate(dot(r3.yxw, -r7.yzw));
      r4.y = 0;
      r4.xyz = t14.Sample(s14_s, r4.xy).xyz;
    } else {
      r4.xyz = cb11[8].xyz;
    }
    r4.xyz = r4.xyz * r0.yyy;
    r6.xyz = v4.xyz * r2.zzz + -r7.yzw;
    r0.y = dot(r6.xyz, r6.xyz);
    r0.y = rsqrt(r0.y);
    r6.xyz = r6.xyz * r0.yyy;
    r0.y = dot(r3.yxw, r6.xyz);
  ...
  r6.xyz = float3(256,256,256) * r3.xyw;
  r6.xyz = floor(r6.yxz);
  r3.xyw = r3.xyw * float3(256,256,256) + -r6.yxz;
  r3.xyw = float3(8,8,4) * r3.xyw;
  r3.xyw = floor(r3.xyw);
  r0.y = dot(r3.xyw, float3(4,32,1));
  o1.w = 0.00392200006 * r0.y;
  o1.xyz = float3(0.00390599994,0.00390599994,0.00390599994) * r6.xyz;
  r8.y = 0.00195299997 * r0.w;
  ...
  r0.yz = r0.yy * float2(0.5,0.488281012) + -r8.xy;
  r0.yz = max(float2(0,0), r0.yz);
  r0.xy = r0.yz * r0.xx + r8.xy;
  o2.xy = sqrt(r0.xy);
  o0.xyzw = cb12[4].xxxx ? v3.xyzw : r4.xyzw;
  o2.z = cb11[4].w;
  o2.w = 1;
