  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  if (r3.z == 0) {
    ...
    if (r3.z == 0) {
      ...
      r7.w = r7.w * r6.w + gLightDirectionAndFalloffExponent[3].w;
      r6.w = r6.w / r7.w;
      ...
      r7.w = r9.w * r7.w;
      r9.w = r7.w * r6.w;
      r10.xyz = gLightColourAndCapsuleExtent[3].xyz * r9.www;
      r8.xzw = r10.xyz * r1.xyz + r8.xzw;
      r9.xyz = r4.xyz * r0.www + r9.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.w = rsqrt(r9.w);
      ...
      r6.w = r7.w * r6.w;
      r6.w = r6.w * r3.w;
      r7.xyz = r6.www * gLightColourAndCapsuleExtent[3].xyz + r7.xyz;
    }
  } else {
    r3.z = -1;
  }
  if (r3.z == 0) {
    r6.w = cmp(4 >= gNumForwardLights);
    r3.z = (int)r3.z | (int)r6.w;
    if (r3.z == 0) {
      r6.w = cmp(gLightColourAndCapsuleExtent[4].w == 0.000000);
      ...
      r9.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[4].w;
      r7.w = saturate(r7.w / r9.w);
      ...
      r7.w = rsqrt(r7.w);
      r9.xyz = r9.xyz * r7.www;
      r6.w = saturate(-r6.w * gLightPositionAndInvDistSqr[4].w + 1);
      r7.w = 1 + -gLightDirectionAndFalloffExponent[4].w;
      r7.w = r7.w * r6.w + gLightDirectionAndFalloffExponent[4].w;
      r6.w = r6.w / r7.w;
      ...
      r7.w = r9.w * r7.w;
      r9.w = r7.w * r6.w;
      r10.xyz = gLightColourAndCapsuleExtent[4].xyz * r9.www;
      r8.xzw = r10.xyz * r1.xyz + r8.xzw;
      r9.xyz = r4.xyz * r0.www + r9.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.w = rsqrt(r9.w);
      ...
      r6.w = r7.w * r6.w;
      r6.w = r6.w * r3.w;
      r7.xyz = r6.www * gLightColourAndCapsuleExtent[4].xyz + r7.xyz;
    }
  } else {
    r3.z = -1;
  }
  if (r3.z == 0) {
    r6.w = cmp(5 >= gNumForwardLights);
    r3.z = (int)r3.z | (int)r6.w;
    if (r3.z == 0) {
      r6.w = cmp(gLightColourAndCapsuleExtent[5].w == 0.000000);
      ...
      r9.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[5].w;
      r7.w = saturate(r7.w / r9.w);
      ...
      r7.w = rsqrt(r7.w);
      r9.xyz = r9.xyz * r7.www;
      r6.w = saturate(-r6.w * gLightPositionAndInvDistSqr[5].w + 1);
      r7.w = 1 + -gLightDirectionAndFalloffExponent[5].w;
      r7.w = r7.w * r6.w + gLightDirectionAndFalloffExponent[5].w;
      r6.w = r6.w / r7.w;
      ...
      r7.w = r9.w * r7.w;
      r9.w = r7.w * r6.w;
      r10.xyz = gLightColourAndCapsuleExtent[5].xyz * r9.www;
      r8.xzw = r10.xyz * r1.xyz + r8.xzw;
      r9.xyz = r4.xyz * r0.www + r9.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.w = rsqrt(r9.w);
      ...
      r6.w = r7.w * r6.w;
      r6.w = r6.w * r3.w;
      r7.xyz = r6.www * gLightColourAndCapsuleExtent[5].xyz + r7.xyz;
    }
  } else {
    r3.z = -1;
  }
  if (r3.z == 0) {
    r6.w = cmp(6 >= gNumForwardLights);
    r3.z = (int)r3.z | (int)r6.w;
    if (r3.z == 0) {
      r6.w = cmp(gLightColourAndCapsuleExtent[6].w == 0.000000);
      ...
      r9.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[6].w;
      r7.w = saturate(r7.w / r9.w);
      ...
      r7.w = rsqrt(r7.w);
      r9.xyz = r9.xyz * r7.www;
      r6.w = saturate(-r6.w * gLightPositionAndInvDistSqr[6].w + 1);
      r7.w = 1 + -gLightDirectionAndFalloffExponent[6].w;
      r7.w = r7.w * r6.w + gLightDirectionAndFalloffExponent[6].w;
      r6.w = r6.w / r7.w;
      ...
      r7.w = r9.w * r7.w;
      r9.w = r7.w * r6.w;
      r10.xyz = gLightColourAndCapsuleExtent[6].xyz * r9.www;
      r8.xzw = r10.xyz * r1.xyz + r8.xzw;
      r9.xyz = r4.xyz * r0.www + r9.xyz;
      r9.w = dot(r9.xyz, r9.xyz);
      r9.w = rsqrt(r9.w);
      ...
      r6.w = r7.w * r6.w;
      r6.w = r6.w * r3.w;
      r7.xyz = r6.www * gLightColourAndCapsuleExtent[6].xyz + r7.xyz;
    }
  } else {
    r3.z = -1;
  }
  if (r3.z == 0) {
    r6.w = cmp(7 >= gNumForwardLights);
    r3.z = (int)r3.z | (int)r6.w;
    if (r3.z == 0) {
      r3.z = cmp(gLightColourAndCapsuleExtent[7].w == 0.000000);
      r9.xyz = gLightPositionAndInvDistSqr[7].xyz + -v2.xyz;
      r10.xyz = -gLightPositionAndInvDistSqr[7].xyz + v2.xyz;
      r6.w = dot(r10.xyz, gLightDirectionAndFalloffExponent[7].xyz);
      r7.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[7].w;
      r6.w = saturate(r6.w / r7.w);
      r6.w = gLightColourAndCapsuleExtent[7].w * r6.w;
      r10.xyz = gLightDirectionAndFalloffExponent[7].xyz * r6.www + gLightPositionAndInvDistSqr[7].xyz;
      r10.xyz = -v2.xyz + r10.xyz;
      ...
      r3.z = saturate(-r3.z * gLightPositionAndInvDistSqr[7].w + 1);
      r6.w = 1 + -gLightDirectionAndFalloffExponent[7].w;
      r6.w = r6.w * r3.z + gLightDirectionAndFalloffExponent[7].w;
      r3.z = r3.z / r6.w;
      r6.w = dot(r9.xyz, -gLightDirectionAndFalloffExponent[7].xyz);
      r6.w = saturate(r6.w * gLightConeScale[7] + gLightConeOffset[7]);
      ...
      r0.x = r0.x * r6.w;
      r6.w = r0.x * r3.z;
      r10.xyz = gLightColourAndCapsuleExtent[7].xyz * r6.www;
      r8.xzw = r10.xyz * r1.xyz + r8.xzw;
