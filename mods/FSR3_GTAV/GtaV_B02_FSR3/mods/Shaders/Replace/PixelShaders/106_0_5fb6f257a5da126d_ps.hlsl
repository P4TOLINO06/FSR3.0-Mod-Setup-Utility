  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r3.xyzw = TextureSampler_layer1.Sample(TextureSampler_layer1_s, v1.zw).xyzw;
  r1.yzw = r3.xyz * r0.xxx;
  r0.xzw = r2.xyz * r0.www + r1.yzw;
  r2.xyzw = TextureSampler_layer2.Sample(TextureSampler_layer2_s, v1.zw).xyzw;
  r0.xzw = r2.xyz * r1.xxx + r0.xzw;
  r1.xyzw = TextureSampler_layer3.Sample(TextureSampler_layer3_s, v1.zw).xyzw;
  ...
  r3.xyzw = BumpSampler_layer1.Sample(BumpSampler_layer1_s, v1.zw).xyzw;
  r2.zw = r3.xy * r0.ww;
  r2.xy = r2.xy * r1.yy + r2.zw;
  r3.xyzw = BumpSampler_layer2.Sample(BumpSampler_layer2_s, v1.zw).xyzw;
  r2.xy = r3.xy * r1.zz + r2.xy;
  r3.xyzw = BumpSampler_layer3.Sample(BumpSampler_layer3_s, v1.zw).xyzw;
  r2.xy = r3.xy * r1.xx + r2.xy;
