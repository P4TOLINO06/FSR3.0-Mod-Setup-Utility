...
SamplerState ComboHeightSamplerFur45_s : register(s6);
SamplerState StippleSampler_s : register(s8);
Texture2D<float4> DiffuseSampler : register(t0);
Texture2D<float4> BumpSampler : register(t2);
Texture2D<float4> SpecSampler : register(t3);
Texture2D<float4> ComboHeightSamplerFur45 : register(t6);
Texture2D<float4> StippleSampler : register(t8);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.z = saturate(28 * r0.z);
  r1.xyz = -gPlayerRFootPos.xyz + v4.xyz;
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = saturate(28 * r0.w);
  ...
  r5.xyzw = ComboHeightSamplerFur45.Sample(ComboHeightSamplerFur45_s, r1.zw).xyzw;
  r1.z = v1.w * r5.y;
  r1.w = -furLayerParams.w + v3.x;
  r0.x = r1.w * r0.x;
  r0.x = v1.w * r0.x + furLayerParams.w;
  r1.w = saturate(v1.w + v1.w);
  r2.w = -0.00999999978 + v3.y;
  r1.w = r1.w * r2.w + 0.00999999978;
  r1.z = cmp(r1.z < r1.w);
  if (r1.z != 0) discard;
