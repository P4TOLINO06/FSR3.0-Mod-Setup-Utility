  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.y = specularIntensityMult * r2.x;
  ...
  r0.xyz = r3.zzz * r5.xyz + r0.xyz;
  r3.z = dirtLevelMod.x * r3.w;
  r4.xzw = r4.zzz + -r0.xyz;
  r0.xyz = r3.zzz * r4.xzw + r0.xyz;
  r3.y = -r4.y * r3.y + 1;
  r2.y = r3.y * r2.y;
  r3.y = dirtLevelMod.w * v3.x;
  r2.x = r3.y * r2.x;
  r2.x = 0.75 * r2.x;
  r3.yzw = float3(0,0,-1) + -gDirectionalLight.xyz;
  r3.yzw = specular2Color_DirLerp.www * r3.yzw + gDirectionalLight.xyz;
  r4.x = cmp(1.5 < abs(matDiffuseSpecularRampEnabled));
  if (r4.x != 0) {
  ...
  r3.yzw = v4.xyz * r2.zzz + -r3.yzw;
  r2.x = dot(r3.yzw, r3.yzw);
  r2.x = rsqrt(r2.x);
  r3.yzw = r3.yzw * r2.xxx;
  r1.y = dot(r1.yzw, r3.yzw);
