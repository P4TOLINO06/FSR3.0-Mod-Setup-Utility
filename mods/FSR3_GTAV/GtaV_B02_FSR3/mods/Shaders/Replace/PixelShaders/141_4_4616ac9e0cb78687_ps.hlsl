  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r3.z = -r2.z * 16 + 14;
  r3.z = cmp(1 >= abs(r3.z));
  r4.x = specularIntensityMult * r3.x;
  r4.y = specularFalloffMult * r3.y;
  r3.w = emissiveMultiplier * r0.w;
  r3.w = globalScalars.w * r3.w;
  r0.w = v3.w * r0.w;
  r4.zw = globalScalars.zy * v3.xy;
  r5.x = r1.z * 0.5 + 0.5;
  r5.y = r5.x * gDynamicBakesAndWetness.y + gDynamicBakesAndWetness.x;
  r5.x = 0.300000012 + r5.x;
  r4.w = r5.x * r4.w;
  r3.w = v3.z * r3.w;
  r5.x = PedDamageData.x * v7.z;
  r5.x = cmp(r5.x != 0.000000);
  if (r5.x != 0) {
    r6.xz = frac(v7.yx);
    r6.w = r6.x * abs(v7.z) + abs(v7.w);
    r6.x = r6.x * v1.w + v2.w;
    r5.x = frac(PedDamageData.z);
    r5.x = cmp(0.100000001 < r5.x);
    r6.y = 1 + -r6.z;
    r7.xyzw = r5.xxxx ? r6.wywy : r6.zwzw;
    r5.z = cmp(PedDamageData.z >= 1);
    r5.zw = r5.zz ? r6.xy : r6.zx;
    r6.xyzw = pedTattooTargetSampler.SampleLevel(pedTattooTargetSampler_s, r5.zw, 0).xyzw;
    r8.xyzw = pedBloodTargetSampler.SampleLevel(pedBloodTargetSampler_s, r7.zw, 0).zxyw;
    r5.z = cmp(r6.w >= 0.501960814);
    r5.w = cmp(0.501960814 >= r6.w);
    r5.z = r1.w ? r5.z : r5.w;
    r5.w = cmp(0 < PedDamageData.x);
    r5.z = r5.w ? r5.z : 0;
    r6.xyzw = r5.zzzz ? r6.xyzw : float4(0,0,0,0.5);
    r5.z = r6.w * 2 + -1;
    r5.z = 1 + -abs(r5.z);
    r5.w = 1 + -r8.x;
    r6.w = r5.w * r5.w;
    ...
    if (r3.x != 0) {
      ...
      r6.xyzw = r5.xxxx ? r6.xyzw : r6.wzwz;
      r3.x = cmp((int)r5.x == (int)r3.x);
      ...
      r6.y = r7.x;
      r3.y = r6.x * r5.w;
      r5.xz = r6.zy * r5.ww + -r3.yy;
      r3.xy = r3.xx * r9.xy + r5.xz;
      r6.xy = PedDamageData.yy * r3.xy;
      r3.x = dot(r6.xy, r6.xy);
      r3.x = 1 + -r3.x;
      r3.x = max(0, r3.x);
      r5.xz = cmp(v7.zw < float2(0,0));
      r5.zw = r5.zz ? r6.yx : r6.xy;
      r6.z = -r6.x;
      r5.xz = r5.xx ? r6.yz : r5.zw;
      r6.xyz = v6.xyz * r5.zzz;
      r5.xzw = r5.xxx * v5.xyz + r6.xyz;
      r5.xzw = r3.xxx * r1.xyz + r5.xzw;
      r3.x = dot(r5.xzw, r5.xzw);
      r3.x = rsqrt(r3.x);
      r1.xyz = r5.xzw * r3.xxx;
    }
  } else {
    r8.x = 1;
  }
  ...
  if (r3.x != 0) {
    ...
    if (r3.x != 0) {
      ...
      r5.xzw = r7.yzx * float3(2,2,1) + float3(-1,-1,0);
      r5.xzw = r5.xzw + -r2.xyz;
      r6.xyz = _matMaterialColorScale[1].xxx * r5.xzw + r2.xyz;
    }
    ...
    r5.xzw = v6.xyz * r6.yyy;
    r5.xzw = v5.xyz * r6.xxx + r5.xzw;
    r5.xzw = r5.xzw * r2.yyy;
    r2.xyw = r5.xzw * r2.www;
  ...
  r2.z = cmp((int)r1.w == 0);
  r5.xzw = wetnessAdjust.xxx * r0.xyz;
  r5.xzw = r5.xzw * r2.xxx;
  r2.xzw = r2.zzz ? r5.xzw : 0;
  r0.xyz = -r2.xzw + r0.xyz;
  r2.xy = wetnessAdjust.yz * r2.yy + r4.yx;
  r0.xyz = _matMaterialColorScale[0].xxx * r0.xyz;
  r2.z = _matMaterialColorScale[0].y * r3.w;
  r2.w = r1.w ? 0.010000 : 0;
  r1.w = r1.w ? -0.00999999978 : -0;
  r1.w = r2.y + r1.w;
  r1.w = _matMaterialColorScale[0].z * r1.w + r2.w;
  r2.y = dot(v4.xyz, v4.xyz);
  r2.y = rsqrt(r2.y);
  r3.xyw = v4.xyz * r2.yyy;
  r2.w = dot(r1.xyz, r1.xyz);
  r2.w = rsqrt(r2.w);
  r5.xzw = r2.www * r1.xyz;
  r2.w = saturate(dot(r3.xyw, r5.xzw));
  r2.w = 0.5 + -r2.w;
  r2.w = saturate(2.5 * r2.w);
  r3.x = r2.w * -2 + 3;
  r2.w = r2.w * r2.w;
  r2.w = r3.x * r2.w;
  r3.x = 1 + r1.z;
  r3.x = saturate(r3.x * 0.5 + -0.300000012);
  r3.x = 1.42857146 * r3.x;
  r5.xzw = saturate(v8.xyz);
  r2.w = r5.x * r2.w;
  r2.w = r2.w * r3.x;
  r3.xyw = r2.www * r0.xyz;
  o0.xyz = r3.xyw * _matMaterialColorScale[0].yyy + r0.xyz;
  r0.xyz = v4.xyz * r2.yyy + -r1.xyz;
  r0.xyz = r5.zzz * r0.xyz + r1.xyz;
  r1.x = 1 + -r8.x;
  r1.y = PedDamageColors[2].y + -r5.w;
  r1.x = r1.x * r1.y + r5.w;
  ...
  r4.xyw = float3(256,256,256) * r0.xyz;
  r4.xyw = floor(r4.xyw);
  r0.xyz = r0.xyz * float3(256,256,256) + -r4.xyw;
  r0.xyz = float3(8,8,4) * r0.xyz;
  r0.xyz = floor(r0.xyz);
  r0.x = dot(r0.yxz, float3(4,32,1));
  o1.w = 0.00392156886 * r0.x;
  o1.xyz = float3(0.00390625,0.00390625,0.00390625) * r4.xyw;
  r0.x = 0.001953125 * r2.x;
  r3.x = r5.y * r4.z + gLightArtificialIntAmbient0.w;
  r0.yz = float2(0.5,0.5) * r3.xy;
  o3.xy = sqrt(r0.yz);
  o3.z = saturate(0.0625 * r2.z);
  r0.y = 1.0196079 + r1.x;
  r0.y = r3.z ? r1.x : r0.y;
