  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.xyz = r0.xyz * r2.xxx + -gDirectionalLight.xyz;
  r2.x = dot(r0.xyz, r0.xyz);
  r2.x = rsqrt(r2.x);
  ...
  r2.w = -r4.w * r5.y + r2.w;
  r2.w = r3.w ? r2.w : r5.z;
  r2.w = gCSMShadowTexture.SampleCmpLevelZero(gCSMShadowTextureSamp_s, r6.xy, r2.w).x;
  r3.w = dot(r3.xyz, -gDirectionalLight.xyz);
  r4.w = saturate(r3.w);
  r4.w = r4.w + -abs(r3.w);
  r3.w = r0.w * r4.w + abs(r3.w);
  r5.x = saturate(dot(r4.xyz, r3.xyz));
  r5.y = saturate(dot(r0.xyz, -gDirectionalLight.xyz));
  r5.xy = float2(1,1) + -r5.xy;
  r5.zw = r5.xy * r5.xy;
  r5.zw = r5.zw * r5.zw;
  r5.xy = r5.zw * r5.xy;
  r5.xy = r5.xy * float2(0.959999979,0.959999979) + float2(0.0399999991,0.0399999991);
  r5.zw = float2(2,9.99999994e-09) + r2.zz;
  r4.w = 0.125 * r5.z;
  r5.x = -r1.w * r5.x + 1;
  ...
  r0.xyz = gDirectionalColour.xyz * r0.xyz;
  r1.w = gLightNaturalAmbient0.w + r3.z;
  r1.w = gLightNaturalAmbient1.w * r1.w;
  r1.w = max(0, r1.w);
  r5.yzw = gLightArtificialExtAmbient0.xyz * r1.www + gLightArtificialExtAmbient1.xyz;
  ...
  r2.zw = saturate(float2(0.000666666718,0.00177619897) * r2.zz);
  r2.z = 1 + -r2.z;
  r3.x = -5 + gReflectionMipCount;
  r3.y = gReflectionMipCount * r2.z;
  r3.y = cmp(r3.y < r3.x);
  r3.z = r2.z * gReflectionMipCount + -5;
  r2.z = r2.z * r2.z;
  r2.z = r2.z * 5 + r3.x;
  r2.z = r3.y ? r3.z : r2.z;
  ...
  r3.xyzw = ReflectionSampler.SampleLevel(ReflectionSampler_s, r1.yz, r2.z).xyzw;
  r1.y = max(r2.x, r2.y);
