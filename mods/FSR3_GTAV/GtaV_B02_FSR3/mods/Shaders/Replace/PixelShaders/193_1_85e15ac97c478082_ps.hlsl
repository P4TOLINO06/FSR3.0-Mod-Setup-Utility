  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.w = 1 + -r3.x;
  r1.w = cmp(0 != postProcess_FlipDepth_NearPlaneFade_Params.z);
  r2.z = 1 + -r0.w;
  r0.w = r1.w ? r2.z : r0.w;
  r0.w = 1 + -r0.w;
  ...
  if (r0.w != 0) {
    r1.xyzw = FogRayTexSampler.Sample(FogRayTexSampler_s, r2.xy).xyzw;
    r0.w = -1 + r1.x;
