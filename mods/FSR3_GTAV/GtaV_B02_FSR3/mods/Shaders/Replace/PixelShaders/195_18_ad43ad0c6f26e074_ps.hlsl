  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.y = r1.y * r1.y;
  r3.y = r3.w * specularFalloffMult + -500;
  r3.y = max(0, r3.y);
  r3.z = r3.w * specularFalloffMult + -r3.y;
  r3.y = 558 * r3.y;
  r3.y = r3.z * 3 + r3.y;
  ...
  r8.zw = float2(2,9.99999994e-09) + r3.yy;
  r5.w = 0.125 * r8.z;
  r6.w = -r1.x * r8.x + 1;
  ...
  if (r3.w == 0) {
    ...
    if (r3.w == 0) {
      ...
      r9.x = r9.x * r7.w + gLightDirectionAndFalloffExponent[4].w;
      r7.w = r7.w / r9.x;
  ...
  if (r3.w == 0) {
    ...
    if (r3.w == 0) {
      ...
      r9.x = r9.x * r7.w + gLightDirectionAndFalloffExponent[5].w;
      r7.w = r7.w / r9.x;
  ...
  if (r3.w == 0) {
    ...
    if (r3.w == 0) {
      ...
      r9.x = r9.x * r7.w + gLightDirectionAndFalloffExponent[6].w;
      r7.w = r7.w / r9.x;
  ...
  if (r3.w == 0) {
    ...
    if (r3.w == 0) {
      ...
      r3.w = r3.w / r7.w;
      r7.w = dot(r10.xyz, -gLightDirectionAndFalloffExponent[7].xyz);
  ...
  r1.zw = saturate(float2(0.000666666718,0.00177619897) * r3.yy);
  r1.z = 1 + -r1.z;
  ...
  r2.xyzw = ReflectionSampler.SampleLevel(ReflectionSampler_s, r2.xy, r1.z).xyzw;
  r1.y = max(r3.x, r1.y);
