  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.y = r0.x * r0.y;
  r0.y = r0.y * -0.5 + 1;
  r4.xyzw = DiffuseSampler.Sample(DiffuseSampler_s, v2.xy).xyzw;
  o0.xyz = r4.xyz * r0.yyy;
  r0.y = v1.w * r4.w;
  r0.z = emissiveMultiplier * r4.w;
  r0.yz = globalScalars.xw * r0.yz;
  r0.z = globalScalars2.y * r0.z;
  r0.z = v1.z * r0.z;
  o3.z = saturate(0.0625 * r0.z);
  o0.w = globalScalars2.y * r0.y;
