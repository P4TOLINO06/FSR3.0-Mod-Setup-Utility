  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.x = saturate(0.0500000007 * v4.w);
  r1.y = abs(r0.w) * -24 + 27;
  ...
  if (r1.z != 0) {
    ...
    r1.z = trunc(r1.z);
    r1.z = r1.x * 5 + -r1.z;
    r2.x = icb[r2.x+3].w + -icb[r1.w+3].w;
    r1.z = r1.z * r2.x + icb[r1.w+3].w;
  } else {
    r1.z = 0;
  }
  r1.w = r1.y * r1.z;
  ...
  if (r2.y == 0) {
    ...
    if (r1.y != 0) {
      ...
      if (r3.z != 0) {
        r4.x = dot(v4.xyz, v6.xyz);
        r4.y = dot(v5.xyz, v6.xyz);
        r4.z = dot(v2.xyz, v6.xyz);
        r3.z = max(0.100000001, v7.y);
        r3.z = min(1, r3.z);
        r3.z = 1 + -r3.z;
        r5.x = dot(v4.xyz, gDirectionalLight.xyz);
        r5.y = dot(v5.xyz, gDirectionalLight.xyz);
        r5.z = dot(v2.xyz, gDirectionalLight.xyz);
        r3.w = dot(r5.xyz, r5.xyz);
        r3.w = rsqrt(r3.w);
        r5.xyz = r5.xyz * r3.www;
        r3.w = dot(v2.xyz, r5.xyz);
        r3.w = cmp(0 < r3.w);
        r1.w = trunc(r1.w);
        r1.w = 1 / r1.w;
  ...
  r1.yz = r3.yy * r1.yz;
  r3.yzw = v5.xyz * r1.zzz;
  r3.yzw = r1.yyy * v4.xyz + r3.yzw;
  r3.yzw = r0.zzz * v2.xyz + r3.yzw;
  ...
  r0.x = materialWetnessMultiplier.z * r3.x + r0.x;
  r0.x = materialWetnessMultiplier.w * r0.y + r0.x;
  r0.y = specularIntensityMult * specularIntensityMult;
  r0.w = cmp(r1.x == 1.000000);
  r1.y = dot(r2.xyw, float3(1.27499998,4.29239988,0.432599992));
  r1.y = 0.5 + -r1.y;
  r1.y = saturate(v2.w + -r1.y);
  r1.z = cmp(0.800000012 < r1.x);
  ...
  r1.x = gLightArtificialIntAmbient0.w + v3.x;
  r1.y = v3.y;
  r1.xy = float2(0.5,0.5) * r1.xy;
  o3.xy = sqrt(r1.xy);
  r0.z = r3.w * r0.z + -0.349999994;
