  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.xyzw = TextureSampler_layer1.Sample(TextureSampler_layer1_s, v1.zw).xyzw;
  ...
  r1.xyzw = TextureSampler_layer2.Sample(TextureSampler_layer2_s, v1.zw).xyzw;
  r0.w = r3.x * r2.y;
  r1.w = r0.w * r2.z;
  r0.w = r0.w * r3.z;
  r0.xyz = r1.xyz * r0.www + r0.xyz;
  r2.xyzw = TextureSampler_layer3.Sample(TextureSampler_layer3_s, v1.zw).xyzw;
  r0.xyz = r2.xyz * r1.www + r0.xyz;
  r1.xyzw = BumpSampler_layer0.Sample(BumpSampler_layer0_s, v1.xy).xyzw;
  r2.xyzw = BumpSampler_layer1.Sample(BumpSampler_layer1_s, v1.zw).xyzw;
  ...
  r2.xyzw = BumpSampler_layer2.Sample(BumpSampler_layer2_s, v1.zw).xyzw;
  r0.w = v2.y * r3.x;
  r1.z = r0.w * r3.z;
  r0.w = v2.z * r0.w;
  r1.xy = r2.xy * r1.zz + r1.xy;
  r2.xyzw = BumpSampler_layer3.Sample(BumpSampler_layer3_s, v1.zw).xyzw;
  ...
  r0.y = -0.100000001 + wetnessMultiplier;
