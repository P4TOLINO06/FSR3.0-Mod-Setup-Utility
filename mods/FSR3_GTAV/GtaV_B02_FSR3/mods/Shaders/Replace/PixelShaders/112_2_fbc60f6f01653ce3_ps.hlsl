  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r0.x = r1.y * r0.x;
  r0.y = 1 + -SpecDesaturateIntensity.w;
  r2.xyzw = DiffuseSampler.Sample(DiffuseSampler_s, v3.xy).xyzw;
  r0.z = dot(r2.xyz, SpecDesaturateIntensity.xyz);
  r0.w = 1 + -r0.z;
  r0.w = r0.w + r0.w;
  r0.y = -r0.w * r0.y + 1;
  r0.w = cmp(r0.z < 0.5);
  r0.z = dot(SpecDesaturateIntensity.ww, r0.zz);
  r3.x = r0.w ? r0.z : r0.y;
  r0.y = 1 + -SpecDesaturateExponent.w;
  r0.z = dot(r2.xyz, SpecDesaturateExponent.xyz);
  r0.w = 1 + -r0.z;
  r0.w = r0.w + r0.w;
  r0.y = -r0.w * r0.y + 1;
  r0.w = cmp(r0.z < 0.5);
  r0.z = dot(SpecDesaturateExponent.ww, r0.zz);
  r3.y = r0.w ? r0.z : r0.y;
  r0.y = dot(r3.xy, specMapIntMask.xy);
  ...
  r0.y = -0.200000003 + wetnessMultiplier;
