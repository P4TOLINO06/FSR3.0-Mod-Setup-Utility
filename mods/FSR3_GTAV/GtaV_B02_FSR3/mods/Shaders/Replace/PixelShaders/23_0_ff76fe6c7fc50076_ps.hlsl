...
Texture2D<float4> lookupSampler : register(t6);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.y = r0.w * r0.z;
  r0.w = r0.w * r1.z;
  r1.y = materialWetnessMultiplier.y * r1.y;
  r0.w = materialWetnessMultiplier.x * r0.w + r1.y;
  r1.x = r1.x * r0.y;
  r1.y = r1.x * r1.z;
  r1.x = r1.x * r0.z;
  r0.xyz = saturate(r0.xyz);
  r0.w = materialWetnessMultiplier.z * r1.y + r0.w;
  r0.w = materialWetnessMultiplier.w * r1.x + r0.w;
  r1.x = 1 + -r0.w;
  r1.y = -0.349999994 + v3.z;
