  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  while (true) {
    ...
    if (r3.y != 0) break;
    r1.x = icb[r3.x+0].x;
    r3.yz = r1.xy * BloomTexelSize.xy + v1.xy;
    r4.xyzw = HDRSampler.Sample(HDRSampler_s, r3.yz).xyzw;
    r4.xyzw = r4.xyzw * icb[r3.x+0].yyyy + r2.xyzw;
    r1.z = -icb[r3.x+0].x;
    r1.xz = r1.zw * BloomTexelSize.xy + v1.xy;
    r5.xyzw = HDRSampler.Sample(HDRSampler_s, r1.xz).xyzw;
    r2.xyzw = r5.xyzw * icb[r3.x+0].yyyy + r4.xyzw;
    r3.x = (int)r3.x + 1;
  }
  o0.xyzw = r2.xyzw;
  return;
