  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r2.w = max(0, r2.w);
  r3.w = r3.w * specularFalloffMult + -r2.w;
  r2.w = 558 * r2.w;
  r2.w = r3.w * 3 + r2.w;
  r3.w = dot(r3.xyz, gViewInverse._m20_m21_m22);
  r7.xyz = -gViewInverse._m30_m31_m32 + v7.xyz;
  ...
  r4.w = 0.5 * r4.w;
  r5.w = max(abs(r11.x), abs(r11.y));
  r5.w = cmp(r5.w < r4.w);
  r5.w = r5.w ? 2 : 3;
  r6.z = max(abs(r10.x), abs(r10.y));
  r6.z = cmp(r6.z < r4.w);
  r5.w = r6.z ? 1 : r5.w;
  r6.z = max(abs(r9.x), abs(r9.y));
  r4.w = cmp(r6.z < r4.w);
  r4.w = r4.w ? 0 : r5.w;
  r9.xyz = x0[r4.w+0].xyz;
  r4.w = (int)r4.w;
  r5.w = 0.5 + r4.w;
  r5.w = 0.25 * r5.w;
  r10.xyzw = cmp(float4(0,1,2,3) == r4.wwww);
  r10.xyzw = r10.xyzw ? float4(1,1,1,1) : 0;
  r4.w = dot(r10.xyzw, gCSMDepthBias.xyzw);
  r6.z = dot(r10.xyzw, gCSMDepthSlopeBias.xyzw);
  r10.x = 0.5 + r9.x;
  r10.y = r9.y * 0.25 + r5.w;
  ...
  r4.w = dot(r9.xyzw, float4(1,1,1,1));
  ...
  r3.w = r3.w * r3.w;
  r3.w = min(1, r3.w);
  r4.w = saturate(v7.z * gCSMShaderVars_shared[3].x + gCSMShaderVars_shared[3].y);
  r4.w = sqrt(r4.w);
  r4.w = gCSMShaderVars_shared[3].z * r4.w;
  r3.w = r4.w * -r3.w + r3.w;
  r4.w = dot(r2.xyz, -gDirectionalLight.xyz);
  r5.w = saturate(r4.w);
  r5.w = r5.w + -abs(r4.w);
  r4.w = r0.w * r5.w + abs(r4.w);
  r8.x = saturate(dot(r4.xyz, r2.xyz));
  r8.y = saturate(dot(r5.xyz, -gDirectionalLight.xyz));
  r6.zw = float2(1,1) + -r8.xy;
  r8.xy = r6.zw * r6.zw;
  r8.xy = r8.xy * r8.xy;
  r6.zw = r8.xy * r6.zw;
  r5.w = 1 + -specularFresnel;
  r6.zw = specularFresnel * r6.zw + r5.ww;
  ...
  r5.x = r5.x * r4.w;
  r4.w = r6.z * r4.w;
  r5.xyz = r0.xyz * r4.www + r5.xxx;
  r5.xyz = gDirectionalColour.xyz * r5.xyz;
  r4.w = cmp(0 >= gNumForwardLights);
  if (r4.w == 0) {
    r6.w = cmp(gLightColourAndCapsuleExtent[0].w == 0.000000);
    r9.xyz = gLightPositionAndInvDistSqr[0].xyz + -v7.xyz;
    r10.xyz = -gLightPositionAndInvDistSqr[0].xyz + v7.xyz;
    r8.z = dot(r10.xyz, gLightDirectionAndFalloffExponent[0].xyz);
    r8.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[0].w;
    r8.z = saturate(r8.z / r8.w);
    r8.z = gLightColourAndCapsuleExtent[0].w * r8.z;
    r10.xyz = gLightDirectionAndFalloffExponent[0].xyz * r8.zzz + gLightPositionAndInvDistSqr[0].xyz;
    ...
    r8.z = 1 + -gLightDirectionAndFalloffExponent[0].w;
    r8.z = r8.z * r6.w + gLightDirectionAndFalloffExponent[0].w;
    r6.w = r6.w / r8.z;
    r8.z = dot(r9.xyz, -gLightDirectionAndFalloffExponent[0].xyz);
    r8.z = saturate(r8.z * gLightConeScale[0] + gLightConeOffset[0]);
    ...
    r9.w = r9.w * r9.w;
    r8.w = r9.w * r8.w;
    r8.w = specularFresnel * r8.w + r5.w;
    ...
    r6.w = r8.z * r6.w;
    r6.w = r6.w * r7.w;
    r9.xyz = gLightColourAndCapsuleExtent[0].xyz * r6.www;
  } else {
  ...
  if (r6.w != 0) {
    r8.z = cmp(1 >= gNumForwardLights);
    r6.w = (int)r4.w | (int)r6.w;
    r4.w = r8.z ? r6.w : r4.w;
    if (r4.w == 0) {
      r6.w = cmp(gLightColourAndCapsuleExtent[1].w == 0.000000);
      r11.xyz = gLightPositionAndInvDistSqr[1].xyz + -v7.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[1].xyz + v7.xyz;
      r8.z = dot(r12.xyz, gLightDirectionAndFalloffExponent[1].xyz);
      r8.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[1].w;
      r8.z = saturate(r8.z / r8.w);
      r8.z = gLightColourAndCapsuleExtent[1].w * r8.z;
      r12.xyz = gLightDirectionAndFalloffExponent[1].xyz * r8.zzz + gLightPositionAndInvDistSqr[1].xyz;
      ...
      r8.z = 1 + -gLightDirectionAndFalloffExponent[1].w;
      r8.z = r8.z * r6.w + gLightDirectionAndFalloffExponent[1].w;
      r6.w = r6.w / r8.z;
      r8.z = dot(r11.xyz, -gLightDirectionAndFalloffExponent[1].xyz);
      r8.z = saturate(r8.z * gLightConeScale[1] + gLightConeOffset[1]);
      ...
      r8.z = r8.w * r8.z;
      r8.w = r8.z * r6.w;
      r12.xyz = gLightColourAndCapsuleExtent[1].xyz * r8.www;
      r10.xyz = r12.xyz * r0.xyz + r10.xyz;
      r11.xyz = r3.xyz * r1.yyy + r11.xyz;
      ...
      r6.w = r8.z * r6.w;
      r6.w = r6.w * r7.w;
      r9.xyz = r6.www * gLightColourAndCapsuleExtent[1].xyz + r9.xyz;
    }
  } else {
    r4.w = -1;
  }
  if (r4.w == 0) {
    ...
    if (r4.w == 0) {
      ...
      r11.xyz = gLightPositionAndInvDistSqr[2].xyz + -v7.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[2].xyz + v7.xyz;
      r8.z = dot(r12.xyz, gLightDirectionAndFalloffExponent[2].xyz);
      r8.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[2].w;
      r8.z = saturate(r8.z / r8.w);
      r8.z = gLightColourAndCapsuleExtent[2].w * r8.z;
      r12.xyz = gLightDirectionAndFalloffExponent[2].xyz * r8.zzz + gLightPositionAndInvDistSqr[2].xyz;
      r12.xyz = -v7.xyz + r12.xyz;
      r11.xyz = r6.www ? r11.xyz : r12.xyz;
      r6.w = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r8.z = 1 + -gLightDirectionAndFalloffExponent[2].w;
      r8.z = r8.z * r6.w + gLightDirectionAndFalloffExponent[2].w;
      r6.w = r6.w / r8.z;
      r8.z = dot(r11.xyz, -gLightDirectionAndFalloffExponent[2].xyz);
      r8.z = saturate(r8.z * gLightConeScale[2] + gLightConeOffset[2]);
      r8.w = dot(r11.xyz, r2.xyz);
      r9.w = saturate(r8.w);
      r9.w = r9.w + -abs(r8.w);
      r8.w = r0.w * r9.w + abs(r8.w);
      r8.z = r8.w * r8.z;
      r8.w = r8.z * r6.w;
      r12.xyz = gLightColourAndCapsuleExtent[2].xyz * r8.www;
      r10.xyz = r12.xyz * r0.xyz + r10.xyz;
      r11.xyz = r3.xyz * r1.yyy + r11.xyz;
      r8.w = dot(r11.xyz, r11.xyz);
      r8.w = rsqrt(r8.w);
      ...
      r6.w = r8.z * r6.w;
      r6.w = r6.w * r7.w;
      r9.xyz = r6.www * gLightColourAndCapsuleExtent[2].xyz + r9.xyz;
    }
  } else {
    r4.w = -1;
  }
  if (r4.w == 0) {
    ...
    if (r4.w == 0) {
      ...
      r11.xyz = gLightPositionAndInvDistSqr[3].xyz + -v7.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[3].xyz + v7.xyz;
      r6.w = dot(r12.xyz, gLightDirectionAndFalloffExponent[3].xyz);
      r8.z = 9.99999975e-05 + gLightColourAndCapsuleExtent[3].w;
      r6.w = saturate(r6.w / r8.z);
      r6.w = gLightColourAndCapsuleExtent[3].w * r6.w;
      r12.xyz = gLightDirectionAndFalloffExponent[3].xyz * r6.www + gLightPositionAndInvDistSqr[3].xyz;
      r12.xyz = -v7.xyz + r12.xyz;
      r11.xyz = r4.www ? r11.xyz : r12.xyz;
      ...
      r6.w = r6.w * r4.w + gLightDirectionAndFalloffExponent[3].w;
      r4.w = r4.w / r6.w;
      r6.w = dot(r11.xyz, -gLightDirectionAndFalloffExponent[3].xyz);
      r6.w = saturate(r6.w * gLightConeScale[3] + gLightConeOffset[3]);
      r8.z = dot(r11.xyz, r2.xyz);
      r8.w = saturate(r8.z);
      r8.w = r8.w + -abs(r8.z);
      r0.w = r0.w * r8.w + abs(r8.z);
      r0.w = r0.w * r6.w;
      r6.w = r0.w * r4.w;
      r12.xyz = gLightColourAndCapsuleExtent[3].xyz * r6.www;
      r10.xyz = r12.xyz * r0.xyz + r10.xyz;
      r3.xyz = r3.xyz * r1.yyy + r11.xyz;
      r1.y = dot(r3.xyz, r3.xyz);
      r1.y = rsqrt(r1.y);
      ...
      r6.w = r6.w * r6.w;
      r1.y = r6.w * r1.y;
      r1.y = specularFresnel * r1.y + r5.w;
      ...
      r0.w = r0.w * r4.w;
      r0.w = r0.w * r7.w;
      r9.xyz = r0.www * gLightColourAndCapsuleExtent[3].xyz + r9.xyz;
    }
  }
  r0.w = r6.z * r6.z;
  r1.x = r1.x * r1.x;
  ...
  r5.xyz = gLightArtificialIntAmbient0.xyz * r0.www + gLightArtificialIntAmbient1.xyz;
  r5.xyz = globalScalars2.zzz * r5.xyz;
  r1.xyz = r1.xyz * r1.www + r5.xyz;
  r1.xyz = r1.xyz * r6.yyy;
  r5.xyz = gLightNaturalAmbient0.xyz * r0.www + gLightNaturalAmbient1.xyz;
  ...
  r5.xyz = gDirectionalAmbientColour.xyz * r0.www + r5.xyz;
  r1.xyz = r5.xyz * r6.xxx + r1.xyz;
  r1.xyz = r1.xyz * r6.zzz;
  r0.xyz = r1.xyz * r0.xyz + r3.xyz;
  r0.w = 1 + -r6.z;
  r1.x = dot(-r4.xyz, r2.xyz);
  r1.x = r1.x + r1.x;
  r1.xyz = r2.xyz * -r1.xxx + -r4.xyz;
