...
{
  float wetnessMultiplier : packoffset(c0);
  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r1.x = 0.5 * r1.x;
  r1.x = r1.z * 0.5 + r1.x;
  r1.x = -r1.x * detailSettings.x + 1;
  r0.xyzw = r1.xxxx * r0.xyzw;
  r1.x = dot(v3.xyz, v3.xyz);
  r1.x = rsqrt(r1.x);
  r1.yzw = v3.xyz * r1.xxx;
  r2.x = saturate(v3.z * 128 + -127);
  r0.w = v1.w * r0.w;
  ...
  r0.w = r1.x * r0.w;
  r0.w = r0.w * r3.y;
  r1.x = wetnessMultiplier * r0.w;
  r0.w = r0.w * -0.5 + 1;
  o0.xyz = r0.xyz * r0.www;
  r0.xy = float2(0.5,0.48828125) * r1.xx;
  o2.xy = sqrt(r0.xy);
