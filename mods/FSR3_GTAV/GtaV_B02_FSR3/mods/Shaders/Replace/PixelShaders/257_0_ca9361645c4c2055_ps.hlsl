  ...
  out float2 motionVectors : SV_Target4)
{
  ...
  r3.w = 558 * r3.w;
  r3.w = r4.w * 3 + r3.w;
  r4.x = dot(r4.xyz, gViewInverse._m20_m21_m22);
  r4.yzw = -gViewInverse._m30_m31_m32 + v6.xyz;
  r7.xyz = gCSMShaderVars_shared[1].xyz * r4.zzz;
  r7.xyz = r4.yyy * gCSMShaderVars_shared[0].xyz + r7.xyz;
  r7.xyz = r4.www * gCSMShaderVars_shared[2].xyz + r7.xyz;
  ...
  r4.x = saturate(r4.x * gCSMShaderVars_shared[0].w + gCSMShaderVars_shared[1].w);
  r6.w = max(abs(r7.x), abs(r7.y));
  r6.w = saturate(r6.w * 15 + -6.30000019);
  r4.x = 1 + -r4.x;
  r4.x = r4.x * r6.w;
  r4.x = r5.w * 0.0625 + r4.x;
  r4.x = r4.x * r4.x;
  r4.x = min(1, r4.x);
  r5.w = saturate(v6.z * gCSMShaderVars_shared[3].x + gCSMShaderVars_shared[3].y);
  r5.w = sqrt(r5.w);
  r5.w = gCSMShaderVars_shared[3].z * r5.w;
  r4.x = r5.w * -r4.x + r4.x;
  r5.w = saturate(dot(r2.xyz, -gDirectionalLight.xyz));
  ...
  r7.xy = r7.xy * r7.xy;
  r5.xy = r7.xy * r5.xy;
  r5.z = 1 + -specularFresnel;
  r5.xy = specularFresnel * r5.xy + r5.zz;
  r7.xy = float2(2,9.99999994e-09) + r3.ww;
  r5.z = 0.125 * r7.x;
  r5.x = -r2.w * r5.x + 1;
  ...
  r2.w = r2.w * r5.w;
  r5.y = r5.w * r5.x;
  r5.yzw = r0.xyz * r5.yyy + r2.www;
  r5.yzw = gDirectionalColour.xyz * r5.yzw;
  r1.z = r1.z * r1.w + gLightNaturalAmbient0.w;
  r1.z = gLightNaturalAmbient1.w * r1.z;
  r1.z = max(0, r1.z);
  r6.xyz = gLightArtificialExtAmbient0.xyz * r1.zzz + gLightArtificialExtAmbient1.xyz;
  r1.w = 1 + -globalScalars2.z;
  r7.xyz = gLightArtificialIntAmbient0.xyz * r1.zzz + gLightArtificialIntAmbient1.xyz;
  r7.xyz = globalScalars2.zzz * r7.xyz;
  r6.xyz = r6.xyz * r1.www + r7.xyz;
  r6.xyz = r6.xyz * r1.yyy;
  r7.xyz = gLightNaturalAmbient0.xyz * r1.zzz + gLightNaturalAmbient1.xyz;
  ...
  r2.xyz = gDirectionalAmbientColour.xyz * r1.zzz + r7.xyz;
  r2.xyz = r2.xyz * r1.xxx + r6.xyz;
  r2.xyz = r2.xyz * r5.xxx;
  r0.xyz = r2.xyz * r0.xyz;
  r0.xyz = r5.yzw * r4.xxx + r0.xyz;
  r1.z = 1 + -r5.x;
  r1.x = max(r1.x, r1.y);
  r1.xyw = r3.xyz * r1.xxx;
  r2.x = saturate(0.00177619897 * r3.w);
