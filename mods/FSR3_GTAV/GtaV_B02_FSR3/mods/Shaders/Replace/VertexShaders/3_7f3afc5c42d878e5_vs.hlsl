...
// unknown dcl_: dcl_input v8.xyzw
  ...
  r3.x = envEffColorModCpvAdd.w * r3.x + v7.z;
  r3.yzw = float3(-0.5,0.529411793,-0.0392156877) + v7.zyy;
  r3.y = saturate(r3.y);
  r3.y = r3.y + r3.y;
  r4.xyz = v0.xyz;
  r4.w = 1;
  ...
  r5.z = dot(r0.xyzw, r4.xyzw);
  r4.xyz = gWorld._m10_m11_m12 * r5.yyy;
  r4.xyz = r5.xxx * gWorld._m00_m01_m02 + r4.xyz;
  r4.xyz = r5.zzz * gWorld._m20_m21_m22 + r4.xyz;
  r4.xyz = gWorld._m30_m31_m32 + r4.xyz;
  o4.xyz = gViewInverse._m30_m31_m32 + -r4.xyz;
  r4.x = dot(r1.xyz, v5.xyz);
  r4.y = dot(r2.xyz, v5.xyz);
  r4.z = dot(r0.xyz, v5.xyz);
  r6.xyz = gWorld._m10_m11_m12 * r4.yyy;
  r6.xyz = r4.xxx * gWorld._m00_m01_m02 + r6.xyz;
  r6.xyz = r4.zzz * gWorld._m20_m21_m22 + r6.xyz;
  ...
  r1.xyz = envEffFatThickness.xxx * r4.xyz;
  r1.xyz = r1.xyz * r3.yyy;
  r1.xyz = r1.xyz * envEffFatSweatScale.yyy + r5.xyz;
  r2.xyz = envEffFatThickness.yyy * r4.xyz;
  r2.xyz = v8.www * r2.xyz;
  r1.xyz = r2.xyz * envEffFatSweatScale.zzz + r1.xyz;
  r2.xyz = umGlobalParams.xxy * v8.xxz;
  r2.xyz = umPedGlobalOverrideParams.xxy * r2.xyz;
  r0.w = 6.28318501 * v8.y;
  r4.xyz = umGlobalParams.zzw * umPedGlobalOverrideParams.zzw;
  r4.xyz = globalScalars2.xxx * r4.xyz + r0.www;
  r4.xyz = sin(r4.xyz);
  r1.xyz = r4.xyz * r2.xyz + r1.xyz;
  r0.w = globalScalars2.w * r3.w;
  ...
  r0.w = saturate(r3.x * 2 + r3.y);
  o4.w = envEffFatSweatScale.x * r0.w;
  r2.zw = v3.xy;
  o1.xyzw = r2.zwxy;
  o2.xyzw = r6.xyzw;
  o3.xyz = v7.xyz;
