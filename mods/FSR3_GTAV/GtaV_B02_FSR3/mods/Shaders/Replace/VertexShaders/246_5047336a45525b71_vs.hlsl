...
// unknown dcl_: dcl_input v0.xyzw
  ...
  r0.y = max(0, r0.y);
  r0.x = r0.y / r0.x;
  r0.y = globalFogParams[1].w * r0.y;
  r0.x = r0.z * r0.x;
  r0.z = cmp(0.00999999978 < abs(r0.x));
  r0.x = globalFogParams[2].z * r0.x;
  r0.w = -1.44269502 * r0.x;
  r0.w = exp2(r0.w);
  r0.w = 1 + -r0.w;
  r0.x = r0.w / r0.x;
  r0.x = r0.z ? r0.x : 1;
  ...
  r0.x = min(1, r0.x);
  r0.x = 1 + -r0.x;
  r0.x = saturate(globalFogParams[2].y * r0.x);
  o1.x = -r0.x * noiseSoftness + 1;
  return;
}