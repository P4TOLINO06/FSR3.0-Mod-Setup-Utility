...
// unknown dcl_: dcl_input v4.xyzw
  ...
  r0.xyzw = float4(0,0,9.99999975e-06,0) + r0.xyzw;
  o1.z = r0.w;
  r1.xy = v2.xy;
  r1.z = 1;
  o1.x = dot(globalAnimUV0.xyz, r1.xyz);
  o1.y = dot(globalAnimUV1.xyz, r1.xyz);
  r1.x = dot(v3.xyz, v3.xyz);
  r1.x = cmp(r1.x < 0.100000001);
  r1.xyz = r1.xxx ? float3(0,0,1) : v3.xyz;
  r2.xyz = gWorld._m10_m11_m12 * r1.yyy;
  r1.xyw = r1.xxx * gWorld._m00_m01_m02 + r2.xyz;
  r1.xyz = r1.zzz * gWorld._m20_m21_m22 + r1.xyw;
  r1.w = dot(r1.xyz, r1.xyz);
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www;
  o2.xyz = r1.xyz;
  r2.xyz = gWorld._m10_m11_m12 * v4.yyy;
  r2.xyz = v4.xxx * gWorld._m00_m01_m02 + r2.xyz;
  r2.xyz = v4.zzz * gWorld._m20_m21_m22 + r2.xyz;
  o4.xyz = r2.xyz;
  r3.xyz = r2.zxy * r1.yzx;
  r1.xyz = r2.yzx * r1.zxy + -r3.xyz;
  o5.xyz = v4.www * r1.xyz;
  o6.w = 1;
  o7.xyzw = r0.xyzw;
