...
// unknown dcl_: dcl_input v5.xyzw
  ...
  if (r1.w != 0) {
    ...
    r2.w = r3.x + r3.x;
    r3.w = cmp(0 < branchBendEtc_AABBInfo[0].w);
    if (r3.w != 0) {
  ...
  o1.xyzw = TintPaletteSampler.SampleLevel(TintPaletteSampler_s, r2.xy, 0).xyzw;
  o2.xy = v4.xy;
  o2.z = v2.w;
  o2.w = SelfShadowing;
  o3.xyz = r0.xyz;
