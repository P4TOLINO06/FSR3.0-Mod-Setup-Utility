...
// unknown dcl_: dcl_input v5.xyzw
  ...
  r4.xyzw = gWorldViewProj._m10_m11_m12_m13 * r1.wwww;
  ...
  r1.xyz = r3.www * gWorld._m00_m01_m02 + r1.xyz;
  r3.xyz = r1.www * gWorld._m00_m01_m02 + r3.xyz;
  r4.xyzw = r1.wwww * gWorldViewProj._m00_m01_m02_m03 + r4.xyzw;
  r5.xyzw = gBoneMtx[r0.y/3]._m20_m21_m22_m23 * v1.yyyy;
  r5.xyzw = gBoneMtx[r0.x/3]._m20_m21_m22_m23 * v1.xxxx + r5.xyzw;
  r5.xyzw = gBoneMtx[r0.z/3]._m20_m21_m22_m23 * v1.zzzz + r5.xyzw;
  r0.xyzw = gBoneMtx[r0.w/3]._m20_m21_m22_m23 * v1.wwww + r5.xyzw;
  r0.w = dot(r0.xyzw, r2.xyzw);
  r0.x = dot(r0.xyz, v4.xyz);
  o2.xyz = r0.xxx * gWorld._m20_m21_m22 + r1.xyz;
  r0.xyz = r0.www * gWorld._m20_m21_m22 + r3.xyz;
  r1.xyzw = r0.wwww * gWorldViewProj._m20_m21_m22_m23 + r4.xyzw;
  ...
  o0.xy = saturate(v5.xy * r0.xy);
  o0.zw = v5.zw;
  r0.xy = v3.xy;
  r0.z = 1;
  o1.x = dot(globalAnimUV0.xyz, r0.xyz);
  o1.y = dot(globalAnimUV1.xyz, r0.xyz);
  o3.w = 1;
  o4.xyzw = r1.xyzw;
  o5.x = dot(r1.xyzw, ClipPlanes.xyzw);
  o5.yzw = float3(0,0,0);
  return;
}