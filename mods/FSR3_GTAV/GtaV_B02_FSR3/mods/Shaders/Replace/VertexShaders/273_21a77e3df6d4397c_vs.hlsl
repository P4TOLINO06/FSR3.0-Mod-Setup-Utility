...
// unknown dcl_: dcl_input v13.xy
  ...
  x3[1].x = 0.5;
  x3[2].x = v9.w;
  r0.xy = cmp(float2(0.999989986,0.999989986) < cb8[2].yz);
  r0.zw = cmp(cb8[2].yz < float2(2.00001001,2.00001001));
  r0.x = r0.z ? r0.x : 0;
  r0.x = r0.y ? r0.x : 0;
  r0.x = r0.w ? r0.x : 0;
  r0.y = cmp(9.99999975e-06 < cb8[3].y);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(cb8[3].y < 0.300000995);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(cb8[5].z < 1.00001001);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(0.000000 == cb8[5].w);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(v1.y < v1.x);
  r0.x = r0.y ? r0.x : 0;
