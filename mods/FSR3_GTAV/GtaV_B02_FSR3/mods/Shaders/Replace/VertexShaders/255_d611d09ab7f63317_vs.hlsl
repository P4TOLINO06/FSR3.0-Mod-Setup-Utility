...
// unknown dcl_: dcl_input v3.xyz
  ...
  if (r6.z == 0) {
    ...
    r6.z = (int)r6.z | (int)r7.x;
    if (r6.z == 0) {
      r7.x = cmp(gLightColourAndCapsuleExtent[3].w == 0.000000);
      r11.xyz = gLightPositionAndInvDistSqr[3].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[3].xyz + r0.xyz;
      r7.z = dot(r12.xyz, gLightDirectionAndFalloffExponent[3].xyz);
      r8.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[3].w;
      r7.z = saturate(r7.z / r8.w);
      r7.z = gLightColourAndCapsuleExtent[3].w * r7.z;
      r12.xyz = gLightDirectionAndFalloffExponent[3].xyz * r7.zzz + gLightPositionAndInvDistSqr[3].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      r11.xyz = r7.xxx ? r11.xyz : r12.xyz;
      r7.x = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      r7.x = saturate(-r7.x * gLightPositionAndInvDistSqr[3].w + 1);
      r7.z = 1 + -gLightDirectionAndFalloffExponent[3].w;
      r7.z = r7.z * r7.x + gLightDirectionAndFalloffExponent[3].w;
      r7.x = r7.x / r7.z;
      ...
      r7.z = r8.w * r7.z;
      r8.w = r7.z * r7.x;
      r10.xyz = r8.www * gLightColourAndCapsuleExtent[3].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r8.w = dot(r11.xyz, r11.xyz);
      r8.w = rsqrt(r8.w);
      r11.xyz = r11.xyz * r8.www;
      ...
      r7.x = r7.z * r7.x;
      r7.x = r7.x * r8.x;
      r9.xyz = r7.xxx * gLightColourAndCapsuleExtent[3].xyz + r9.xyz;
    }
  } else {
    r6.z = -1;
  }
  if (r6.z == 0) {
    r7.x = cmp(4 >= gNumForwardLights);
    r6.z = (int)r6.z | (int)r7.x;
    if (r6.z == 0) {
      r7.x = cmp(gLightColourAndCapsuleExtent[4].w == 0.000000);
      r11.xyz = gLightPositionAndInvDistSqr[4].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[4].xyz + r0.xyz;
      r7.z = dot(r12.xyz, gLightDirectionAndFalloffExponent[4].xyz);
      r8.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[4].w;
      r7.z = saturate(r7.z / r8.w);
      r7.z = gLightColourAndCapsuleExtent[4].w * r7.z;
      r12.xyz = gLightDirectionAndFalloffExponent[4].xyz * r7.zzz + gLightPositionAndInvDistSqr[4].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      r11.xyz = r7.xxx ? r11.xyz : r12.xyz;
      r7.x = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      r7.x = saturate(-r7.x * gLightPositionAndInvDistSqr[4].w + 1);
      r7.z = 1 + -gLightDirectionAndFalloffExponent[4].w;
      r7.z = r7.z * r7.x + gLightDirectionAndFalloffExponent[4].w;
      r7.x = r7.x / r7.z;
      ...
      r7.z = r8.w * r7.z;
      r8.w = r7.z * r7.x;
      r10.xyz = r8.www * gLightColourAndCapsuleExtent[4].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r8.w = dot(r11.xyz, r11.xyz);
      r8.w = rsqrt(r8.w);
      r11.xyz = r11.xyz * r8.www;
      ...
      r7.x = r7.z * r7.x;
      r7.x = r7.x * r8.x;
      r9.xyz = r7.xxx * gLightColourAndCapsuleExtent[4].xyz + r9.xyz;
    }
  } else {
    r6.z = -1;
  }
  if (r6.z == 0) {
    r7.x = cmp(5 >= gNumForwardLights);
    r6.z = (int)r6.z | (int)r7.x;
    if (r6.z == 0) {
      r7.x = cmp(gLightColourAndCapsuleExtent[5].w == 0.000000);
      r11.xyz = gLightPositionAndInvDistSqr[5].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[5].xyz + r0.xyz;
      r7.z = dot(r12.xyz, gLightDirectionAndFalloffExponent[5].xyz);
      r8.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[5].w;
      r7.z = saturate(r7.z / r8.w);
      r7.z = gLightColourAndCapsuleExtent[5].w * r7.z;
      r12.xyz = gLightDirectionAndFalloffExponent[5].xyz * r7.zzz + gLightPositionAndInvDistSqr[5].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      r11.xyz = r7.xxx ? r11.xyz : r12.xyz;
      r7.x = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      r7.x = saturate(-r7.x * gLightPositionAndInvDistSqr[5].w + 1);
      r7.z = 1 + -gLightDirectionAndFalloffExponent[5].w;
      r7.z = r7.z * r7.x + gLightDirectionAndFalloffExponent[5].w;
      r7.x = r7.x / r7.z;
      ...
      r7.z = r8.w * r7.z;
      r8.w = r7.z * r7.x;
      r10.xyz = r8.www * gLightColourAndCapsuleExtent[5].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r8.w = dot(r11.xyz, r11.xyz);
      r8.w = rsqrt(r8.w);
      r11.xyz = r11.xyz * r8.www;
      ...
      r7.x = r7.z * r7.x;
      r7.x = r7.x * r8.x;
      r9.xyz = r7.xxx * gLightColourAndCapsuleExtent[5].xyz + r9.xyz;
    }
  } else {
    r6.z = -1;
  }
  if (r6.z == 0) {
    r7.x = cmp(6 >= gNumForwardLights);
    r6.z = (int)r6.z | (int)r7.x;
    if (r6.z == 0) {
      r7.x = cmp(gLightColourAndCapsuleExtent[6].w == 0.000000);
      r11.xyz = gLightPositionAndInvDistSqr[6].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[6].xyz + r0.xyz;
      r7.z = dot(r12.xyz, gLightDirectionAndFalloffExponent[6].xyz);
      r8.w = 9.99999975e-05 + gLightColourAndCapsuleExtent[6].w;
      r7.z = saturate(r7.z / r8.w);
      r7.z = gLightColourAndCapsuleExtent[6].w * r7.z;
      r12.xyz = gLightDirectionAndFalloffExponent[6].xyz * r7.zzz + gLightPositionAndInvDistSqr[6].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      r11.xyz = r7.xxx ? r11.xyz : r12.xyz;
      r7.x = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      r7.x = saturate(-r7.x * gLightPositionAndInvDistSqr[6].w + 1);
      r7.z = 1 + -gLightDirectionAndFalloffExponent[6].w;
      r7.z = r7.z * r7.x + gLightDirectionAndFalloffExponent[6].w;
      r7.x = r7.x / r7.z;
      ...
      r7.z = r8.w * r7.z;
      r8.w = r7.z * r7.x;
      r10.xyz = r8.www * gLightColourAndCapsuleExtent[6].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r8.w = dot(r11.xyz, r11.xyz);
      r8.w = rsqrt(r8.w);
      r11.xyz = r11.xyz * r8.www;
      ...
      r7.x = r7.z * r7.x;
      r7.x = r7.x * r8.x;
      r9.xyz = r7.xxx * gLightColourAndCapsuleExtent[6].xyz + r9.xyz;
    }
  } else {
    r6.z = -1;
  }
  if (r6.z == 0) {
    r7.x = cmp(7 >= gNumForwardLights);
    r6.z = (int)r6.z | (int)r7.x;
    if (r6.z == 0) {
      r6.z = cmp(gLightColourAndCapsuleExtent[7].w == 0.000000);
      r11.xyz = gLightPositionAndInvDistSqr[7].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[7].xyz + r0.xyz;
      r7.x = dot(r12.xyz, gLightDirectionAndFalloffExponent[7].xyz);
      r7.z = 9.99999975e-05 + gLightColourAndCapsuleExtent[7].w;
      r7.x = saturate(r7.x / r7.z);
      r7.x = gLightColourAndCapsuleExtent[7].w * r7.x;
      r12.xyz = gLightDirectionAndFalloffExponent[7].xyz * r7.xxx + gLightPositionAndInvDistSqr[7].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      ...
      r6.z = saturate(-r6.z * gLightPositionAndInvDistSqr[7].w + 1);
      r7.x = 1 + -gLightDirectionAndFalloffExponent[7].w;
      r7.x = r7.x * r6.z + gLightDirectionAndFalloffExponent[7].w;
      r6.z = r6.z / r7.x;
      r7.x = dot(r11.xyz, -gLightDirectionAndFalloffExponent[7].xyz);
      r7.x = saturate(r7.x * gLightConeScale[7] + gLightConeOffset[7]);
      ...
      r7.x = r7.z * r7.x;
      r7.z = r7.x * r6.z;
      r10.xyz = r7.zzz * gLightColourAndCapsuleExtent[7].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r7.z = dot(r11.xyz, r11.xyz);
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      ...
      r6.z = r7.x * r6.z;
      r6.z = r6.z * r8.x;
      r9.xyz = r6.zzz * gLightColourAndCapsuleExtent[7].xyz + r9.xyz;
    }
  }
  r6.z = r7.y * r7.y;
  r5.w = r5.w * r5.w;
  ...
  if (r6.x == 0) {
    ...
    if (r6.x == 0) {
      ...
      r7.x = r7.x * r6.y + gLightDirectionAndFalloffExponent[3].w;
      r6.y = r6.y / r7.x;
      ...
      r6.y = r7.x * r6.y;
      r6.y = r6.y * r8.x;
      r9.xyz = r6.yyy * gLightColourAndCapsuleExtent[3].xyz + r9.xyz;
    }
  } else {
    r6.x = -1;
  }
  if (r6.x == 0) {
    ...
    if (r6.x == 0) {
      ...
      r11.xyz = gLightPositionAndInvDistSqr[4].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[4].xyz + r0.xyz;
      r7.x = dot(r12.xyz, gLightDirectionAndFalloffExponent[4].xyz);
      r7.z = 9.99999975e-05 + gLightColourAndCapsuleExtent[4].w;
      r7.x = saturate(r7.x / r7.z);
      r7.x = gLightColourAndCapsuleExtent[4].w * r7.x;
      r12.xyz = gLightDirectionAndFalloffExponent[4].xyz * r7.xxx + gLightPositionAndInvDistSqr[4].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      r11.xyz = r6.yyy ? r11.xyz : r12.xyz;
      r6.y = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r7.x = 1 + -gLightDirectionAndFalloffExponent[4].w;
      r7.x = r7.x * r6.y + gLightDirectionAndFalloffExponent[4].w;
      r6.y = r6.y / r7.x;
      r7.x = dot(r11.xyz, -gLightDirectionAndFalloffExponent[4].xyz);
      r7.x = saturate(r7.x * gLightConeScale[4] + gLightConeOffset[4]);
      r7.z = dot(r11.xyz, -r4.xyz);
      r8.w = saturate(r7.z);
      r8.w = r8.w + -abs(r7.z);
      r7.z = v1.w * r8.w + abs(r7.z);
      r7.x = r7.z * r7.x;
      r7.z = r7.x * r6.y;
      r10.xyz = r7.zzz * gLightColourAndCapsuleExtent[4].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r7.z = dot(r11.xyz, r11.xyz);
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      ...
      r6.y = r7.x * r6.y;
      r6.y = r6.y * r8.x;
      r9.xyz = r6.yyy * gLightColourAndCapsuleExtent[4].xyz + r9.xyz;
    }
  } else {
    r6.x = -1;
  }
  if (r6.x == 0) {
    ...
    if (r6.x == 0) {
      ...
      r11.xyz = gLightPositionAndInvDistSqr[5].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[5].xyz + r0.xyz;
      r7.x = dot(r12.xyz, gLightDirectionAndFalloffExponent[5].xyz);
      r7.z = 9.99999975e-05 + gLightColourAndCapsuleExtent[5].w;
      r7.x = saturate(r7.x / r7.z);
      r7.x = gLightColourAndCapsuleExtent[5].w * r7.x;
      r12.xyz = gLightDirectionAndFalloffExponent[5].xyz * r7.xxx + gLightPositionAndInvDistSqr[5].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      r11.xyz = r6.yyy ? r11.xyz : r12.xyz;
      r6.y = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r7.x = 1 + -gLightDirectionAndFalloffExponent[5].w;
      r7.x = r7.x * r6.y + gLightDirectionAndFalloffExponent[5].w;
      r6.y = r6.y / r7.x;
      r7.x = dot(r11.xyz, -gLightDirectionAndFalloffExponent[5].xyz);
      r7.x = saturate(r7.x * gLightConeScale[5] + gLightConeOffset[5]);
      r7.z = dot(r11.xyz, -r4.xyz);
      r8.w = saturate(r7.z);
      r8.w = r8.w + -abs(r7.z);
      r7.z = v1.w * r8.w + abs(r7.z);
      r7.x = r7.z * r7.x;
      r7.z = r7.x * r6.y;
      r10.xyz = r7.zzz * gLightColourAndCapsuleExtent[5].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r7.z = dot(r11.xyz, r11.xyz);
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      ...
      r6.y = r7.x * r6.y;
      r6.y = r6.y * r8.x;
      r9.xyz = r6.yyy * gLightColourAndCapsuleExtent[5].xyz + r9.xyz;
    }
  } else {
    r6.x = -1;
  }
  if (r6.x == 0) {
    ...
    if (r6.x == 0) {
      ...
      r11.xyz = gLightPositionAndInvDistSqr[6].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[6].xyz + r0.xyz;
      r7.x = dot(r12.xyz, gLightDirectionAndFalloffExponent[6].xyz);
      r7.z = 9.99999975e-05 + gLightColourAndCapsuleExtent[6].w;
      r7.x = saturate(r7.x / r7.z);
      r7.x = gLightColourAndCapsuleExtent[6].w * r7.x;
      r12.xyz = gLightDirectionAndFalloffExponent[6].xyz * r7.xxx + gLightPositionAndInvDistSqr[6].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      r11.xyz = r6.yyy ? r11.xyz : r12.xyz;
      r6.y = dot(r11.xyz, r11.xyz);
      r11.xyz = float3(9.99999997e-07,9.99999997e-07,9.99999997e-07) + r11.xyz;
      ...
      r7.x = 1 + -gLightDirectionAndFalloffExponent[6].w;
      r7.x = r7.x * r6.y + gLightDirectionAndFalloffExponent[6].w;
      r6.y = r6.y / r7.x;
      r7.x = dot(r11.xyz, -gLightDirectionAndFalloffExponent[6].xyz);
      r7.x = saturate(r7.x * gLightConeScale[6] + gLightConeOffset[6]);
      r7.z = dot(r11.xyz, -r4.xyz);
      r8.w = saturate(r7.z);
      r8.w = r8.w + -abs(r7.z);
      r7.z = v1.w * r8.w + abs(r7.z);
      r7.x = r7.z * r7.x;
      r7.z = r7.x * r6.y;
      r10.xyz = r7.zzz * gLightColourAndCapsuleExtent[6].xyz + r10.xyz;
      r11.xyz = r2.xyz * r4.www + r11.xyz;
      r7.z = dot(r11.xyz, r11.xyz);
      r7.z = rsqrt(r7.z);
      r11.xyz = r11.xyz * r7.zzz;
      ...
      r6.y = r7.x * r6.y;
      r6.y = r6.y * r8.x;
      r9.xyz = r6.yyy * gLightColourAndCapsuleExtent[6].xyz + r9.xyz;
    }
  } else {
    r6.x = -1;
  }
  if (r6.x == 0) {
    ...
    r6.x = (int)r6.x | (int)r6.y;
    if (r6.x == 0) {
      r6.x = cmp(gLightColourAndCapsuleExtent[7].w == 0.000000);
      r11.xyz = gLightPositionAndInvDistSqr[7].xyz + -r0.xyz;
      r12.xyz = -gLightPositionAndInvDistSqr[7].xyz + r0.xyz;
      r6.y = dot(r12.xyz, gLightDirectionAndFalloffExponent[7].xyz);
      r7.x = 9.99999975e-05 + gLightColourAndCapsuleExtent[7].w;
      r6.y = saturate(r6.y / r7.x);
      r6.y = gLightColourAndCapsuleExtent[7].w * r6.y;
      r12.xyz = gLightDirectionAndFalloffExponent[7].xyz * r6.yyy + gLightPositionAndInvDistSqr[7].xyz;
      r12.xyz = r12.xyz + -r0.xyz;
      ...
      r6.x = saturate(-r6.x * gLightPositionAndInvDistSqr[7].w + 1);
      r6.y = 1 + -gLightDirectionAndFalloffExponent[7].w;
      r6.y = r6.y * r6.x + gLightDirectionAndFalloffExponent[7].w;
      r6.x = r6.x / r6.y;
      r6.y = dot(r11.xyz, -gLightDirectionAndFalloffExponent[7].xyz);
      ...
      r6.y = r7.x * r6.y;
      r7.x = r6.y * r6.x;
      r10.xyz = r7.xxx * gLightColourAndCapsuleExtent[7].xyz + r10.xyz;
      r2.xyz = r2.xyz * r4.www + r11.xyz;
      r4.w = dot(r2.xyz, r2.xyz);
      r4.w = rsqrt(r4.w);
      ...
      r5.x = r5.x * r5.x;
      r4.w = r5.x * r4.w;
      r4.w = specularFresnel * r4.w + r7.w;
      ...
      r2.x = r2.x * r6.x;
      r2.x = r2.x * r8.x;
      r9.xyz = r2.xxx * gLightColourAndCapsuleExtent[7].xyz + r9.xyz;
    }
  }
  o9.xyz = r10.xyz * r6.zzz;
  o10.xyz = r9.xyz * r5.www;
