...
// unknown dcl_: dcl_input v8.w
  ...
  r5.xyz = r3.xxx * gWorld._m00_m01_m02 + r5.xyz;
  r5.xyz = r3.zzz * gWorld._m20_m21_m22 + r5.xyz;
  ...
  r1.xyz = r0.zxy * r5.yzx;
  r1.xyz = r0.yzx * r5.zxy + -r1.xyz;
  o6.xyz = v6.www * r1.xyz;
  r1.xyz = envEffFatThickness.yyy * r3.xyz;
  r1.xyz = v8.www * r1.xyz;
  r1.xyz = r1.xyz * envEffFatSweatScale.zzz + r4.xyz;
