...
// unknown dcl_: dcl_input v0.xyz
  ...
  r4.x = cmp(deferredLightVolumeParams[1].y < deferredLightVolumeParams[1].x);
  r4.y = 2.86520004 * deferredLightVolumeParams[1].y;
  r4.y = cmp(deferredLightVolumeParams[1].x < r4.y);
  r4.x = r4.y ? r4.x : 0;
  r4.y = 2.95910001 * deferredLightVolumeParams[1].z;
  r4.y = cmp(r4.y < deferredLightVolumeParams[1].y);
  r4.x = r4.y ? r4.x : 0;
  r4.xyz = r4.xxx ? deferredLightVolumeParams[1].yyy : deferredLightVolumeParams[1].xyz;
