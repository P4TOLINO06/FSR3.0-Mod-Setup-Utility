...
// unknown dcl_: dcl_input v5.xyzw
  ...
  r4.w = dot(r5.xyz, v4.xyz);
  r1.xyz = r4.www * gWorld._m00_m01_m02 + r1.xyz;
  temp.x = r1.w;
  ...
  o3.xyz = r0.xxx * gWorld._m20_m21_m22 + r1.xyz;
  temp.z = r0.w;
  r1.xyzw = r0.wwww * gWorldViewProj._m20_m21_m22_m23 + r3.xyzw;
  r0.xyz = r0.www * gWorld._m20_m21_m22 + r4.xyz;
  ...
  o0.xyzw = float4(0,0,9.99999975e-06,0) + r1.xyzw;
  r0.y = 1 + -r0.x;
  ...
  r0.xy = v3.xy;
  r0.z = 1;
  o2.x = dot(globalAnimUV0.xyz, r0.xyz);
  o2.y = dot(globalAnimUV1.xyz, r0.xyz);
  return;
}