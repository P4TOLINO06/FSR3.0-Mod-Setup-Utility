...
// unknown dcl_: dcl_input v8.xyzw
  ...
  if (r0.z != 0) {
    r4.x = dot(clothParentMatrix._m00_m01_m02, clothVertices[r0.w].xyz);
    r4.y = dot(clothParentMatrix._m10_m11_m12, clothVertices[r0.w].xyz);
    r4.z = dot(clothParentMatrix._m20_m21_m22, clothVertices[r0.w].xyz);
    r5.x = dot(clothParentMatrix._m00_m01_m02, clothVertices[r0.x].xyz);
    r5.y = dot(clothParentMatrix._m10_m11_m12, clothVertices[r0.x].xyz);
    r5.z = dot(clothParentMatrix._m20_m21_m22, clothVertices[r0.x].xyz);
    r6.x = dot(clothParentMatrix._m00_m01_m02, clothVertices[r0.y].xyz);
    r6.y = dot(clothParentMatrix._m10_m11_m12, clothVertices[r0.y].xyz);
    r6.z = dot(clothParentMatrix._m20_m21_m22, clothVertices[r0.y].xyz);
    r0.xyw = -r5.zxy + r4.zxy;
    r7.xyz = r6.yzx + -r5.yzx;
    r8.xyz = r7.xyz * r0.xyw;
    r0.xyw = r0.wxy * r7.yzx + -r8.xyz;
    r4.w = dot(r0.xyw, r0.xyw);
    r4.w = rsqrt(r4.w);
    r0.xyw = r4.www * r0.xyw;
    r5.xyz = v1.yyy * r5.xyz;
    r4.xyz = v1.zzz * r4.xyz + r5.xyz;
    r4.xyz = v1.xxx * r6.xyz + r4.xyz;
    r4.w = -0.5 + v1.w;
    r4.w = 0.100000001 * r4.w;
    r4.xyz = r4.www * -r0.xyw + r4.xyz;
    r5.xyz = gWorld._m10_m11_m12 * r4.yyy;
    r5.xyz = r4.xxx * gWorld._m00_m01_m02 + r5.xyz;
    r5.xyz = r4.zzz * gWorld._m20_m21_m22 + r5.xyz;
    r5.xyz = gWorld._m30_m31_m32 + r5.xyz;
    r6.xyz = gWorld._m10_m11_m12 * r0.yyy;
    r6.xyz = r0.xxx * gWorld._m00_m01_m02 + r6.xyz;
    r6.xyz = r0.www * gWorld._m20_m21_m22 + r6.xyz;
    o4.xyz = gViewInverse._m30_m31_m32 + -r5.xyz;
    r0.xyw = r0.zzz ? gBoneMtx[0]._m00_m01_m02 : r2.xyz;
    r5.xyz = r0.zzz ? gBoneMtx[0]._m10_m11_m12 : r3.xyz;
    r7.xyz = r0.zzz ? gBoneMtx[0]._m20_m21_m22 : r1.xyz;
    r0.x = dot(r0.xyw, v6.xyz);
    r0.y = dot(r5.xyz, v6.xyz);
    r0.w = dot(r7.xyz, v6.xyz);
    r5.xyz = gWorld._m10_m11_m12 * r0.yyy;
    r5.xyz = r0.xxx * gWorld._m00_m01_m02 + r5.xyz;
    r0.xyw = r0.www * gWorld._m20_m21_m22 + r5.xyz;
    r5.xyz = r0.wxy * r6.yzx;
    r5.xyz = r0.ywx * r6.zxy + -r5.xyz;
    o6.xyz = v6.www * r5.xyz;
    o5.xyz = r0.xyw;
  } else {
    r2.xyzw = r0.zzzz ? gBoneMtx[0]._m00_m01_m02_m03 : r2.xyzw;
    r3.xyzw = r0.zzzz ? gBoneMtx[0]._m10_m11_m12_m13 : r3.xyzw;
    r0.xyzw = r0.zzzz ? gBoneMtx[0]._m20_m21_m22_m23 : r1.xyzw;
    r1.xyz = v0.xyz;
    r1.w = 1;
    r4.x = dot(r2.xyzw, r1.xyzw);
    r4.y = dot(r3.xyzw, r1.xyzw);
    r4.z = dot(r0.xyzw, r1.xyzw);
    r1.xyz = gWorld._m10_m11_m12 * r4.yyy;
    r1.xyz = r4.xxx * gWorld._m00_m01_m02 + r1.xyz;
    r1.xyz = r4.zzz * gWorld._m20_m21_m22 + r1.xyz;
    r1.xyz = gWorld._m30_m31_m32 + r1.xyz;
    o4.xyz = gViewInverse._m30_m31_m32 + -r1.xyz;
    r0.w = dot(r2.xyz, v5.xyz);
    r1.x = dot(r3.xyz, v5.xyz);
    r1.y = dot(r0.xyz, v5.xyz);
    r1.xzw = gWorld._m10_m11_m12 * r1.xxx;
    r1.xzw = r0.www * gWorld._m00_m01_m02 + r1.xzw;
    r6.xyz = r1.yyy * gWorld._m20_m21_m22 + r1.xzw;
    ...
    r1.xyz = r0.zxy * r6.yzx;
    r1.xyz = r0.yzx * r6.zxy + -r1.xyz;
    o6.xyz = v6.www * r1.xyz;
    o5.xyz = r0.xyz;
  }
  r0.xyz = umGlobalParams.xxy * v8.xxz;
  r0.xyz = umPedGlobalOverrideParams.xxy * r0.xyz;
  r0.w = 6.28318501 * v8.y;
  r1.xyz = umGlobalParams.zzw * umPedGlobalOverrideParams.zzw;
  r1.xyz = globalScalars2.xxx * r1.xyz + r0.www;
  r1.xyz = sin(r1.xyz);
  r0.xyz = r1.xyz * r0.xyz + r4.xyz;
  r1.xy = float2(0.529411793,-0.0392156877) + v7.yy;
  r0.w = globalScalars2.w * r1.y;
