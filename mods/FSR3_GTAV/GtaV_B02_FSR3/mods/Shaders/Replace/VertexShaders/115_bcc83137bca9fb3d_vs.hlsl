...
// unknown dcl_: dcl_input v7.xyzw
  ...
  o1.zw = v4.xy;
  o2.xyzw = v2.xyzw;
  r0.xyz = gWorld._m10_m11_m12 * v6.yyy;
  r0.xyz = v6.xxx * gWorld._m00_m01_m02 + r0.xyz;
  r0.xyz = v6.zzz * gWorld._m20_m21_m22 + r0.xyz;
  ...
  r2.x = min(1, r0.w);
  r2.y = 1 + -r2.x;
  r2.xy = saturate(-globalScalars2.zz + r2.xy);
  r0.w = -1 + gDirectionalAmbientColour.w;
  r2.xy = r2.xy * r0.ww + float2(1,1);
  o4.xy = saturate(v1.xy * r2.xy);
  o4.z = v1.z;
  o4.w = 0;
  r2.xyz = gViewInverse._m11_m12_m10 * gViewInverse._m02_m00_m01;
  r2.xyz = gViewInverse._m01_m02_m00 * gViewInverse._m12_m10_m11 + -r2.xyz;
  r2.xyz = -r2.xyz * float3(8,8,8) + gViewInverse._m30_m31_m32;
  r2.xyz = r2.xyz + -r1.xyz;
  o7.xyz = gViewInverse._m30_m31_m32 + -r1.xyz;
  r0.w = dot(r2.xyz, r2.xyz);
  o5.w = sqrt(r0.w);
  r1.xyz = gWorld._m10_m11_m12 * v7.yyy;
  r1.xyz = v7.xxx * gWorld._m00_m01_m02 + r1.xyz;
  r1.xyz = v7.zzz * gWorld._m20_m21_m22 + r1.xyz;
  o5.xyz = r1.xyz;
  r2.xyz = r1.zxy * r0.yzx;
  r0.xyz = r1.yzx * r0.zxy + -r2.xyz;
  o6.xyz = v7.www * r0.xyz;
  o8.xy = v5.xy;
  return;
}