...
// unknown dcl_: dcl_input v13.xy
  ...
  x3[1].x = 0.5;
  x3[2].x = v9.w;
  r0.xy = cmp(float2(0.999989986,0.999989986) < gDirectionalMult);
  r0.zw = cmp(gDirectionalMult < float2(2.00001001,2.00001001));
  r0.x = r0.z ? r0.x : 0;
  r0.x = r0.y ? r0.x : 0;
  r0.x = r0.w ? r0.x : 0;
  r0.y = cmp(9.99999975e-06 < gCameraBias);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(gCameraBias < 0.300000995);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(gAlphaCutoffMinMax.y < 1.00001001);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(0.000000 == gAlphaCutoffMinMax.z);
  r0.x = r0.y ? r0.x : 0;
  r0.y = cmp(v1.y < v1.x);
  r0.x = r0.y ? r0.x : 0;
  r1.xyz = float3(3.9000001,2.21000004,1.82000005) * v1.xyz;
  r1.w = 1.10000002 * v4.w;
  r2.xyz = v1.xyz;
  r2.w = v4.w;
  r0.xyzw = r0.xxxx ? r1.xyzw : r2.xyzw;
  r1.xyz = r0.xyz * r0.xyz;
  o0.xyz = r1.xyz * v3.yyy + r0.xyz;
  r0.x = v1.w * r0.w;
  r0.x = v4.y * r0.x;
  ...
  r1.x = x1[r0.y+0].x;
  o1.w = r1.x * r1.y + v11.w;
  r1.yz = v10.yz + -v10.xw;
  o1.x = r0.z * r1.y + v10.x;
  o1.y = r1.x * r1.z + v10.w;
  r0.y = x3[r0.y+0].x;
  r0.x = x2[r0.x+0].x;
  o2.x = r0.x * r1.y + v10.x;
  o2.y = r0.y * r1.z + v10.w;
  o2.zw = float2(0,0);
  o3.x = saturate(v3.x);
  o3.y = v3.y;
  r1.yzw = v7.xyz + v0.xyz;
  r2.x = v6.w;
  r2.y = v7.w;
  r2.z = v8.w;
  r1.yzw = r2.xyz + r1.yzw;
  r2.xyz = v8.xyz + -r2.xyz;
  r0.xyz = r2.xyz * r0.zzz + r1.yzw;
  r3.xyz = -v7.xyz + v6.xyz;
  r0.xyz = r3.xyz * r1.xxx + r0.xyz;
  r2.xyz = r3.xyz + r2.xyz;
  r1.xyz = r2.xyz * float3(0.5,0.5,0.5) + r1.yzw;
