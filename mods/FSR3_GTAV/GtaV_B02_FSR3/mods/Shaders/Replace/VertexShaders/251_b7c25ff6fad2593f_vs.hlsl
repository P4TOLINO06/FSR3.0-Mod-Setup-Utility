...
// unknown dcl_: dcl_input_sgv v1.x, instance_id
  ...
  r1.y = r1.x * r1.y + gTextureRowsColsStartEnd.z;
  r1.y = floor(r1.y);
  r1.y = r1.y / gTextureRowsColsStartEnd.y;
  r1.z = cmp(r1.y >= -r1.y);
  r2.w = frac(abs(r1.y));
  r1.z = r1.z ? r2.w : -r2.w;
  r6.x = gTextureRowsColsStartEnd.y * r1.z;
  r6.y = floor(r1.y);
  r1.yz = float2(1,1) / gTextureRowsColsStartEnd.yx;
  r6.xy = v0.xy + r6.xy;
  o1.xy = r6.xy * r1.yz;
  r2.w = 1 + gTextureAnimRateScaleOverLifeStart2End2.w;
  r2.w = -gTextureAnimRateScaleOverLifeStart2End2.z + r2.w;
  r1.x = r1.x * r2.w + gTextureAnimRateScaleOverLifeStart2End2.z;
  r1.x = floor(r1.x);
  r1.x = r1.x / gTextureRowsColsStartEnd.y;
  r2.w = cmp(r1.x >= -r1.x);
  r3.w = frac(abs(r1.x));
  r2.w = r2.w ? r3.w : -r3.w;
  r6.z = gTextureRowsColsStartEnd.y * r2.w;
  r6.w = floor(r1.x);
  r6.xy = v0.xy + r6.zw;
  o1.zw = r6.xy * r1.yz;
  ...
  r1.x = r1.z * r1.x;
  r1.y = 1 + -abs(r1.x);
  r1.y = -gCamAngleLimits.x + r1.y;
  r1.x = -gCamAngleLimits.z + abs(r1.x);
  o5.xy = saturate(gCamAngleLimits.yw * r1.yx);
