...
// unknown dcl_: dcl_input v8.xyzw
  ...
  if (switchOn != 0) {
    ...
    r3.xyz = r3.xyz * r5.xyz + v6.xyz;
    r1.yzw = r1.www ? r3.xyz : v6.xyz;
  ...
  r0.y = dot(gBoneMtx[r1.x/3]._m00_m01_m02, v7.xyz);
  r0.z = dot(gBoneMtx[r1.x/3]._m10_m11_m12, v7.xyz);
  r0.w = dot(gBoneMtx[r1.x/3]._m20_m21_m22, v7.xyz);
  ...
  o6.xyz = v7.www * r2.xyz;
  float3 temp = float3(r1.y, r1.x, r1.w);
  ...
  if (bDebugDisplayDamageMap != 0) {
    ...
    r2.xy = float2(126.732674,126.732674) * r1.xy;
