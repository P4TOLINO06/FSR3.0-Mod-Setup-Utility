...
// unknown dcl_: dcl_input v6.xyzw
  ...
  if (bDebugDisplayDamageMap != 0) {
    ...
    r3.xy = float2(126.732697,126.732697) * r1.xy;
    r3.zw = cmp(r3.xy >= -r3.xy);
    r3.xy = frac(abs(r3.xy));
    r3.xy = r3.zw ? r3.xy : -r3.xy;
    r4.xyzw = DamageSampler.SampleLevel(DamageSampler_s, r1.xy, 0).xyzw;
    r1.xy = -r3.xy * float2(0.00789062493,0.00789062493) + r1.xy;
    r5.xyzw = float4(0.00789062493,0,0,0.00789062493) + r1.xyxy;
    r6.xyzw = DamageSampler.SampleLevel(DamageSampler_s, r5.xy, 0).xyzw;
    r5.xyzw = DamageSampler.SampleLevel(DamageSampler_s, r5.zw, 0).xyzw;
    r1.xy = float2(0.00789062493,0.00789062493) + r1.xy;
    r7.xyzw = DamageSampler.SampleLevel(DamageSampler_s, r1.xy, 0).xyzw;
    r1.xy = float2(1,1) + -r3.xy;
    r4.xyzw = r4.xyzw * r1.xxxx;
    r6.xyzw = r6.xyzw * r3.xxxx;
    r6.xyzw = r6.xyzw * r1.yyyy;
    r4.xyzw = r4.xyzw * r1.yyyy + r6.xyzw;
    r5.xyzw = r5.xyzw * r1.xxxx;
    r4.xyzw = r5.xyzw * r3.yyyy + r4.xyzw;
    r5.xyzw = r7.xyzw * r3.xxxx;
  ...
  r3.x = r70.y;
  r3.w = 1;
  o4.xyzw = bDebugDisplayDamageScale ? r3.xxxw : r1.xyzw;
  ...
  r1.x = exp2(r1.x);
  r1.y = -r2.w * globalFogParams[2].y + 1;
  r1.z = -globalFogParams[2].x + r3.x;
  r1.z = max(0, r1.z);
  r1.yz = globalFogParams[1].yx * r1.yz;
  r1.z = 1.44269502 * r1.z;
  r1.z = exp2(r1.z);
  r1.z = 1 + -r1.z;
  o5.w = saturate(r1.y * r1.z + r3.y);
  r1.z = -globalFogParams[1].z * r3.x;
  r1.z = 1.44269502 * r1.z;
  r1.z = exp2(r1.z);
  r1.z = 1 + -r1.z;
  ...
  r1.xzw = r1.zzz * r3.xyz + globalFogColorN.xyz;
  r3.x = globalFogColor.w + -r1.x;
  r3.y = globalFogColorE.w + -r1.z;
  r3.z = globalFogColorN.w + -r1.w;
  o5.xyz = r1.yyy * r3.xyz + r1.xzw;
