...
// unknown dcl_: dcl_input v6.w
  ...
  r4.xyz = envEffFatThickness.xxx * r2.xyz;
  r2.w = saturate(-0.5 + v5.z);
  r2.w = r2.w + r2.w;
  ...
  r0.xyz = r4.xyz * envEffFatSweatScale.yyy + r1.xyz;
  r1.xyz = envEffFatThickness.yyy * r2.xyz;
  r3.xyz = gWorld._m10_m11_m12 * r2.yyy;
  r3.xyz = r2.xxx * gWorld._m00_m01_m02 + r3.xyz;
  o2.xyz = r2.zzz * gWorld._m20_m21_m22 + r3.xyz;
  r1.xyz = v6.www * r1.xyz;
  r0.xyz = r1.xyz * envEffFatSweatScale.zzz + r0.xyz;
  ...
  r0.x = envEffColorModCpvAdd.w * r0.x + v5.z;
  r0.x = saturate(r0.x * 2 + r2.w);
  o1.z = envEffFatSweatScale.x * r0.x;
  o1.xy = v3.xy;
  o3.xyzw = v5.xyzw;
  return;
}