...
// unknown dcl_: dcl_input v6.xyzw
  ...
  r2.xyz = r0.www * gWorld._m20_m21_m22 + r3.xyz;
  ...
  r4.xyz = gViewInverse._m30_m31_m32 + -r2.xyz;
  o6.xyz = r2.xyz;
  ...
  o0.xy = saturate(v6.xy * r2.xy);
  o0.zw = v6.zw;
  r2.xy = v3.xy;
  r2.z = 1;
  o1.x = dot(globalAnimUV0.xyz, r2.xyz);
  o1.y = dot(globalAnimUV1.xyz, r2.xyz);
